...
#ifndef _WIN32
typedef void* HANDLE; // provide a POSIX-compatible alias for Windows HANDLE used in original code
#endif
...
public:
   ...
   // CBaslerUniversalInstantCamera *CAMERA = new CBaslerUniversalInstantCamera(CTlFactory::GetInstance().CreateFirstDevice());;
    ...
    // Pixelink camera wrapper not used anymore; use Basler CGuiCamera array instead
    // camera *PXLcamera = new camera; // removed Pixelink wrapper
    ...
    // Unused legacy HANDLE for Pixelink
    // HANDLE sendcamera;
...
private slots:
    ...
    void do_connect();
    void on_upload_test_btn_clicked();
    // legacy Pixelink-based usedcamera no longer used
...
private:
    ...
    SQLsend *send = nullptr;
    QThread *threadsend;
    QPushButton *upload_test_btn = nullptr;
...
//////////////////////
    ...
    QLabel *m_previewLabel = nullptr; // for live preview
///////////////////////
