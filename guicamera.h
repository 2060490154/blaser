...
public:
    ...
    void SetDebugSaveEnabled(bool enable);
    void SetDebugSaveInterval(int interval);
/////////////////////////////////////////////////////////////////
signals:
...
private:
    ...
    // Debug controls: enable or disable saving debug images and throttle frequency
    bool m_debugSaveEnabled = false;
    int m_debugSaveCounter = 0; // incremented and saved every m_debugSaveInterval frames (to limit IO)
    int m_debugSaveInterval = 10; // save one every 10 frames by default
