//-----------------------------------------------------------------------------
//  Basler pylon SDK
//  Copyright (c) 2008-2025 Basler AG
...
#define PYLON_VERSION_SUFFIX "_v11"
#define PYLON_CPP_VERSION_SUFFIX "_v11"
#define PYLON_C_VERSION_SUFFIX "_v10"
#define MONTI_VISION_VERSION_SUFFIX "_v9"
...
// generic
#define PYLON_LIB_SUFFIX        PYLON_SUFFIX( PYLON_CPP_VERSION_SUFFIX PYLON_CONFIGURATION, "lib" )
#define PYLON_DLL_SUFFIX        PYLON_SUFFIX( PYLON_CPP_VERSION_SUFFIX PYLON_CONFIGURATION, "dll" )

// names for Transport Layer
#define PYLON_TL_LIB_SUFFIX     PYLON_SUFFIX( PYLON_CPP_VERSION_SUFFIX PYLON_CONFIGURATION "_TL", "lib" )
#define PYLON_TL_DLL_SUFFIX     PYLON_SUFFIX( PYLON_CPP_VERSION_SUFFIX PYLON_CONFIGURATION "_TL", "dll" )
...
#define PYLON_LIB_NAME( module )  module PYLON_SUFFIX( PYLON_CPP_VERSION_SUFFIX PYLON_CONFIGURATION, "lib" )
#define PYLON_DLL_NAME( module )  module PYLON_SUFFIX( PYLON_CPP_VERSION_SUFFIX PYLON_CONFIGURATION, "dll" )
