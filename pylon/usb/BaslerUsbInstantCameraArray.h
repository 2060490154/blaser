//-----------------------------------------------------------------------------
//  Basler pylon SDK
//  Copyright (c) 2012-2025 Basler AG
...
namespace Pylon
{
    ...
    */
    class PYLON_DEPRECATED("Use CBaslerUniversalInstantCameraArray") CBaslerUsbInstantCameraArray : public CDeviceSpecificInstantCameraArrayT<CBaslerUsbInstantCamera>
    {
    public:
        /*!
