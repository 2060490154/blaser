...
namespace Pylon
{
    ...
    */
    class PYLON_DEPRECATED("Use CBaslerUniversalInstantCameraArray") CBaslerGigEInstantCameraArray : public CDeviceSpecificInstantCameraArrayT<CBaslerGigEInstantCamera>
    {
    public:
        /*!
