...
// Suppress the unreachable code warning for MSVC > 14.16 (Visual Studio 2019)
// compilers, as it occurs due to DeviceClass() throwing an intentional exception
// in the CBaslerUniversalInstantCamera case.
#  pragma warning(push)
