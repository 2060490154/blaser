//-----------------------------------------------------------------------------
//  Basler pylon SDK
//  Copyright (c) 2019-2025 Basler AG
...
namespace Basler_UniversalCameraParams
{
    ...
    {
        AcquisitionMode_Continuous,  //!< The acquisition mode is set to Continuous - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        AcquisitionMode_MultiFrame,  //!< The acquisition mode is set to Multi Frame - Applies to: CameraLink, Stereo ace and ace GigE
        AcquisitionMode_SingleFrame  //!< The acquisition mode is set to Single Frame - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for AcquisitionStatusSelector
    enum AcquisitionStatusSelectorEnums
    {
        AcquisitionStatusSelector_AcquisitionActive,  //!< A check determines whether the camera is currently acquiring one or multiple frames - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        AcquisitionStatusSelector_AcquisitionIdle,  //!< A check determines whether the camera is currently idle - Applies to: ace GigE
        AcquisitionStatusSelector_AcquisitionTransfer,  //!< A check determines whether the camera is currently transferring an acquisition of one or multiple frames - Applies to: CameraLink and ace GigE
        AcquisitionStatusSelector_AcquisitionTriggerWait,  //!< A check determines whether the camera is currently waiting for a trigger to acquire one or multiple frames - Applies to: CameraLink and ace GigE
        AcquisitionStatusSelector_ExposureActive,  //!< A check determines whether the camera is currently exposing a frame - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        AcquisitionStatusSelector_ExposureTriggerWait,  //!< A check determines whether the camera is currently waiting for an Exposure Start trigger signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        AcquisitionStatusSelector_FlashWindow,  //!< A check determines whether the camera is currently within the flash window, i e  whether flash lighting can be used - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and dart USB
        AcquisitionStatusSelector_FrameActive,  //!< A check determines whether the camera is currently capturing a frame - Applies to: CameraLink, ace GigE, ace USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        AcquisitionStatusSelector_FrameBurstActive,  //!< A check determines whether the camera is currently doing a frame burst of one or many frames - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE and racer 2S GigE
        ...
        AcquisitionStatusSelector_FrameBurstTriggerWait,  //!< A check determines whether the camera is currently waiting for a frame burst trigger - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE and racer 2S GigE
        AcquisitionStatusSelector_FrameTransfer,  //!< A check determines whether the camera is currently transferring a frame - Applies to: CameraLink, ace GigE and ace USB
        AcquisitionStatusSelector_FrameTriggerWait,  //!< A check determines whether the camera is currently waiting for a frame trigger - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        AcquisitionStatusSelector_LineTriggerWait  //!< A check determines whether the camera is currently waiting for a line trigger - Applies to: CameraLink, ace GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for AcquisitionStopMode
    enum AcquisitionStopModeEnums
    {
        AcquisitionStopMode_AbortExposure,  //!< Current exposure is aborted - Applies to: ace 2 GigE, ace 2 USB and dart GigE
        AcquisitionStopMode_Complete,  //!< Current exposure and frame readout are completed  Afterwards, image acquisition is switched off   - Applies to: ace 2 GigE, ace 2 USB and dart GigE
    ...
    {
        AutoFunctionAOISelector_AOI1,  //!< Auto function AOI 1 can be configured - Applies to: CameraLink and ace GigE
        AutoFunctionAOISelector_AOI2,  //!< Auto function AOI 2 can be configured - Applies to: CameraLink and ace GigE
        AutoFunctionAOISelector_AOI3,  //!< Applies to: CameraLink and ace GigE
        AutoFunctionAOISelector_AOI4,  //!< Applies to: CameraLink and ace GigE
        AutoFunctionAOISelector_AOI5,  //!< Applies to: CameraLink and ace GigE
        AutoFunctionAOISelector_AOI6,  //!< Applies to: CameraLink and ace GigE
        AutoFunctionAOISelector_AOI7,  //!< Applies to: CameraLink and ace GigE
        AutoFunctionAOISelector_AOI8  //!< Applies to: CameraLink and ace GigE
    };
    ...
    enum AutoFunctionProfileEnums
    {
        ...
        AutoFunctionProfile_ExposureMinimum,  //!< Exposure time is kept as low as possible - Applies to: CameraLink and ace GigE
        AutoFunctionProfile_ExposureMinimumQuick,  //!< Exposure time is kept as low as possible and is adjusted quickly - Applies to: ace GigE
        AutoFunctionProfile_GainMinimum,  //!< Gain is kept as low as possible - Applies to: CameraLink and ace GigE
        AutoFunctionProfile_GainMinimumQuick,  //!< Gain time is kept as low as possible and is adjusted quickly - Applies to: ace GigE
        AutoFunctionProfile_MinimizeExposureTime,  //!< Exposure time is kept as low as possible - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        AutoFunctionProfile_MinimizeGain,  //!< Gain is kept as low as possible - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    ...
    {
        AutoFunctionROISelector_ROI1,  //!< Auto function ROI 1 can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        AutoFunctionROISelector_ROI2  //!< Auto function ROI 2 can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for AutoTonalRangeAdjustmentSelector
    enum AutoTonalRangeAdjustmentSelectorEnums
    {
        AutoTonalRangeAdjustmentSelector_Bright,  //!< Only the bright end of the tonal range can be adjusted - Applies to: ace GigE and ace USB
        AutoTonalRangeAdjustmentSelector_Dark,  //!< Only the dark end of the tonal range can be adjusted - Applies to: ace GigE and ace USB
        AutoTonalRangeAdjustmentSelector_DarkAndBright  //!< The dark and bright end of the tonal range can be adjusted - Applies to: ace GigE and ace USB
    };

    //! Valid values for AutoTonalRangeModeSelector
    enum AutoTonalRangeModeSelectorEnums
    {
        AutoTonalRangeModeSelector_Color,  //!< Only color is adjusted - Applies to: ace GigE and ace USB
        AutoTonalRangeModeSelector_ColorAndContrast,  //!< Color and contrast are adjusted - Applies to: ace GigE and ace USB
        AutoTonalRangeModeSelector_Contrast  //!< Only contrast is adjusted - Applies to: ace GigE and ace USB
    };

    //! Valid values for BLCSerialPortBaudRate
    enum BLCSerialPortBaudRateEnums
    {
        BLCSerialPortBaudRate_Baud115200  //!< The baud rate is 115200 Bd - Applies to: ace GigE and ace USB
    };

    //! Valid values for BLCSerialPortParity
    enum BLCSerialPortParityEnums
    {
        BLCSerialPortParity_Even,  //!< The serial communication module uses an even parity bit - Applies to: ace GigE and ace USB
        BLCSerialPortParity_Odd,  //!< The serial communication module uses an odd parity bit - Applies to: ace GigE and ace USB
        BLCSerialPortParity_Off  //!< The serial communication module does not use a parity bit - Applies to: ace GigE and ace USB
    };

    //! Valid values for BLCSerialPortSource
    enum BLCSerialPortSourceEnums
    {
        BLCSerialPortSource_Line3,  //!< The signal source for the serial communication module is set to line 3 - Applies to: ace GigE and ace USB
        BLCSerialPortSource_Line4,  //!< The signal source for the serial communication module is set to line 4 - Applies to: ace GigE and ace USB
        BLCSerialPortSource_Off  //!< The signal source for the serial communication module is disabled - Applies to: ace GigE and ace USB
    };

    //! Valid values for BLCSerialPortStopBits
    enum BLCSerialPortStopBitsEnums
    {
        BLCSerialPortStopBits_StopBits0,  //!< The serial communication module does not use a stop bit - Applies to: ace GigE and ace USB
        BLCSerialPortStopBits_StopBits1  //!< The serial communication module does uses 1 stop bit - Applies to: ace GigE and ace USB
    };

    //! Valid values for BLCSerialReceiveQueueStatus
    enum BLCSerialReceiveQueueStatusEnums
    {
        BLCSerialReceiveQueueStatus_Empty,  //!< The receive queue is empty - Applies to: ace GigE and ace USB
        BLCSerialReceiveQueueStatus_Filled,  //!< The receive queue contains at least one value - Applies to: ace GigE and ace USB
        BLCSerialReceiveQueueStatus_Full  //!< The receive queue is full - Applies to: ace GigE and ace USB
    };

    //! Valid values for BLCSerialTransmitQueueStatus
    enum BLCSerialTransmitQueueStatusEnums
    {
        BLCSerialTransmitQueueStatus_Empty,  //!< The transmit queue is empty - Applies to: ace GigE and ace USB
        BLCSerialTransmitQueueStatus_Filled,  //!< The transmit queue contains at least one value - Applies to: ace GigE and ace USB
        BLCSerialTransmitQueueStatus_Full  //!< The transmit queue is full - Applies to: ace GigE and ace USB
    };

    //! Valid values for BalanceRatioSelector
    enum BalanceRatioSelectorEnums
    {
        BalanceRatioSelector_Blue,  //!< Balance ratio is applied to the blue channel - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BalanceRatioSelector_Green,  //!< Balance ratio is applied to the green channel - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BalanceRatioSelector_Red  //!< Balance ratio is applied to the red channel - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for BalanceWhiteAuto
    enum BalanceWhiteAutoEnums
    {
        BalanceWhiteAuto_Continuous,  //!< White balance is adjusted continuously while images are being acquired - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB and pulse USB
        BalanceWhiteAuto_Off,  //!< The Balance White Auto auto function is disabled - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BalanceWhiteAuto_Once  //!< White balance is adjusted automatically to reach the specified target value - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for BandwidthReserveMode
    enum BandwidthReserveModeEnums
    {
        BandwidthReserveMode_Manual,  //!< The bandwidth reserve can be configured manually - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        BandwidthReserveMode_Performance,  //!< The bandwidth reserve is set to 5 % - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        BandwidthReserveMode_Standard  //!< The bandwidth reserve is set to 10 % - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
    };

    //! Valid values for BinningHorizontalMode
    enum BinningHorizontalModeEnums
    {
        BinningHorizontalMode_Average,  //!< The values of the binned pixels are averaged - Applies to: CamEmu, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BinningHorizontalMode_Sum  //!< The values of the binned pixels are summed - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };
    ...
    {
        BinningSelector_Region1,  //!< FPGA binning can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BinningSelector_Sensor  //!< Sensor binning can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and dart USB
    };

    //! Valid values for BinningVerticalMode
    enum BinningVerticalModeEnums
    {
        BinningVerticalMode_Average,  //!< The values of the binned pixels are averaged - Applies to: CamEmu, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, pulse USB and racer 2 CXP
        BinningVerticalMode_Sum  //!< The values of the binned pixels are summed - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, pulse USB and racer 2 CXP
    };

    //! Valid values for BlackLevelSelector
    enum BlackLevelSelectorEnums
    {
        BlackLevelSelector_All,  //!< The black level value is applied universally - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BlackLevelSelector_AnalogAll,  //!< Selects all analog black level controls for adjustment - Applies to: CameraLink and ace GigE
        BlackLevelSelector_Blue,  //!< Selects the blue black level control for adjustment - Applies to: CameraLink and ace GigE
        BlackLevelSelector_DigitalAll,  //!< Selects all digital black level controls for adjustment - Applies to: CameraLink and ace GigE
        BlackLevelSelector_Green,  //!< Selects the green black level control for adjustment - Applies to: CameraLink and ace GigE
        BlackLevelSelector_Line1,  //!< The black level value is applied to line 1 - Applies to: racer 2 CXP
        BlackLevelSelector_Line2,  //!< The black level value is applied to line 2 - Applies to: racer 2 CXP
        BlackLevelSelector_Line3,  //!< The black level value is applied to line 3 - Applies to: racer 2 CXP
        BlackLevelSelector_Line4,  //!< The black level value is applied to line 4 - Applies to: racer 2 CXP
        BlackLevelSelector_Red,  //!< Selects the red black level control for adjustment - Applies to: CameraLink and ace GigE
        BlackLevelSelector_SensorAll,  //!< The black level value is applied to the sensor - Applies to: racer 2 CXP
        BlackLevelSelector_Tap1,  //!< The black level value is applied to sensor tap 1 - Applies to: CameraLink and ace GigE
        BlackLevelSelector_Tap2,  //!< The black level value is applied to sensor tap 2 - Applies to: CameraLink and ace GigE
        BlackLevelSelector_Tap3,  //!< The black level value is applied to sensor tap 3 - Applies to: CameraLink and ace GigE
        BlackLevelSelector_Tap4  //!< The black level value is applied to sensor tap 4 - Applies to: CameraLink and ace GigE
    };
    ...
    {
        BslAcquisitionBurstMode_HighSpeed,  //!< The High Speed burst mode is enabled - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and dart USB
        BslAcquisitionBurstMode_Standard  //!< The Standard burst mode is enabled - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE and racer 2S GigE
    };
    ...
    {
        BslAcquisitionStopMode_AbortExposure,  //!< Acquisition Stop commands abort exposure - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart USB and racer 2 CXP
        BslAcquisitionStopMode_CompleteExposure  //!< Acquisition Stop commands allow the exposure to be completed - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart USB and racer 2 CXP
    };
    ...
    //! Valid values for BslAutoFunctionMeteringMode
    enum BslAutoFunctionMeteringModeEnums
    {
        BslAutoFunctionMeteringMode_AutoAverage,  //!< Auto Average - Applies to: dart MIPI
        BslAutoFunctionMeteringMode_AutoNarrowCenter,  //!< Auto Narrow Center - Applies to: dart MIPI
        BslAutoFunctionMeteringMode_AutoSpot,  //!< Auto Spot - Applies to: dart MIPI
        BslAutoFunctionMeteringMode_AutoWideCenter  //!< Auto Wide Center - Applies to: dart MIPI
    };
    ...
    {
        BslChunkAutoBrightnessStatus_Disabled,  //!< Target brightness adjustments are disabled, i e , Gain Auto and Exposure Auto are set to Off   - Applies to: ace 2 GigE, ace 2 USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        BslChunkAutoBrightnessStatus_TargetNotReached,  //!< Target brightness adjustments are enabled, but the target brightness value has not been reached - Applies to: ace 2 GigE, ace 2 USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        BslChunkAutoBrightnessStatus_TargetReached  //!< Target brightness adjustments are enabled, and the target brightness value has been reached - Applies to: ace 2 GigE, ace 2 USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
    };

    //! Valid values for BslChunkTimestampSelector
    enum BslChunkTimestampSelectorEnums
    {
        BslChunkTimestampSelector_ExposureEnd,  //!< The Chunk Timestamp Value parameter indicates when exposure of the current image ended - Applies to: ace 2 GigE, ace 2 USB, dart GigE and dart USB
        BslChunkTimestampSelector_ExposureStart,  //!< The Chunk Timestamp Value parameter indicates when exposure of the current image started - Applies to: ace 2 GigE, ace 2 USB, dart GigE and dart USB
        BslChunkTimestampSelector_FrameStart  //!< The Chunk Timestamp Value parameter indicates when acquisition of the current image started - Applies to: ace 2 GigE, ace 2 USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
    };

    //! Valid values for BslColorAdjustmentSelector
    enum BslColorAdjustmentSelectorEnums
    {
        BslColorAdjustmentSelector_Blue,  //!< Colors with a predominant blue component can be adjusted - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslColorAdjustmentSelector_Cyan,  //!< Colors with a predominant cyan component can be adjusted - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslColorAdjustmentSelector_Green,  //!< Colors with a predominant green component can be adjusted - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslColorAdjustmentSelector_Magenta,  //!< Colors with a predominant magenta component can be adjusted - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslColorAdjustmentSelector_Red,  //!< Colors with a predominant red component can be adjusted - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslColorAdjustmentSelector_Yellow  //!< Colors with a predominant yellow component can be adjusted - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for BslColorSpace
    enum BslColorSpaceEnums
    {
        BslColorSpace_Off,  //!< No additional gamma correction value is applied - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslColorSpace_sRgb  //!< The color space is set to sRGB - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };
    ...
    {
        BslContrastMode_Linear,  //!< The camera uses a linear function to adjust the contrast - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslContrastMode_SCurve  //!< The camera uses an S-curve function to adjust the contrast - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for BslConversionGainMode
    enum BslConversionGainModeEnums
    {
        BslConversionGainMode_High,  //!< The conversion gain mode is set to High - Applies to: ace 2 GigE, ace 2 USB and dart GigE
        BslConversionGainMode_Low  //!< The conversion gain mode is set to Low - Applies to: ace 2 GigE, ace 2 USB and dart GigE
    };

    //! Valid values for BslDefectPixelCorrectionMode
    enum BslDefectPixelCorrectionModeEnums
    {
        BslDefectPixelCorrectionMode_Off,  //!< Defect pixel correction is disabled - Applies to: dart MIPI and dart USB
        BslDefectPixelCorrectionMode_On,  //!< Defect pixel correction is enabled - Applies to: dart MIPI and dart USB
        BslDefectPixelCorrectionMode_StaticOnly  //!< Only static defect pixel correction is enabled - Applies to: dart USB
    };

    //! Valid values for BslDemosaicingMethod
    enum BslDemosaicingMethodEnums
    {
        BslDemosaicingMethod_AverageGreen,  //!< Demosaicing is performed using the Average Green algorithm - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and dart USB
        ...
        BslDemosaicingMethod_NearestNeighbor,  //!< Demosaicing is performed using the Nearest Neighbor algorithm - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and dart USB
        BslDemosaicingMethod_Unilinear  //!< Demosaicing is performed using the Unilinear algorithm - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and dart USB
    };

    //! Valid values for BslDemosaicingMode
    enum BslDemosaicingModeEnums
    {
        BslDemosaicingMode_Auto,  //!< The demosaicing method is determined automatically - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and dart USB
        BslDemosaicingMode_Manual  //!< The demosaicing method can be set manually - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and dart USB
    };
    ...
    {
        BslLightControlErrorStatus_Device1,  //!< Light device 1 is experiencing problems - Applies to: ace GigE and ace USB
        BslLightControlErrorStatus_Device2,  //!< Light device 2 is experiencing problems - Applies to: ace GigE and ace USB
        BslLightControlErrorStatus_Device3,  //!< Light device 3 is experiencing problems - Applies to: ace GigE and ace USB
        BslLightControlErrorStatus_Device4,  //!< Light device 4 is experiencing problems - Applies to: ace GigE and ace USB
        BslLightControlErrorStatus_MultipleDevices,  //!< Multiple light devices are experiencing problems - Applies to: ace GigE and ace USB
        BslLightControlErrorStatus_NoError  //!< No error was detected - Applies to: ace GigE and ace USB
    };

    //! Valid values for BslLightControlErrorSummary
    enum BslLightControlErrorSummaryEnums
    {
        BslLightControlErrorSummary_Device1,  //!< Light device 1 is experiencing problems - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightControlErrorSummary_Device2,  //!< Light device 2 is experiencing problems - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightControlErrorSummary_Device3,  //!< Light device 3 is experiencing problems - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightControlErrorSummary_Device4,  //!< Light device 4 is experiencing problems - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightControlErrorSummary_MultipleDevices,  //!< Multiple light devices are experiencing problems - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightControlErrorSummary_NoDevice,  //!< No light device has been detected - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightControlErrorSummary_NoError  //!< No error was detected - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
    };

    //! Valid values for BslLightControlMode
    enum BslLightControlModeEnums
    {
        BslLightControlMode_Off,  //!< The light control features are disabled - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress and dart GigE
        BslLightControlMode_On  //!< The light control features are enabled - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress and dart GigE
    };

    //! Valid values for BslLightControlSource
    enum BslLightControlSourceEnums
    {
        BslLightControlSource_Line3,  //!< Line 3 is used to control the light features - Applies to: ace GigE and ace USB
        BslLightControlSource_Line4,  //!< Line 4 is used to control the light features - Applies to: ace GigE and ace USB
        BslLightControlSource_Off  //!< No line is used to control the light features - Applies to: ace GigE and ace USB
    };

    //! Valid values for BslLightControlStatus
    enum BslLightControlStatusEnums
    {
        BslLightControlStatus_Idle,  //!< No light device has been detected - Applies to: ace GigE and ace USB
        BslLightControlStatus_Off,  //!< The light control mode is disabled - Applies to: ace GigE and ace USB
        BslLightControlStatus_Ready,  //!< The light device is ready for use - Applies to: ace GigE and ace USB
        BslLightControlStatus_Searching,  //!< The controller ist searching for light devices connected to your camera - Applies to: ace GigE and ace USB
        BslLightControlStatus_Updating  //!< Parameters are being updated - Applies to: ace GigE and ace USB
    };

    //! Valid values for BslLightControlTriggerActivation
    enum BslLightControlTriggerActivationEnums
    {
        BslLightControlTriggerActivation_AnyEdge,  //!< The light device is triggered when the source signal falls or rises - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightControlTriggerActivation_FallingEdge,  //!< The light device is triggered when the source signal falls - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightControlTriggerActivation_RisingEdge  //!< The light device is triggered when the source signal rises - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
    };

    //! Valid values for BslLightControlTriggerSource
    enum BslLightControlTriggerSourceEnums
    {
        BslLightControlTriggerSource_AcquisitionActive,  //!< The light device can be triggered by an Acquisition Active signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightControlTriggerSource_Action1,  //!< The light device can be triggered by an Action 1 signal - Applies to: ace 2 GigE and dart GigE
        BslLightControlTriggerSource_Action2,  //!< The light device can be triggered by an Action 2 signal - Applies to: ace 2 GigE
        BslLightControlTriggerSource_Counter1Active,  //!< The light device can be triggered by a Counter 1 Active signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightControlTriggerSource_Counter1End,  //!< The light device can be triggered by a Counter 1 End signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightControlTriggerSource_Counter1Start,  //!< The light device can be triggered by a Counter 1 Start signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightControlTriggerSource_Counter2Active,  //!< The light device can be triggered by a Counter 2 Active signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightControlTriggerSource_Counter2End,  //!< The light device can be triggered by a Counter 2 End signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightControlTriggerSource_Counter2Start,  //!< The light device can be triggered by a Counter 2 Start signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        ...
        BslLightControlTriggerSource_ExposureActive,  //!< The light device can be triggered by an Exposure Active signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightControlTriggerSource_ExposureStart,  //!< The light device can be triggered by an Exposure Start signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightControlTriggerSource_ExposureTriggerWait,  //!< The light device can be triggered by an Exposure Trigger Wait signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightControlTriggerSource_FlashWindow,  //!< The light device can be triggered by a Flash Window signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightControlTriggerSource_FrameBurstActive,  //!< The light device can be triggered by a Frame Burst Active signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightControlTriggerSource_FrameBurstTriggerWait,  //!< The light device can be triggered by a Frame Burst Trigger Wait signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightControlTriggerSource_FrameTriggerWait,  //!< The light device can be triggered by a Frame Trigger Wait signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightControlTriggerSource_Line1,  //!< The light device can be triggered by a Line 1 signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        ...
        BslLightControlTriggerSource_Line3,  //!< The light device can be triggered by a Line 3 signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightControlTriggerSource_PeriodicSignal1,  //!< The light device can be triggered by a Periodic Signal 1 signal - Applies to: ace 2 GigE and dart GigE
        BslLightControlTriggerSource_SoftwareSignal1,  //!< The light device can be triggered by a Software Signal 1 signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightControlTriggerSource_SoftwareSignal2,  //!< The light device can be triggered by a Software Signal 2 signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightControlTriggerSource_SoftwareSignal3,  //!< The light device can be triggered by a Software Signal 3 signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightControlTriggerSource_Timer1Active,  //!< The light device can be triggered by a Timer 1 Active signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightControlTriggerSource_Timer1End,  //!< The light device can be triggered by a Timer 1 End signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightControlTriggerSource_Timer2Active,  //!< The light device can be triggered by a Timer 2 Active signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightControlTriggerSource_Timer2End  //!< The light device can be triggered by a Timer 2 End signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
    };

    //! Valid values for BslLightDeviceChangeID
    enum BslLightDeviceChangeIDEnums
    {
        BslLightDeviceChangeID_Device1,  //!< The ID of the currently selected light device is changed to Device 1 - Applies to: ace GigE and ace USB
        BslLightDeviceChangeID_Device2,  //!< The ID of the currently selected light device is changed to Device 2 - Applies to: ace GigE and ace USB
        BslLightDeviceChangeID_Device3,  //!< The ID of the currently selected light device is changed to Device 3 - Applies to: ace GigE and ace USB
        BslLightDeviceChangeID_Device4  //!< The ID of the currently selected light device is changed to Device 4 - Applies to: ace GigE and ace USB
    };

    //! Valid values for BslLightDeviceControlMode
    enum BslLightDeviceControlModeEnums
    {
        BslLightDeviceControlMode_Current,  //!< The light device is controlled by current - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightDeviceControlMode_Voltage12V,  //!< The light device is controlled by 12 V voltage - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightDeviceControlMode_Voltage24V  //!< The light device is controlled by 24 V voltage - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
    };

    //! Valid values for BslLightDeviceErrorStatus
    enum BslLightDeviceErrorStatusEnums
    {
        BslLightDeviceErrorStatus_CommunicationError,  //!< The data transmission between the camera and the light device is disrupted - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightDeviceErrorStatus_ConnectionLost,  //!< The connection to a previously connected light device has been lost - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightDeviceErrorStatus_HardwareError,  //!< The light device is experiencing a technical fault - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightDeviceErrorStatus_LightDeviceError,  //!< The light device is experiencing an internal error - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightDeviceErrorStatus_NoError,  //!< No error was detected - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightDeviceErrorStatus_NotConnected,  //!< The light device is not connected to the camera or has not been enumerated yet - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightDeviceErrorStatus_UnsupportedDeviceVersion  //!< The light device is not compatible with the current camera - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
    };

    //! Valid values for BslLightDeviceLastError
    enum BslLightDeviceLastErrorEnums
    {
        BslLightDeviceLastError_Communication,  //!< The data transmission between the camera and the light device is disrupted - Applies to: ace GigE and ace USB
        BslLightDeviceLastError_Connection,  //!< The connection between the camera and the light device is broken - Applies to: ace GigE and ace USB
        BslLightDeviceLastError_Hardware,  //!< The light device is experiencing a technical fault - Applies to: ace GigE and ace USB
        BslLightDeviceLastError_InsufficientCurrent,  //!< The light controller is unable to supply the requested current - Applies to: ace GigE and ace USB
        BslLightDeviceLastError_NoError,  //!< No error was detected - Applies to: ace GigE and ace USB
        BslLightDeviceLastError_ShortCircuit  //!< There is a short circuit at the Lighting connector of the light controller - Applies to: ace GigE and ace USB
    };

    //! Valid values for BslLightDeviceNewID
    enum BslLightDeviceNewIDEnums
    {
        BslLightDeviceNewID_Device1,  //!< The ID of the currently selected light device can be set to Device 1 - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightDeviceNewID_Device2,  //!< The ID of the currently selected light device can be set to Device 2 - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightDeviceNewID_Device3,  //!< The ID of the currently selected light device can be set to Device 3 - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLightDeviceNewID_Device4  //!< The ID of the currently selected light device can be set to Device 4 - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
    };

    //! Valid values for BslLightDeviceOperationMode
    enum BslLightDeviceOperationModeEnums
    {
        BslLightDeviceOperationMode_Off,  //!< The currently selected light device is switched off - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress and dart GigE
        BslLightDeviceOperationMode_On,  //!< The currently selected light device is switched on - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress and dart GigE
        BslLightDeviceOperationMode_Strobe  //!< The currently selected light device is set to strobe mode - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress and dart GigE
    };

    //! Valid values for BslLightDeviceSelector
    enum BslLightDeviceSelectorEnums
    {
        BslLightDeviceSelector_Device1,  //!< Light device 1 can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress and dart GigE
        BslLightDeviceSelector_Device2,  //!< Light device 2 can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress and dart GigE
        BslLightDeviceSelector_Device3,  //!< Light device 3 can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress and dart GigE
        BslLightDeviceSelector_Device4  //!< Light device 4 can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress and dart GigE
    };

    //! Valid values for BslLightDeviceStrobeMode
    enum BslLightDeviceStrobeModeEnums
    {
        BslLightDeviceStrobeMode_Automatic,  //!< The timing of the individual strobe pulses is determined by the Exposure Active signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress and dart GigE
        BslLightDeviceStrobeMode_Manual  //!< The timing of the individual strobe pulses can be specified manually - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress and dart GigE
    };
    ...
    enum BslLightSourcePresetEnums
    {
        ...
        BslLightSourcePreset_Daylight5000K,  //!< The light source preset for image acquisitions with daylight of 5000 K is selected - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslLightSourcePreset_Daylight6500K,  //!< The light source preset for image acquisitions with daylight of 6500 K is selected - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        BslLightSourcePreset_FactoryLED6000K,  //!< The light source preset for image acquisitions with LED light is selected - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        BslLightSourcePreset_LineLED5500K,  //!< The light source preset for image acquisitions with line LED is selected - Applies to: racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslLightSourcePreset_Manual,  //!< The color temperature of the light source is determined manually - Applies to: dart MIPI
        BslLightSourcePreset_Off,  //!< No light source preset is selected - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslLightSourcePreset_Tungsten,  //!< The light source preset for image acquisitions with tungsten incandescent light is selected - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and dart USB
    ...
    {
        BslLightSourcePresetFeatureSelector_ColorAdjustment,  //!< Adjustment of the Color Adjustment feature can be enabled or disabled - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslLightSourcePresetFeatureSelector_ColorTransformation,  //!< Adjustment of the Color Transformation feature can be enabled or disabled - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslLightSourcePresetFeatureSelector_WhiteBalance  //!< Adjustment of the Balance White feature can be enabled or disabled - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for BslLineCombinationMode
    enum BslLineCombinationModeEnums
    {
        BslLineCombinationMode_Off,  //!< Line combination mode is disabled - Applies to: racer 2 CXP
        BslLineCombinationMode_TDIAverage,  //!< The values of the binned pixels are averaged - Applies to: racer 2 CXP
        BslLineCombinationMode_TDISum  //!< The values of the binned pixels are summed - Applies to: racer 2 CXP
    };

    //! Valid values for BslLineConnection
    enum BslLineConnectionEnums
    {
        BslLineConnection_ConnectionOff,  //!< No connection signal is set for the currently selected line - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and dart USB
        BslLineConnection_LightControl,  //!< The Light Control signal is set for the currently selected line - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslLineConnection_TwiScl,  //!< The TWI SCL signal is set for the currently selected line - Applies to: dart USB
        BslLineConnection_TwiSda  //!< The TWI SDA signal is set for the currently selected line - Applies to: dart USB
    };

    //! Valid values for BslMultipleROIColumnSelector
    enum BslMultipleROIColumnSelectorEnums
    {
        BslMultipleROIColumnSelector_Column1,  //!< Column 1 can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslMultipleROIColumnSelector_Column2,  //!< Column 2 can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslMultipleROIColumnSelector_Column3,  //!< Column 3 can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslMultipleROIColumnSelector_Column4,  //!< Column 4 can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslMultipleROIColumnSelector_Column5,  //!< Column 5 can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslMultipleROIColumnSelector_Column6,  //!< Column 6 can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslMultipleROIColumnSelector_Column7,  //!< Column 7 can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslMultipleROIColumnSelector_Column8  //!< Column 8 can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
    };

    //! Valid values for BslMultipleROIRowSelector
    enum BslMultipleROIRowSelectorEnums
    {
        BslMultipleROIRowSelector_Row1,  //!< Row 1 can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        ...
        BslMultipleROIRowSelector_Row2,  //!< Row 2 can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslMultipleROIRowSelector_Row3,  //!< Row 3 can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslMultipleROIRowSelector_Row4,  //!< Row 4 can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslMultipleROIRowSelector_Row5,  //!< Row 5 can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslMultipleROIRowSelector_Row6,  //!< Row 6 can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslMultipleROIRowSelector_Row7,  //!< Row 7 can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslMultipleROIRowSelector_Row8,  //!< Row 8 can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
    ...
    {
        BslPeriodicSignalSelector_PeriodicSignal1  //!< Periodic Signal 1 can be configured - Applies to: ace 2 GigE, dart GigE, dart MIPI, racer 2S 5GigE and racer 2S GigE
    };

    //! Valid values for BslPeriodicSignalSource
    enum BslPeriodicSignalSourceEnums
    {
        BslPeriodicSignalSource_DeviceClock,  //!< The camera is synchronized via the device clock - Applies to: ace 2 GigE, dart GigE, dart MIPI, racer 2S 5GigE and racer 2S GigE
        BslPeriodicSignalSource_Line1,  //!< The camera is synchronized via Line 1 - Applies to: dart MIPI
        BslPeriodicSignalSource_PtpClock  //!< The camera is synchronized via the PTP clock - Applies to: ace 2 GigE, dart GigE, dart MIPI, racer 2S 5GigE and racer 2S GigE
    };

    //! Valid values for BslPtpDelayMechanism
    enum BslPtpDelayMechanismEnums
    {
        BslPtpDelayMechanism_E2E,  //!< The port is configured to use the delay request-response mechanism - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        BslPtpDelayMechanism_P2P  //!< The port is configured to use the peer delay mechanism - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
    };

    //! Valid values for BslPtpNetworkMode
    enum BslPtpNetworkModeEnums
    {
        BslPtpNetworkMode_Hybrid,  //!< Hybrid network communication is enabled - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        BslPtpNetworkMode_Multicast,  //!< Multicast network communication is enabled - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        BslPtpNetworkMode_Unicast  //!< Unicast network communication is enabled - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
    };

    //! Valid values for BslPtpProfile
    enum BslPtpProfileEnums
    {
        BslPtpProfile_DelayRequestResponseDefaultProfile,  //!< The default PTP profile is set to Delay Request-Response - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        BslPtpProfile_PeerToPeerDefaultProfile  //!< The default PTP profile is set to Peer-to-Peer - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
    };

    //! Valid values for BslSensorAcquisitionMode
    enum BslSensorAcquisitionModeEnums
    {
        BslSensorAcquisitionMode_DualLine,  //!< The sensor acquisition mode is set to Dual Line - Applies to: racer 2 CXP
        BslSensorAcquisitionMode_QuadLine,  //!< The sensor acquisition mode is set to Quad Line - Applies to: racer 2 CXP
    ...
    {
        BslSensorBitDepth_Bpp10,  //!< The sensor bit depth is set to 10 bits per pixel - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB and racer 2 CXP
        BslSensorBitDepth_Bpp12,  //!< The sensor bit depth is set to 12 bits per pixel - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslSensorBitDepth_Bpp8  //!< The sensor bit depth is set to 8 bits per pixel - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for BslSensorBitDepthMode
    enum BslSensorBitDepthModeEnums
    {
        BslSensorBitDepthMode_Auto,  //!< The sensor bit depth mode is set to Auto - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslSensorBitDepthMode_Manual  //!< The sensor bit depth mode is set to Manual - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for BslSensorState
    enum BslSensorStateEnums
    {
        BslSensorState_Off,  //!< The sensor power is switched off - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslSensorState_On,  //!< The sensor power is switched on - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        BslSensorState_Standby  //!< The sensor is in standby mode - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for BslSerialBaudRate
    enum BslSerialBaudRateEnums
    {
        BslSerialBaudRate_Baud115200,  //!< A symbol rate of 115200 baud is used in serial communication - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
        BslSerialBaudRate_Baud1200,  //!< A symbol rate of 1200 baud is used in serial communication - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
        BslSerialBaudRate_Baud19200,  //!< A symbol rate of 19200 baud is used in serial communication - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
        BslSerialBaudRate_Baud2400,  //!< A symbol rate of 2400 baud is used in serial communication - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
        BslSerialBaudRate_Baud38400,  //!< A symbol rate of 38400 baud is used in serial communication - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
        BslSerialBaudRate_Baud4800,  //!< A symbol rate of 4800 baud is used in serial communication - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
        BslSerialBaudRate_Baud57600,  //!< A symbol rate of 57600 baud is used in serial communication - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
        BslSerialBaudRate_Baud9600  //!< A symbol rate of 9600 baud is used in serial communication - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
    };

    //! Valid values for BslSerialNumberOfDataBits
    enum BslSerialNumberOfDataBitsEnums
    {
        BslSerialNumberOfDataBits_Bits7,  //!< Seven data bits per frame are used in serial communication - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
        BslSerialNumberOfDataBits_Bits8  //!< Eight data bits per frame are used in serial communication - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
    };

    //! Valid values for BslSerialNumberOfStopBits
    enum BslSerialNumberOfStopBitsEnums
    {
        BslSerialNumberOfStopBits_Bits1,  //!< One stop bit is used in serial communication - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
        BslSerialNumberOfStopBits_Bits2  //!< Two stop bits are used in serial communication - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
    };

    //! Valid values for BslSerialParity
    enum BslSerialParityEnums
    {
        BslSerialParity_Even,  //!< An even parity check is performed - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
        BslSerialParity_None,  //!< No parity check is performed - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
        BslSerialParity_Odd  //!< An odd parity check is performed - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
    };

    //! Valid values for BslSerialRxSource
    enum BslSerialRxSourceEnums
    {
        BslSerialRxSource_Line1,  //!< The source of the Rx serial input is set to Line 1 - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
        ...
        BslSerialRxSource_Line3,  //!< The source of the Rx serial input is set to Line 3 - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
        BslSerialRxSource_Off,  //!< Rx input is muted - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
        BslSerialRxSource_SerialTx  //!< The source of the Rx serial input is set to Serial Tx - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
    };

    //! Valid values for BslSerialTransmitMode
    enum BslSerialTransmitModeEnums
    {
        BslSerialTransmitMode_FullDuplex,  //!< Transmit and receive can happen simultaneously - Applies to: ace 2 GigE, ace 2 USB, dart GigE and racer 2 CXP
        BslSerialTransmitMode_HalfDuplex  //!< Receiving will be stopped when data is transmitted - Applies to: ace 2 GigE, ace 2 USB, dart GigE and racer 2 CXP
    };
    ...
    //! Valid values for BslShadingCorrectionROISelector
    enum BslShadingCorrectionROISelectorEnums
    {
        BslShadingCorrectionROISelector_ROI1  //!< Shading ROI 1 can be configured - Applies to: racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };
    ...
    enum BslShadingCorrectionSetStatusEnums
    {
        ...
        BslShadingCorrectionSetStatus_InvalidFileFormat,  //!< The file format of the shading correction set is invalid - Applies to: racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    ...
    //! Valid values for BslShadingCorrectionTargetSelector
    enum BslShadingCorrectionTargetSelectorEnums
    {
        BslShadingCorrectionTargetSelector_All,  //!< PRNU target value is applied universally - Applies to: racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslShadingCorrectionTargetSelector_Blue,  //!< PRNU target value for blue line selected - Applies to: racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslShadingCorrectionTargetSelector_Green,  //!< PRNU target value for green line selected - Applies to: racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslShadingCorrectionTargetSelector_Red  //!< PRNU target value for red line selected - Applies to: racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for BslSpatialCorrectionDirectionReversal
    enum BslSpatialCorrectionDirectionReversalEnums
    {
        BslSpatialCorrectionDirectionReversal_EncoderReverse1,  //!< The Encoder Reverse 1 signal level determines the spatial correction direction - Applies to: racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslSpatialCorrectionDirectionReversal_Line1,  //!< The signal level of line 1 determines the spatial correction direction - Applies to: racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslSpatialCorrectionDirectionReversal_Line2,  //!< The signal level of line 2 determines the spatial correction direction - Applies to: racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslSpatialCorrectionDirectionReversal_Line3,  //!< The signal level of line 3 determines the spatial correction direction - Applies to: racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslSpatialCorrectionDirectionReversal_Off  //!< Direction reversal is disabled - Applies to: racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for BslStaticDefectPixelCorrectionFileStatus
    enum BslStaticDefectPixelCorrectionFileStatusEnums
    {
        BslStaticDefectPixelCorrectionFileStatus_FileEmpty,  //!< The defect pixel correction file has no entries - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslStaticDefectPixelCorrectionFileStatus_FileNotFound,  //!< The defect pixel correction file can't be found - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslStaticDefectPixelCorrectionFileStatus_FileOk,  //!< The defect pixel correction file is valid - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslStaticDefectPixelCorrectionFileStatus_FileStatusUnknown,  //!< The status of the defect pixel correction file is unknown   - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslStaticDefectPixelCorrectionFileStatus_InvalidClustering,  //!< An invalid cluster has been found - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslStaticDefectPixelCorrectionFileStatus_InvalidFileEntry,  //!< At least one entry in the defect pixel correction file has an invalid size - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslStaticDefectPixelCorrectionFileStatus_InvalidHeader,  //!< The defect pixel correction file header is invalid - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslStaticDefectPixelCorrectionFileStatus_InvalidSize,  //!< The defect pixel correction file size is invalid - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslStaticDefectPixelCorrectionFileStatus_InvalidSorting  //!< The sorting of entries in the defect pixel correction file is invalid - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
    };

    //! Valid values for BslStaticDefectPixelCorrectionMode
    enum BslStaticDefectPixelCorrectionModeEnums
    {
        BslStaticDefectPixelCorrectionMode_Factory,  //!< Static defect pixel correction is based on the defect pixels stored in the factory correction file - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress and dart GigE
        BslStaticDefectPixelCorrectionMode_Off,  //!< Static defect pixel correction is disabled - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress and dart GigE
        BslStaticDefectPixelCorrectionMode_User  //!< Static defect pixel correction is based on the defect pixels stored in the user correction file - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress and dart GigE
    };
    ...
    {
        BslTemperatureStatus_Critical,  //!< The temperature is close to or at the allowed maximum  Provide cooling - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslTemperatureStatus_Error,  //!< The temperature is above the allowed maximum  Provide cooling immediately - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslTemperatureStatus_Ok  //!< The temperature is within the normal operating temperature range - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for BslTransferBitDepth
    enum BslTransferBitDepthEnums
    {
        BslTransferBitDepth_Bpp10,  //!< The transfer bit depth is set to 10 bits per pixel - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslTransferBitDepth_Bpp12,  //!< The transfer bit depth is set to 12 bits per pixel - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslTransferBitDepth_Bpp8  //!< The transfer bit depth is set to 8 bits per pixel - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
    };

    //! Valid values for BslTransferBitDepthMode
    enum BslTransferBitDepthModeEnums
    {
        BslTransferBitDepthMode_Auto,  //!< The transfer bit depth mode is set to Auto - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        BslTransferBitDepthMode_Manual  //!< The transfer bit depth mode is set to Manual - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
    };

    //! Valid values for BslTwiBitrate
    enum BslTwiBitrateEnums
    {
        BslTwiBitrate_Bitrate100kbps,  //!< The bit rate is set to 100000 bits per second - Applies to: dart USB
        BslTwiBitrate_Bitrate10kbps,  //!< The bit rate is set to 10000 bits per second - Applies to: dart USB
        BslTwiBitrate_Bitrate200kbps,  //!< The bit rate is set to 200000 bits per second - Applies to: dart USB
        BslTwiBitrate_Bitrate20kbps,  //!< The bit rate is set to 20000 bits per second - Applies to: dart USB
        BslTwiBitrate_Bitrate400kbps,  //!< The bit rate is set to 400000 bits per second - Applies to: dart USB
        BslTwiBitrate_Bitrate50kbps  //!< The bit rate is set to 50000 bits per second - Applies to: dart USB
    };

    //! Valid values for BslTwiTransferStatus
    enum BslTwiTransferStatusEnums
    {
        BslTwiTransferStatus_NakAddress,  //!< The last transfer failed because a NAK was received when sending the address - Applies to: dart USB
        BslTwiTransferStatus_NakData,  //!< The last transfer failed because a NAK was received when sending data - Applies to: dart USB
        BslTwiTransferStatus_Pending,  //!< A transfer is pending - Applies to: dart USB
        BslTwiTransferStatus_Success  //!< The last transfer was successful - Applies to: dart USB
    };
    ...
    {
        ChunkCounterSelector_Counter1,  //!< Chunk data can be retrieved from counter 1 - Applies to: ace 2 GigE, ace 2 USB, ace USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ChunkCounterSelector_Counter2,  //!< Chunk data can be retrieved from counter 2 - Applies to: ace 2 GigE, ace 2 USB, ace USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
    ...
    {
        ChunkExposureTimeSelector_Common,  //!< Chunk data can be retrieved from the common exposure time - Applies to: ace 2 GigE, ace 2 USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ChunkExposureTimeSelector_Stage1,  //!< Chunk data can be retrieved from the Stage 1 exposure time - Applies to: ace 2 GigE, ace 2 USB and dart GigE
        ChunkExposureTimeSelector_Stage2,  //!< Chunk data can be retrieved from the Stage 2 exposure time - Applies to: ace 2 GigE, ace 2 USB and dart GigE
        ChunkExposureTimeSelector_Stage3,  //!< Chunk data can be retrieved from the Stage 3 exposure time - Applies to: ace 2 GigE, ace 2 USB and dart GigE
        ChunkExposureTimeSelector_Stage4  //!< Chunk data can be retrieved from the Stage 4 exposure time - Applies to: ace 2 GigE, ace 2 USB and dart GigE
    };

    //! Valid values for ChunkGainSelector
    enum ChunkGainSelectorEnums
    {
        ChunkGainSelector_All  //!< Chunk data can be retrieved from all gain channels - Applies to: ace 2 GigE, ace 2 USB, ace USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
    };
    ...
    {
        ChunkPixelFormat_BGR10Packed,  //!< The pixel data in the acquired image is in the BGR 10 Packed format - Applies to: ace GigE
        ChunkPixelFormat_BGR12Packed,  //!< The pixel data in the acquired image is in the BGR 12 Packed format - Applies to: ace GigE
        ChunkPixelFormat_BGR8,  //!< The pixel format is set to BGR 8 - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ChunkPixelFormat_BGR8Packed,  //!< The pixel data in the acquired image is in the BGR 8 Packed format - Applies to: ace GigE
        ChunkPixelFormat_BGRA8Packed,  //!< The pixel data in the acquired image is in the BGRA 8 Packed format - Applies to: ace GigE
        ChunkPixelFormat_BayerBG10,  //!< The pixel data in the acquired image is in the Bayer BG 10 format - Applies to: ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ChunkPixelFormat_BayerBG10p,  //!< The pixel data in the acquired image is in the Bayer BG 10p format - Applies to: ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ChunkPixelFormat_BayerBG12,  //!< The pixel data in the acquired image is in the Bayer BG 12 format - Applies to: ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ChunkPixelFormat_BayerBG12Packed,  //!< The pixel data in the acquired image is in the Bayer BG 12 Packed format - Applies to: ace GigE
        ChunkPixelFormat_BayerBG12p,  //!< The pixel format is set to Bayer BG 12p - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ChunkPixelFormat_BayerBG16,  //!< The pixel data in the acquired image is in the Bayer BG 16 format - Applies to: ace GigE
        ChunkPixelFormat_BayerBG8,  //!< The pixel data in the acquired image is in the Bayer BG 8 format - Applies to: ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ChunkPixelFormat_BayerGB10,  //!< The pixel data in the acquired image is in the Bayer GB 10 format - Applies to: ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ChunkPixelFormat_BayerGB10p,  //!< The pixel data in the acquired image is in the Bayer GB 10p format - Applies to: ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ChunkPixelFormat_BayerGB12,  //!< The pixel data in the acquired image is in the Bayer GB 12 format - Applies to: ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ChunkPixelFormat_BayerGB12Packed,  //!< The pixel data in the acquired image is in the Bayer GB 12 Packed format - Applies to: ace GigE
        ChunkPixelFormat_BayerGB12p,  //!< The pixel format is set to Bayer GB 12p - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ChunkPixelFormat_BayerGB16,  //!< The pixel data in the acquired image is in the Bayer GB 16 format - Applies to: ace GigE
        ChunkPixelFormat_BayerGB8,  //!< The pixel data in the acquired image is in the Bayer GB 8 format - Applies to: ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ChunkPixelFormat_BayerGR10,  //!< The pixel data in the acquired image is in the Bayer GR 10 format - Applies to: ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ChunkPixelFormat_BayerGR10p,  //!< The pixel data in the acquired image is in the Bayer GR 10p format - Applies to: ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ChunkPixelFormat_BayerGR12,  //!< The pixel data in the acquired image is in the Bayer GR 12 format - Applies to: ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ChunkPixelFormat_BayerGR12Packed,  //!< The pixel data in the acquired image is in the Bayer GR 12 Packed format - Applies to: ace GigE
        ChunkPixelFormat_BayerGR12p,  //!< The pixel format is set to Bayer GR 12p - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ChunkPixelFormat_BayerGR16,  //!< The pixel data in the acquired image is in the Bayer GR 16 format - Applies to: ace GigE
        ChunkPixelFormat_BayerGR8,  //!< The pixel data in the acquired image is in the Bayer GR 8 format - Applies to: ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ChunkPixelFormat_BayerRG10,  //!< The pixel data in the acquired image is in the Bayer RG 10 format - Applies to: ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ChunkPixelFormat_BayerRG10p,  //!< The pixel data in the acquired image is in the Bayer RG 10p format - Applies to: ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ChunkPixelFormat_BayerRG12,  //!< The pixel data in the acquired image is in the Bayer RG 12 format - Applies to: ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ChunkPixelFormat_BayerRG12Packed,  //!< The pixel data in the acquired image is in the Bayer RG 12 Packed format - Applies to: ace GigE
        ChunkPixelFormat_BayerRG12p,  //!< The pixel format is set to Bayer RG 12p - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ChunkPixelFormat_BayerRG16,  //!< The pixel data in the acquired image is in the Bayer RG 16 format - Applies to: ace GigE
        ChunkPixelFormat_BayerRG8,  //!< The pixel data in the acquired image is in the Bayer RG 8 format - Applies to: ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ChunkPixelFormat_BiColorBGRG8,  //!< The pixel data in the acquired image is in the BiColor BGRG 8 format - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ChunkPixelFormat_BiColorRGBG8,  //!< The pixel data in the acquired image is in the BiColor RGBG 8 format - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        ChunkPixelFormat_Mono10,  //!< The pixel data in the acquired image is in the Mono 10 format - Applies to: ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ChunkPixelFormat_Mono10Packed,  //!< The pixel data in the acquired image is in the Mono 10 Packed format - Applies to: ace GigE
        ChunkPixelFormat_Mono10p,  //!< The pixel data in the acquired image is in the Mono 10p format - Applies to: ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ChunkPixelFormat_Mono12,  //!< The pixel data in the acquired image is in the Mono 12 format - Applies to: ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ChunkPixelFormat_Mono12Packed,  //!< The pixel data in the acquired image is in the Mono 12 Packed format - Applies to: ace GigE
        ChunkPixelFormat_Mono12p,  //!< The pixel format is set to Mono 12p - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ChunkPixelFormat_Mono16,  //!< The pixel data in the acquired image is in the Mono 16 format - Applies to: Stereo ace and ace GigE
        ChunkPixelFormat_Mono8,  //!< The pixel data in the acquired image is in the Mono 8 format - Applies to: Stereo ace, ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ChunkPixelFormat_Mono8Signed,  //!< The pixel data in the acquired image is in the Mono 8 Signed format - Applies to: ace GigE
        ChunkPixelFormat_RGB10Packed,  //!< The pixel data in the acquired image is in the RGB 10 Packed format - Applies to: ace GigE
        ChunkPixelFormat_RGB10Planar,  //!< The pixel data in the acquired image is in the RGB 10 Planar format - Applies to: ace GigE
        ChunkPixelFormat_RGB10V1Packed,  //!< The pixel data in the acquired image is in the RGB 10V1 Packed format - Applies to: ace GigE
        ChunkPixelFormat_RGB10V2Packed,  //!< The pixel data in the acquired image is in the RGB 10V2 Packed format - Applies to: ace GigE
        ChunkPixelFormat_RGB12Packed,  //!< The pixel data in the acquired image is in the RGB 12 Packed format - Applies to: ace GigE
        ChunkPixelFormat_RGB12Planar,  //!< The pixel data in the acquired image is in the RGB 12 Planar format - Applies to: ace GigE
        ChunkPixelFormat_RGB12V1Packed,  //!< The pixel data in the acquired image is in RGB 12 V1 Packed format - Applies to: ace GigE
        ChunkPixelFormat_RGB16Planar,  //!< The pixel data in the acquired image is in the RGB 16 Planar format - Applies to: ace GigE
        ChunkPixelFormat_RGB8,  //!< The pixel format is set to RGB 8 - Applies to: Stereo ace, ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ChunkPixelFormat_RGB8Packed,  //!< The pixel data in the acquired image is in the RGB 8 Packed format - Applies to: ace GigE
        ChunkPixelFormat_RGB8Planar,  //!< The pixel data in the acquired image is in the RGB 8 Planar format - Applies to: ace GigE
        ChunkPixelFormat_RGBA8Packed,  //!< The pixel data in the acquired image is in the RGBA 8 Packed format - Applies to: ace GigE
        ChunkPixelFormat_YCbCr422_8,  //!< The pixel format is set to YCbCr 422 - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ChunkPixelFormat_YUV411Packed,  //!< The pixel data in the acquired image is in the YUV 411 Packed format - Applies to: ace GigE
        ChunkPixelFormat_YUV422Packed,  //!< The pixel data in the acquired image is in the YUV 422 Packed format - Applies to: ace GigE
        ChunkPixelFormat_YUV422_8,  //!< The pixel format is set to YUV 4:2:2 8 bit packed - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ChunkPixelFormat_YUV422_YUYV_Packed,  //!< The pixel data in the acquired image is in the YUV 422 (YUYV) Packed format - Applies to: ace GigE
        ChunkPixelFormat_YUV444Packed  //!< The pixel data in the acquired image is in the YUV 444 Packed format - Applies to: ace GigE
    };
    ...
    {
        ChunkSelector_AutoBrightnessStatus,  //!< The Auto Brightness Status chunk can be enabled - Applies to: ace 2 GigE, ace 2 USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ChunkSelector_BrightPixel,  //!< Applies to: ace GigE
        ...
        ChunkSelector_CounterValue,  //!< The Counter Value chunk can be enabled - Applies to: ace 2 GigE, ace 2 USB, ace USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        ChunkSelector_DynamicRangeMax,  //!< The Dynamic Range Max chunk can be enabled - Applies to: ace GigE
        ChunkSelector_DynamicRangeMin,  //!< The Dynamic Range Min chunk can be enabled - Applies to: ace GigE
        ChunkSelector_EncoderValue,  //!< The Encoder Value chunk can be enabled - Applies to: racer 2S 5GigE and racer 2S GigE
        ChunkSelector_ExposureTime,  //!< The Exposure Time chunk can be enabled - Applies to: ace 2 GigE, ace 2 USB, ace GigE, ace USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ChunkSelector_FrameID,  //!< The Frame ID chunk can be enabled - Applies to: Stereo ace, ace 2 GigE, ace 2 USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ChunkSelector_FrameTriggerCounter,  //!< The Frame Trigger Counter chunk can be enabled - Applies to: ace GigE
        ChunkSelector_FrameTriggerIgnoredCounter,  //!< The Frame Trigger Ignored Counter chunk can be enabled - Applies to: ace GigE
        ChunkSelector_Framecounter,  //!< The Frame Counter chunk can be enabled - Applies to: ace GigE
        ChunkSelector_FramesPerTriggerCounter,  //!< The Frames Per Trigger Counter chunk can be enabled - Applies to: ace GigE
        ChunkSelector_Gain,  //!< The Gain chunk can be enabled - Applies to: ace 2 GigE, ace 2 USB, ace USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ChunkSelector_GainAll,  //!< The Gain All chunk can be enabled - Applies to: ace GigE
        ChunkSelector_Height,  //!< The Height chunk can be enabled - Applies to: Stereo ace and ace GigE
        ChunkSelector_Image,  //!< The Image chunk can be enabled - Applies to: Stereo ace, ace GigE and ace USB
        ChunkSelector_InputStatusAtLineTrigger,  //!< The Input Status At Line Trigger chunk can be enabled - Applies to: ace GigE
        ChunkSelector_LineSource,  //!< Line Source - Applies to: Stereo ace
        ChunkSelector_LineStatusAll,  //!< The Line Status All chunk can be enabled - Applies to: Stereo ace, ace 2 GigE, ace 2 USB, ace GigE, ace USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ChunkSelector_LineTriggerCounter,  //!< The Line Trigger Counter chunk can be enabled - Applies to: ace GigE
        ChunkSelector_LineTriggerEndToEndCounter,  //!< The Line Trigger End To End Counter chunk can be enabled - Applies to: ace GigE
        ChunkSelector_LineTriggerIgnoredCounter,  //!< The Line Trigger Ignored Counter chunk can be enabled - Applies to: ace GigE
        ChunkSelector_OffsetX,  //!< The X Offset chunk can be enabled - Applies to: Stereo ace and ace GigE
        ChunkSelector_OffsetY,  //!< The Y Offset chunk can be enabled - Applies to: Stereo ace and ace GigE
        ChunkSelector_PartIndex,  //!< Part Index - Applies to: Stereo ace
        ChunkSelector_PayloadCRC16,  //!< The CRC Checksum chunk can be enabled - Applies to: ace 2 GigE, ace 2 USB, ace GigE, ace USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ChunkSelector_PixelFormat,  //!< The Pixel Format chunk can be enabled - Applies to: Stereo ace and ace GigE
        ...
        ChunkSelector_SequenceSetIndex,  //!< The Sequence Set Index chunk can be enabled - Applies to: ace GigE
        ...
        ChunkSelector_ShaftEncoderCounter,  //!< The Shaft Encoder Counter chunk can be enabled - Applies to: ace GigE
        ChunkSelector_Stride,  //!< The Stride chunk can be enabled - Applies to: ace GigE
        ChunkSelector_Timestamp,  //!< The Timestamp chunk can be enabled - Applies to: Stereo ace, ace 2 GigE, ace 2 USB, ace GigE, ace USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ChunkSelector_Triggerinputcounter,  //!< The Trigger Input Counter chunk can be enabled - Applies to: ace GigE
        ChunkSelector_VirtLineStatusAll,  //!< Selects the virtual line status all chunk for enabling - Applies to: ace GigE
        ChunkSelector_Width  //!< The Width chunk can be enabled - Applies to: Stereo ace and ace GigE
    };
    ...
    {
        ColorAdjustmentSelector_Blue,  //!< Colors with a predominant blue component can be adjusted - Applies to: CameraLink, ace GigE and ace USB
        ColorAdjustmentSelector_Cyan,  //!< Colors with a predominant cyan component can be adjusted - Applies to: CameraLink, ace GigE and ace USB
        ColorAdjustmentSelector_Green,  //!< Colors with a predominant green component can be adjusted - Applies to: CameraLink, ace GigE and ace USB
        ColorAdjustmentSelector_Magenta,  //!< Colors with a predominant magenta component can be adjusted - Applies to: CameraLink, ace GigE and ace USB
        ColorAdjustmentSelector_Red,  //!< Colors with a predominant red component can be adjusted - Applies to: CameraLink, ace GigE and ace USB
        ColorAdjustmentSelector_Yellow  //!< Colors with a predominant yellow component can be adjusted - Applies to: CameraLink, ace GigE and ace USB
    };

    //! Valid values for ColorOverexposureCompensationAOISelector
    enum ColorOverexposureCompensationAOISelectorEnums
    {
        ColorOverexposureCompensationAOISelector_AOI1  //!< Selects Color Overexposure Compensation AOI 1 - Applies to: CameraLink and ace GigE
    };
    ...
    {
        ColorTransformationSelector_RGBtoRGB,  //!< Color transformation from RGB to RGB will be performed - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ColorTransformationSelector_RGBtoYUV,  //!< Color transformation from RGB to YUV will be performed - Applies to: CameraLink, ace GigE and ace USB
        ColorTransformationSelector_YUVtoRGB  //!< Color transformation from YUV to RGB will be performed - Applies to: CameraLink, ace GigE and ace USB
    };

    //! Valid values for ColorTransformationValueSelector
    enum ColorTransformationValueSelectorEnums
    {
        ColorTransformationValueSelector_Gain00,  //!< The desired color transformation value can be entered at the position row 0 and column 0 - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ColorTransformationValueSelector_Gain01,  //!< The desired color transformation value can be entered at the position row 0 and column 1 - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ColorTransformationValueSelector_Gain02,  //!< The desired color transformation value can be entered at the position row 0 and column 2 - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ColorTransformationValueSelector_Gain10,  //!< The desired color transformation value can be entered at the position row 1 and column 0 - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ColorTransformationValueSelector_Gain11,  //!< The desired color transformation value can be entered at the position row 1 and column 1 - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ColorTransformationValueSelector_Gain12,  //!< The desired color transformation value can be entered at the position row 1 and column 2 - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ColorTransformationValueSelector_Gain20,  //!< The desired color transformation value can be entered at the position row 2 and column 0 - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ColorTransformationValueSelector_Gain21,  //!< The desired color transformation value can be entered at the position row 2 and column 1 - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ColorTransformationValueSelector_Gain22,  //!< The desired color transformation value can be entered at the position row 2 and column 2 - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ColorTransformationValueSelector_Offset0,  //!< The desired color transformation value can be entered in row 0 of the offset matrix - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ColorTransformationValueSelector_Offset1,  //!< The desired color transformation value can be entered in row 1 of the offset matrix - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ColorTransformationValueSelector_Offset2  //!< The desired color transformation value can be entered in row 2 of the offset matrix - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };
    ...
    {
        CounterEventActivation_AnyEdge,  //!< Increases the counter on any edge (rising or falling) of the source selected - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterEventActivation_FallingEdge,  //!< Increases the counter on the falling edge of the source selected - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterEventActivation_LevelHigh,  //!< Trigger is active as long as the selected source signal is on a logic high level - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart USB and racer 2 CXP
        CounterEventActivation_LevelLow,  //!< Trigger is active as long as the selected source signal is on a logic low level - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart USB and racer 2 CXP
        CounterEventActivation_RisingEdge  //!< Increases the counter on the rising edge of the source selected   - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for CounterEventSource
    enum CounterEventSourceEnums
    {
        CounterEventSource_AcquisitionActive,  //!< The selected counter counts the number of Acquisition Active signals - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterEventSource_AcquisitionEnd,  //!< Counts the number of Acquisition End - Applies to: CameraLink and ace GigE
        CounterEventSource_AcquisitionStart,  //!< Counts the number of Acquisition Start - Applies to: CameraLink and ace GigE
        CounterEventSource_AcquisitionTrigger,  //!< Counts the number of Acquisition Trigger - Applies to: CameraLink and ace GigE
        CounterEventSource_Action1,  //!< The selected counter counts the number of action commands received for action signal 1 - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        CounterEventSource_Counter1Active,  //!< The selected counter counts the number of Counter 1 Active signals - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterEventSource_Counter1End,  //!< The selected counter counts the number of Counter 1 End signals - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterEventSource_Counter1Start,  //!< The selected counter counts the number of Counter 1 Start signals - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterEventSource_Counter2Active,  //!< The selected counter counts the number of Counter 2 Active signals - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterEventSource_Counter2End,  //!< The selected counter counts the number of Counter 2 End signals - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterEventSource_Counter2Start,  //!< The selected counter counts the number of Counter 2 Start signals - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        CounterEventSource_ExposureActive,  //!< The selected counter counts the number of Exposure Active signals - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterEventSource_ExposureEnd,  //!< Counts the number of Exposure End - Applies to: CameraLink and ace GigE
        CounterEventSource_ExposureStart,  //!< The selected counter counts the number of Exposure Start signals - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterEventSource_ExposureTriggerWait,  //!< The selected counter counts the number of Exposure Trigger Wait signals - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterEventSource_FlashWindow,  //!< The selected counter counts the number of Flash Window signals - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and dart USB
        ...
        CounterEventSource_FrameBurstActive,  //!< The selected counter counts the number of Frame Burst Active signals - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE and racer 2S GigE
        CounterEventSource_FrameBurstTriggerWait,  //!< The selected counter counts the number of Frame Burst Trigger Wait signals - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE and racer 2S GigE
        CounterEventSource_FrameEnd,  //!< Counts the number of Frame End - Applies to: CameraLink and ace GigE
        CounterEventSource_FrameStart,  //!< The selected counter counts the number of Frame Start events - Applies to: CameraLink, ace GigE and ace USB
        CounterEventSource_FrameTrigger,  //!< The selected counter counts the number of Frame Trigger events - Applies to: CameraLink, ace GigE and ace USB
        CounterEventSource_FrameTriggerWait,  //!< The selected counter counts the number of Frame Trigger Wait signals - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        CounterEventSource_Line1,  //!< The selected counter counts the number of Line 1 signals - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterEventSource_Line2,  //!< The selected counter counts the number of Line 2 signals - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterEventSource_Line3,  //!< The selected counter counts the number of Line 3 signals - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterEventSource_Line4,  //!< The selected counter counts the number of Line 4 signals - Applies to: dart USB
        CounterEventSource_LineEnd,  //!< Counts the number of Line End - Applies to: CameraLink and ace GigE
        CounterEventSource_LineStart,  //!< Counts the number of Line Start - Applies to: CameraLink and ace GigE
        CounterEventSource_LineTrigger,  //!< The selected counter counts the number of Line Trigger events - Applies to: CameraLink and ace GigE
        ...
        CounterEventSource_Off,  //!< The selected counter is disabled - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterEventSource_PeriodicSignal1,  //!< The selected counter counts the number of Periodic Signal 1 signals - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        CounterEventSource_SoftwareSignal1,  //!< The selected counter counts the number of Software Signal 1 signals - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterEventSource_SoftwareSignal2,  //!< The selected counter counts the number of Software Signal 2 signals - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterEventSource_SoftwareSignal3,  //!< The selected counter counts the number of Software Signal 3 signals - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterEventSource_Timer1Active,  //!< The selected counter counts the number of Timer 1 Active signals - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterEventSource_Timer1End,  //!< The selected counter counts the number of Timer 1 End signals - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterEventSource_Timer2Active,  //!< The selected counter counts the number of Timer 2 Active signals - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterEventSource_Timer2End  //!< The selected counter counts the number of Timer 2 End signals - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for CounterResetActivation
    enum CounterResetActivationEnums
    {
        CounterResetActivation_AnyEdge,  //!< The counter is reset on any edge of the signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterResetActivation_FallingEdge,  //!< The counter is reset on the falling edge of the signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterResetActivation_LevelHigh,  //!< The counter is reset when the signal is high - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart USB and racer 2 CXP
        CounterResetActivation_LevelLow,  //!< The counter is reset when the signal is low - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart USB and racer 2 CXP
        CounterResetActivation_RisingEdge  //!< The counter is reset on the rising edge of the signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for CounterResetSource
    enum CounterResetSourceEnums
    {
        CounterResetSource_AcquisitionActive,  //!< The selected counter can be reset by an Acquisition Active signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterResetSource_Action1,  //!< The selected counter can be reset by an action command that is defined by action signal 1 - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        CounterResetSource_CC1,  //!< The selected counter can be reset by a CC1 signal - Applies to: CameraLink and ace GigE
        CounterResetSource_CC2,  //!< The selected counter can be reset by a CC2 signal - Applies to: CameraLink and ace GigE
        CounterResetSource_CC3,  //!< The selected counter can be reset by a CC3 signal - Applies to: CameraLink and ace GigE
        CounterResetSource_CC4,  //!< The selected counter can be reset by a CC4 signal - Applies to: CameraLink and ace GigE
        CounterResetSource_Counter1Active,  //!< The selected counter can be reset by a Counter 1 Active signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterResetSource_Counter1End,  //!< The selected counter can be reset by a Counter 1 End signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterResetSource_Counter1Start,  //!< The selected counter can be reset by a Counter 1 Start signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterResetSource_Counter2Active,  //!< The selected counter can be reset by a Counter 2 Active signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterResetSource_Counter2End,  //!< The selected counter can be reset by a Counter 2 End signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterResetSource_Counter2Start,  //!< The selected counter can be reset by a Counter 2 Start signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        CounterResetSource_ExposureActive,  //!< The selected counter can be reset by an Exposure Active signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterResetSource_ExposureStart,  //!< The selected counter can be reset by an Exposure Start signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterResetSource_ExposureTriggerWait,  //!< The selected counter can be reset by an Exposure Trigger Wait signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterResetSource_FlashWindow,  //!< The selected counter can be reset by a Flash Window signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and dart USB
        ...
        CounterResetSource_FrameBurstActive,  //!< The selected counter can be reset by a Frame Burst Active signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE and racer 2S GigE
        CounterResetSource_FrameBurstTriggerWait,  //!< The selected counter can be reset by a Frame Burst Trigger Wait signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE and racer 2S GigE
        CounterResetSource_FrameTriggerWait,  //!< The selected counter can be reset by a Frame Trigger Wait signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        CounterResetSource_Line1,  //!< The selected counter can be reset by a signal applied to Line 1 - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterResetSource_Line2,  //!< The selected counter can be reset by a signal applied to Line 2 - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterResetSource_Line3,  //!< The selected counter can be reset by a signal applied to Line 3 - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterResetSource_Line4,  //!< The selected counter can be reset by a signal applied to Line 4 - Applies to: CameraLink, ace GigE, ace USB and dart USB
        CounterResetSource_Line5,  //!< The selected counter can be reset by a signal applied to Line 5 - Applies to: CameraLink and ace GigE
        CounterResetSource_Line6,  //!< The selected counter can be reset by a signal applied to Line 6 - Applies to: CameraLink and ace GigE
        CounterResetSource_Line7,  //!< The selected counter can be reset by a signal applied to Line 7 - Applies to: CameraLink and ace GigE
        CounterResetSource_Line8,  //!< The selected counter can be reset by a signal applied to Line 8 - Applies to: CameraLink and ace GigE
        ...
        CounterResetSource_Off,  //!< The counter reset is disabled - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterResetSource_PeriodicSignal1,  //!< The selected counter can be reset by a Periodic Signal 1 signal - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        CounterResetSource_Software,  //!< The selected counter can be reset by a software command - Applies to: CameraLink, ace GigE and ace USB
        CounterResetSource_SoftwareSignal1,  //!< The selected counter can be reset by a Software Signal 1 signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterResetSource_SoftwareSignal2,  //!< The selected counter can be reset by a Software Signal 2 signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterResetSource_SoftwareSignal3,  //!< The selected counter can be reset by a Software Signal 3 signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterResetSource_Timer1Active,  //!< The selected counter can be reset by a Timer 1 Active signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterResetSource_Timer1End,  //!< The selected counter can be reset by a Timer 1 End signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterResetSource_Timer2Active,  //!< The selected counter can be reset by a Timer 2 Active signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterResetSource_Timer2End,  //!< The selected counter can be reset by a Timer 2 End signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterResetSource_VInput1,  //!< Selects Virtual Input 1 as the source for counter reset - Applies to: CameraLink and ace GigE
        CounterResetSource_VInput2,  //!< Selects Virtual Input 2 as the source for counter reset - Applies to: CameraLink and ace GigE
        CounterResetSource_VInput3,  //!< Selects Virtual Input 3 as the source for counter reset - Applies to: CameraLink and ace GigE
        CounterResetSource_VInput4,  //!< Selects Virtual Input 4 as the source for counter reset - Applies to: CameraLink and ace GigE
        CounterResetSource_VInputDecActive  //!< Selects Virtual Input Decoder Active as the source for counter reset - Applies to: CameraLink and ace GigE
    };

    //! Valid values for CounterSelector
    enum CounterSelectorEnums
    {
        CounterSelector_Counter1,  //!< Counter 1 can be configured - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterSelector_Counter2,  //!< Counter 2 can be configured - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterSelector_Counter3,  //!< Counter 3 can be configured - Applies to: CameraLink, ace GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterSelector_Counter4  //!< Counter 4 can be configured - Applies to: CameraLink, ace GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for CounterStatus
    enum CounterStatusEnums
    {
        CounterStatus_CounterActive,  //!< The counter is waiting to be increased by the selected event source or is currently counting - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterStatus_CounterCompleted,  //!< The counter has reached its maximum value defined by the Counter Duration parameter - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterStatus_CounterTriggerWait  //!< The counter is waiting to be started - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for CounterTriggerActivation
    enum CounterTriggerActivationEnums
    {
        CounterTriggerActivation_AnyEdge,  //!< The counter is started on any edge (rising or falling) of the selected source - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterTriggerActivation_FallingEdge,  //!< The counter is started on the falling edge of the source selected - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterTriggerActivation_LevelHigh,  //!< The counter is active as long as the logic level of the source selected is high - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterTriggerActivation_LevelLow,  //!< The counter is active as long as the logic level of the source selected is low - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterTriggerActivation_RisingEdge  //!< The counter is started on the risiging edge of the source selected - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for CounterTriggerSource
    enum CounterTriggerSourceEnums
    {
        CounterTriggerSource_AcquisitionActive,  //!< The selected counter can be started by an Acquisition Active signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterTriggerSource_Action1,  //!< The selected counter can be started by an action command that is defined by action signal 1 - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        CounterTriggerSource_Counter1Active,  //!< The selected counter can be started by a Counter 1 Active signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterTriggerSource_Counter1End,  //!< The selected counter can be started by a Counter 1 End signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterTriggerSource_Counter1Start,  //!< The selected counter can be started by a Counter 1 Start signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterTriggerSource_Counter2Active,  //!< The selected counter can be started by a Counter 2 Active signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterTriggerSource_Counter2End,  //!< The selected counter can be started by a Counter 2 End signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterTriggerSource_Counter2Start,  //!< The selected counter can be started by a Counter 2 Start signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        CounterTriggerSource_ExposureActive,  //!< The selected counter can be started by an Exposure Active signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterTriggerSource_ExposureStart,  //!< The selected counter can be started by an Exposure Start signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterTriggerSource_ExposureTriggerWait,  //!< The selected counter can be started by an Exposure Trigger Wait signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterTriggerSource_FlashWindow,  //!< The selected counter can be started by a Flash Window signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and dart USB
        ...
        CounterTriggerSource_FrameBurstActive,  //!< The selected counter can be started by a Frame Burst Active signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE and racer 2S GigE
        CounterTriggerSource_FrameBurstTriggerWait,  //!< The selected counter can be started by a Frame Burst Trigger Wait signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE and racer 2S GigE
        CounterTriggerSource_FrameTriggerWait,  //!< The selected counter can be started by a Frame Trigger Wait signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        CounterTriggerSource_Line1,  //!< The selected counter can be started by a Line 1 signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterTriggerSource_Line2,  //!< The selected counter can be started by a Line 2 signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterTriggerSource_Line3,  //!< The selected counter can be started by a Line 3 signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterTriggerSource_Line4,  //!< The selected counter can be started by a Line 4 signal - Applies to: dart USB
        ...
        CounterTriggerSource_Off,  //!< The selected counter is disabled and can't be started - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterTriggerSource_PeriodicSignal1,  //!< The selected counter can be started by a Periodic Signal 1 signal - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        CounterTriggerSource_SoftwareSignal1,  //!< The selected counter can be started by a Software Signal 1 signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterTriggerSource_SoftwareSignal2,  //!< The selected counter can be started by a Software Signal 2 signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterTriggerSource_SoftwareSignal3,  //!< The selected counter can be started by a Software Signal 3 signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterTriggerSource_Timer1Active,  //!< The selected counter can be started by a Timer 1 Active signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterTriggerSource_Timer1End,  //!< The selected counter can be started by a Timer 1 End signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterTriggerSource_Timer2Active,  //!< The selected counter can be started by a Timer 2 Active signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        CounterTriggerSource_Timer2End  //!< The selected counter can be started by a Timer 2 End signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };
    ...
    {
        DemosaicingMode_BaslerPGI,  //!< Demosaicing is performed using the Basler PGI algorithm - Applies to: ace GigE and ace USB
        DemosaicingMode_Simple  //!< Demosaicing is performed using a simple demosaicing algorithm - Applies to: ace GigE and ace USB
    };
    ...
    enum DeviceCharacterSetEnums
    {
        ...
        DeviceCharacterSet_UTF8  //!< The strings of the device's bootstrap registers use the UTF-8 character set - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for DeviceIndicatorMode
    enum DeviceIndicatorModeEnums
    {
        DeviceIndicatorMode_Active,  //!< The status LED of the camera is turned on - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        DeviceIndicatorMode_ErrorStatus,  //!< The camera's status LED is inactive unless an error occurs - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        DeviceIndicatorMode_Inactive  //!< The status LED of the camera is turned off - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for DeviceLinkThroughputLimitMode
    enum DeviceLinkThroughputLimitModeEnums
    {
        DeviceLinkThroughputLimitMode_Off,  //!< The Device Link Throughput Limit parameter is disabled - Applies to: CamEmu, Stereo ace, ace 2 USB, ace USB, dart USB and pulse USB
        DeviceLinkThroughputLimitMode_On  //!< The Device Link Throughput Limit parameter is enabled - Applies to: CamEmu, Stereo ace, ace 2 GigE, ace 2 USB, ace USB, dart GigE, dart MIPI, dart USB, pulse USB, racer 2S 5GigE and racer 2S GigE
    };

    //! Valid values for DeviceRegistersEndianness
    enum DeviceRegistersEndiannessEnums
    {
        DeviceRegistersEndianness_Big,  //!< The endianness of the device's registers is big-endian - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        DeviceRegistersEndianness_Little  //!< The endianness of the device's registers is little-endian - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for DeviceScanType
    enum DeviceScanTypeEnums
    {
        DeviceScanType_Areascan,  //!< The camera has an area scan sensor - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        DeviceScanType_Areascan3D,  //!< Device outputs 2D range image - Applies to: Stereo ace and blaze
        DeviceScanType_Linescan,  //!< The camera has a line scan sensor - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    ...
    {
        DeviceTLType_BCON,  //!< The device provides a BCON transport layer - Applies to: racer 2 CXP
        ...
        DeviceTLType_CoaXPress,  //!< The device provides a CoaXPress transport layer - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        DeviceTLType_Custom,  //!< The device provides a custom transport layer - Applies to: Stereo ace and dart MIPI
        DeviceTLType_GigEVision,  //!< The device provides a GigE Vision transport layer - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        DeviceTLType_USB3Vision  //!< The device provides a USB3 Vision transport layer - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };
    ...
    enum DeviceTemperatureSelectorEnums
    {
        ...
        DeviceTemperatureSelector_Coreboard,  //!< The temperature is measured on the core board - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, dart GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        DeviceTemperatureSelector_FpgaCore,  //!< The temperature is measured on the FPGA board - Applies to: ace 2 CXP, boost CoaXPress, boost V CoaXPress, dart USB, racer 2 CXP and racer 2S CXP
        ...
        DeviceTemperatureSelector_Sensor,  //!< The temperature is measured on the image sensor - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB and racer 2 CXP
    ...
    {
        EventNotification_GenICamEvent,  //!< Event notifications are enabled and the notification type is set to GenICam - Applies to: ace GigE
        EventNotification_Off,  //!< Event notifications are disabled - Applies to: ace 2 GigE, ace 2 USB, ace GigE, ace USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        EventNotification_On,  //!< Event notifications are enabled - Applies to: ace 2 GigE, ace 2 USB, ace GigE, ace USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        EventNotification_Once  //!< Applies to: ace 2 GigE, ace 2 USB and dart USB
    };

    //! Valid values for EventSelector
    enum EventSelectorEnums
    {
        EventSelector_AcquisitionStart,  //!< Event notifications for the Acquisition Start event can be enabled - Applies to: ace GigE
        EventSelector_AcquisitionStartOvertrigger,  //!< Event notifications for the Acquisition Start Overtrigger event can be enabled - Applies to: ace GigE
        EventSelector_AcquisitionStartWait,  //!< Event notifications for the Acquisition Start Wait event can be enabled - Applies to: ace GigE
        EventSelector_AcquisitionWait,  //!< Event notifications for the Acquisition Wait event can be enabled - Applies to: ace GigE
        EventSelector_ActionLate,  //!< Event notifications for the Action Late event can be enabled - Applies to: ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        EventSelector_CriticalTemperature,  //!< Event notifications for the Critical Temperature event can be enabled - Applies to: ace GigE and ace USB
        EventSelector_EventOverrun,  //!< Event notifications for the Event Overrun event can be enabled - Applies to: ace GigE
        EventSelector_ExposureEnd,  //!< Event notifications for the Exposure End event can be enabled - Applies to: ace 2 GigE, ace 2 USB, ace GigE, ace USB, dart GigE and dart USB
        EventSelector_FrameBufferOverrun,  //!< Event notifications for the Frame Buffer Overrun event can be enabled - Applies to: ace 2 GigE, ace 2 USB and dart GigE
        ...
        EventSelector_FrameStart,  //!< Event notifications for the Frame Start event can be enabled - Applies to: ace 2 GigE, ace 2 USB, ace GigE, ace USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        EventSelector_FrameStartOvertrigger,  //!< Event notifications for the Frame Start Overtrigger event can be enabled - Applies to: ace GigE and ace USB
        EventSelector_FrameStartWait,  //!< Event notifications for the Frame Start Wait event can be enabled - Applies to: ace GigE and ace USB
        EventSelector_FrameTimeout,  //!< Event notifications for the Frame Timeout event can be enabled - Applies to: ace GigE
        EventSelector_FrameTriggerMissed,  //!< Event notifications for the Frame Trigger Missed event can be enabled - Applies to: ace 2 GigE, ace 2 USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        EventSelector_FrameWait,  //!< Event notifications for the Frame Wait event can be enabled - Applies to: ace GigE
        EventSelector_Line1RisingEdge,  //!< Applies to: ace GigE
        EventSelector_Line2RisingEdge,  //!< Applies to: ace GigE
        EventSelector_Line3RisingEdge,  //!< Applies to: ace GigE
        EventSelector_Line4RisingEdge,  //!< Applies to: ace GigE
        EventSelector_LineStartOvertrigger,  //!< Event notifications for the Line Start Overtrigger event can be enabled - Applies to: ace GigE
        ...
        EventSelector_OverTemperature,  //!< Event notifications for the Over Temperature event can be enabled - Applies to: ace GigE and ace USB
        EventSelector_Overrun,  //!< Event notifications for the Overrun event can be enabled - Applies to: ace 2 GigE, ace 2 USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        EventSelector_TemperatureStatusChanged,  //!< Event notifications for the Temperature Status Changed event can be enabled - Applies to: ace 2 GigE, ace 2 USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        EventSelector_Test,  //!< Event notifications for the Test event can be enabled - Applies to: ace 2 GigE, ace 2 USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        EventSelector_VirtualLine1RisingEdge,  //!< Applies to: ace GigE
        EventSelector_VirtualLine2RisingEdge,  //!< Applies to: ace GigE
        EventSelector_VirtualLine3RisingEdge,  //!< Applies to: ace GigE
        EventSelector_VirtualLine4RisingEdge  //!< Applies to: ace GigE
    };

    //! Valid values for EventTemperatureStatusChangedStatus
    enum EventTemperatureStatusChangedStatusEnums
    {
        EventTemperatureStatusChangedStatus_Critical,  //!< The temperature status changed to Critical - Applies to: ace 2 GigE, ace 2 USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        EventTemperatureStatusChangedStatus_Error,  //!< The temperature status changed to Error - Applies to: ace 2 GigE, ace 2 USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        EventTemperatureStatusChangedStatus_Ok  //!< The temperature status changed to Ok - Applies to: ace 2 GigE, ace 2 USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
    };

    //! Valid values for ExpertFeatureAccessSelector
    enum ExpertFeatureAccessSelectorEnums
    {
        ExpertFeatureAccessSelector_ExpertFeature1,  //!< Expert Feature 1 can be configured - Applies to: CameraLink, ace GigE and ace USB
        ExpertFeatureAccessSelector_ExpertFeature10,  //!< Expert Feature 10 can be configured - Applies to: ace GigE and ace USB
        ExpertFeatureAccessSelector_ExpertFeature11,  //!< Expert feature 11 can be configured - Applies to: ace GigE and ace USB
        ExpertFeatureAccessSelector_ExpertFeature1_Legacy,  //!< Expert Feature 1 (Legacy) can be configured - Applies to: CameraLink and ace GigE
        ExpertFeatureAccessSelector_ExpertFeature2,  //!< Expert Feature 2 can be configured - Applies to: CameraLink, ace GigE and ace USB
        ExpertFeatureAccessSelector_ExpertFeature3,  //!< Expert Feature 3 can be configured - Applies to: CameraLink, ace GigE and ace USB
        ExpertFeatureAccessSelector_ExpertFeature4,  //!< Expert Feature 4 can be configured - Applies to: CameraLink, ace GigE and ace USB
        ExpertFeatureAccessSelector_ExpertFeature5,  //!< Expert Feature 5 can be configured - Applies to: CameraLink, ace GigE and ace USB
        ExpertFeatureAccessSelector_ExpertFeature6,  //!< Expert Feature 6 can be configured - Applies to: CameraLink, ace GigE and ace USB
        ExpertFeatureAccessSelector_ExpertFeature7,  //!< Expert Feature 7 can be configured - Applies to: CameraLink, ace GigE and ace USB
        ExpertFeatureAccessSelector_ExpertFeature8,  //!< Expert Feature 8 can be configured - Applies to: ace GigE and ace USB
        ExpertFeatureAccessSelector_ExpertFeature9  //!< Expert Feature 9 can be configured - Applies to: ace GigE and ace USB
    };

    //! Valid values for ExposureAuto
    enum ExposureAutoEnums
    {
        ExposureAuto_Continuous,  //!< The exposure time is adjusted continuously while images are being acquired - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ExposureAuto_Off,  //!< Automatic exposure time adjustment is disabled - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ExposureAuto_Once  //!< The exposure time is adjusted automatically to reach the specified target value - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for ExposureMode
    enum ExposureModeEnums
    {
        ExposureMode_Off,  //!< Sets the exposure mode to off - Applies to: CameraLink and ace GigE
        ExposureMode_Timed,  //!< The exposure mode is set to Timed - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ExposureMode_TriggerControlled,  //!< The exposure mode is set to Trigger Controlled - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ExposureMode_TriggerWidth  //!< The exposure mode is set to Trigger Width - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for ExposureOverlapTimeMode
    enum ExposureOverlapTimeModeEnums
    {
        ExposureOverlapTimeMode_Automatic,  //!< The camera automatically uses the optimum overlap time for each acquisition - Applies to: ace GigE and ace USB
        ExposureOverlapTimeMode_Manual  //!< The user can manually set the overlap time for each acquisition - Applies to: ace GigE and ace USB
    };

    //! Valid values for ExposureTimeMode
    enum ExposureTimeModeEnums
    {
        ExposureTimeMode_Common,  //!< The same exposure time is used for all components - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ExposureTimeMode_Individual,  //!< Different exposure times can be specified for individual components - Applies to: ace 2 GigE, ace 2 USB, dart GigE and racer 2 CXP
        ExposureTimeMode_Short,  //!< The exposure time mode is set to Short - Applies to: boost CoaXPress
        ExposureTimeMode_Standard,  //!< The exposure time mode is set to Standard - Applies to: ace GigE and ace USB
        ExposureTimeMode_UltraShort  //!< The exposure time mode is set to Ultra Short - Applies to: ace 2 GigE, ace 2 USB, ace GigE, ace USB and boost CoaXPress
    };

    //! Valid values for ExposureTimeSelector
    enum ExposureTimeSelectorEnums
    {
        ExposureTimeSelector_Common,  //!< The Exposure Time parameter value applies to all components - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ExposureTimeSelector_Stage1,  //!< The Exposure Time parameter value applies to the Stage 1 exposure time - Applies to: ace 2 GigE, ace 2 USB, dart GigE and racer 2 CXP
        ExposureTimeSelector_Stage2,  //!< The Exposure Time parameter value applies to the Stage 2 exposure time - Applies to: ace 2 GigE, ace 2 USB, dart GigE and racer 2 CXP
        ExposureTimeSelector_Stage3,  //!< The specified exposure time applies to the exposure of Stage 3 - Applies to: ace 2 GigE, ace 2 USB, dart GigE and racer 2 CXP
        ExposureTimeSelector_Stage4  //!< The specified exposure time applies to the exposure of Stage 4 - Applies to: ace 2 GigE, ace 2 USB, dart GigE and racer 2 CXP
    };

    //! Valid values for FeatureSet
    enum FeatureSetEnums
    {
        FeatureSet_Basic,  //!< The basic feature set is made available - Applies to: CameraLink and ace GigE
        FeatureSet_Full  //!< The full feature set is made available - Applies to: CameraLink and ace GigE
    };

    //! Valid values for FieldOutputMode
    enum FieldOutputModeEnums
    {
        FieldOutputMode_ConcatenatedNewFields,  //!< Sets the mode to output a frame consisting of field 0 in the upper half and field 1 in the lower half of the frame - Applies to: CameraLink and ace GigE
        FieldOutputMode_DeinterlacedNewFields,  //!< Sets the mode to output a frame generated by deinterlacing field 0 and field 1 using the deinterlacer selected by feature Deinterlacer   - Applies to: CameraLink and ace GigE
        FieldOutputMode_Field0,  //!< Sets the mode to only output field 0 - Applies to: CameraLink and ace GigE
        FieldOutputMode_Field0First,  //!< Sets the mode to only output field 0 and field 1 in single frames  Starting with field 0 - Applies to: CameraLink and ace GigE
        FieldOutputMode_Field1  //!< Sets the mode to only output field 1 - Applies to: CameraLink and ace GigE
    };

    //! Valid values for FileOpenMode
    enum FileOpenModeEnums
    {
        FileOpenMode_Read,  //!< Files are opened in read-only mode - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        FileOpenMode_ReadWrite,  //!< This selects read and write open mode - Applies to: Stereo ace
        FileOpenMode_Write  //!< Files are opened in write-only mode - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for FileOperationSelector
    enum FileOperationSelectorEnums
    {
        FileOperationSelector_Close,  //!< The currently selected file can be closed - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        FileOperationSelector_Delete,  //!< Deletes the content of the file selected by FileSelector - Applies to: Stereo ace
        FileOperationSelector_Open,  //!< The currently selected file can be opened - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        FileOperationSelector_Read,  //!< The currently selected file can be read - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        FileOperationSelector_Write  //!< The currently selected file can be written to - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for FileOperationStatus
    enum FileOperationStatusEnums
    {
        FileOperationStatus_Failure,  //!< The file operation has failed - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        FileOperationStatus_Invalid,  //!< File content is invalid - Applies to: Stereo ace
        FileOperationStatus_Success  //!< The file operation was successful - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for FileSelector
    enum FileSelectorEnums
    {
        FileSelector_BootUpdate,  //!< The Boot Firmware Update file is selected - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        FileSelector_BootUpdatePackage,  //!< The Boot Firmware Update Package file is selected - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        FileSelector_Calibration,  //!< Applies to: Stereo ace
        FileSelector_ExpertFeature7File,  //!< The Expert Feature 7 File file is selected - Applies to: CameraLink, ace GigE and ace USB
        FileSelector_FactoryDefectPixelCorrection,  //!< The factory defect pixel correction file is selected - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        FileSelector_FirmwareUpdate,  //!< The Firmware Update file is selected - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        FileSelector_FirmwareUpdatePackage,  //!< The Firmware Update Package file is selected - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        FileSelector_None,  //!< No file is selected - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        FileSelector_UserData,  //!< The User Data file is selected - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        FileSelector_UserDefectPixelCorrection,  //!< The user defect pixel correction file is selected - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        FileSelector_UserGainShading1,  //!< The User Gain Shading 1 file is selected - Applies to: CameraLink, ace GigE and ace USB
        FileSelector_UserGainShading2,  //!< The User Gain Shading 2 file is selected - Applies to: CameraLink, ace GigE and ace USB
        FileSelector_UserOffsetShading1,  //!< The User Offset Shading 1 file is selected - Applies to: CameraLink, ace GigE and ace USB
        FileSelector_UserOffsetShading2,  //!< The User Offset Shading 2 file is selected - Applies to: CameraLink, ace GigE and ace USB
        FileSelector_UserSet1,  //!< The User Set 1 file is selected - Applies to: CameraLink, ace GigE and ace USB
        FileSelector_UserSet2,  //!< The User Set 2 file is selected - Applies to: CameraLink, ace GigE and ace USB
        FileSelector_UserSet3,  //!< The User Set 3 file is selected - Applies to: CameraLink, ace GigE and ace USB
        FileSelector_VignettingCorrection  //!< The Vignetting Correction file is selected - Applies to: ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress and dart USB
    };
    ...
    {
        FrequencyConverterInputSource_CC1,  //!< CC1 is selected as the source signal for the frequency converter module - Applies to: CameraLink and ace GigE
        FrequencyConverterInputSource_CC2,  //!< CC2 is selected as the source signal for the frequency converter module - Applies to: CameraLink and ace GigE
        FrequencyConverterInputSource_CC3,  //!< CC3 is selected as the source signal for the frequency converter module - Applies to: CameraLink and ace GigE
        FrequencyConverterInputSource_CC4,  //!< CC4 is selected as the source signal for the frequency converter module - Applies to: CameraLink and ace GigE
        FrequencyConverterInputSource_Line1,  //!< Line 1 is selected as the input source for the frequency converter module - Applies to: CameraLink and ace GigE
        FrequencyConverterInputSource_Line2,  //!< Line 2 is selected as the input source for the frequency converter module - Applies to: CameraLink and ace GigE
        FrequencyConverterInputSource_Line3,  //!< Line 3 is selected as the input source for the frequency converter module - Applies to: CameraLink and ace GigE
        FrequencyConverterInputSource_Line4,  //!< Line 4 is selected as the input source for the frequency converter module - Applies to: CameraLink and ace GigE
        FrequencyConverterInputSource_Line5,  //!< Selects line 5 as the input source - Applies to: CameraLink and ace GigE
        FrequencyConverterInputSource_Line6,  //!< Selects line 6 as the input source   - Applies to: CameraLink and ace GigE
        FrequencyConverterInputSource_Line7,  //!< Selects line 7 as the input source - Applies to: CameraLink and ace GigE
        FrequencyConverterInputSource_Line8,  //!< Selects line 8 as the input source - Applies to: CameraLink and ace GigE
        FrequencyConverterInputSource_ShaftEncoderModuleOut  //!< The output of the shaft encoder module is selected as the input source for the frequency converter module - Applies to: CameraLink and ace GigE
    };

    //! Valid values for FrequencyConverterSignalAlignment
    enum FrequencyConverterSignalAlignmentEnums
    {
        FrequencyConverterSignalAlignment_FallingEdge,  //!< For the falling edge of each received signal, a falling edge of a generated signal is provided - Applies to: CameraLink and ace GigE
        FrequencyConverterSignalAlignment_RisingEdge  //!< For the rising edge of each received signal, a rising edge of a generated signal is provided - Applies to: CameraLink and ace GigE
    };

    //! Valid values for GainAuto
    enum GainAutoEnums
    {
        GainAuto_Continuous,  //!< The gain is adjusted continuously while images are being acquired - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        GainAuto_Off,  //!< Automatic gain adjustment is disabled - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        GainAuto_Once  //!< The gain is adjusted automatically to reach the specifed target value - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for GainSelector
    enum GainSelectorEnums
    {
        GainSelector_All,  //!< Changes to the gain will be applied universally - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        GainSelector_AnalogAll,  //!< Changes to the gain will be applied to all analog gain parameters - Applies to: CameraLink, ace GigE and ace USB
        GainSelector_Blue,  //!< Selects the blue gain control for adjustment - Applies to: CameraLink and ace GigE
        GainSelector_DigitalAll,  //!< Changes to the gain will be applied to all digital gain parameters - Applies to: CameraLink, ace GigE and ace USB
        GainSelector_Green,  //!< Selects the green gain control for adjustment - Applies to: CameraLink and ace GigE
        GainSelector_Line1,  //!< Changes to the gain will be applied to Line 1 - Applies to: racer 2 CXP
        GainSelector_Line2,  //!< Changes to the gain will be applied to Line 2 - Applies to: racer 2 CXP
        GainSelector_Line3,  //!< Changes to the gain will be applied to Line 3 - Applies to: racer 2 CXP
        GainSelector_Line4,  //!< Changes to the gain will be applied to Line 4 - Applies to: racer 2 CXP
        GainSelector_Red,  //!< Selects the red gain control for adjustment - Applies to: CameraLink and ace GigE
        GainSelector_Tap1,  //!< Changes to the gain will be applied to tap 1 - Applies to: CameraLink and ace GigE
        GainSelector_Tap2,  //!< Changes to the gain will be applied to tap 2 - Applies to: CameraLink and ace GigE
        GainSelector_Tap3,  //!< Changes to the gain will be applied to tap 3 - Applies to: CameraLink and ace GigE
        GainSelector_Tap4  //!< Changes to the gain will be applied to tap 4 - Applies to: CameraLink and ace GigE
    };

    //! Valid values for GammaSelector
    enum GammaSelectorEnums
    {
        GammaSelector_User,  //!< The gamma curve can be configured by the user - Applies to: CameraLink and ace GigE
        GammaSelector_sRGB  //!< The gamma curve is set to a fixed sRGB curve - Applies to: CameraLink and ace GigE
    };
    ...
    enum GevCCPEnums
    {
        GevCCP_Control,  //!< The control channel privilege is set to Control - Applies to: ace GigE
        GevCCP_Exclusive,  //!< The control channel privilege is set to Exclusive - Applies to: ace GigE
        GevCCP_ExclusiveControl  //!< The control channel privilege is set to Exclusive Control - Applies to: ace GigE
    };

    //! Valid values for GevGVSPExtendedIDMode
    enum GevGVSPExtendedIDModeEnums
    {
        GevGVSPExtendedIDMode_Off,  //!< The Extended ID mode is switched off - Applies to: ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        GevGVSPExtendedIDMode_On  //!< The Extended ID mode is switched on - Applies to: ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
    };

    //! Valid values for GevIEEE1588Status
    enum GevIEEE1588StatusEnums
    {
        GevIEEE1588Status_Disabled,  //!< The port is in the Disabled state - Applies to: ace GigE
        GevIEEE1588Status_Faulty,  //!< The port is in the Faulty state - Applies to: ace GigE
        GevIEEE1588Status_Initializing,  //!< The port is in the Initializing state - Applies to: ace GigE
        GevIEEE1588Status_Listening,  //!< The port is in the Listening state - Applies to: ace GigE
        GevIEEE1588Status_Master,  //!< The port is in the Master state - Applies to: ace GigE
        GevIEEE1588Status_Passive,  //!< The port is in the Passive state - Applies to: ace GigE
        GevIEEE1588Status_PreMaster,  //!< The port is in the PreMaster state - Applies to: ace GigE
        GevIEEE1588Status_Slave,  //!< The port is in the Slave state - Applies to: ace GigE
        GevIEEE1588Status_Uncalibrated,  //!< The port is in the Uncalibrated state - Applies to: ace GigE
        GevIEEE1588Status_Undefined  //!< The port is in an undefined state - Applies to: ace GigE
    };

    //! Valid values for GevIEEE1588StatusLatched
    enum GevIEEE1588StatusLatchedEnums
    {
        GevIEEE1588StatusLatched_Disabled,  //!< The port is in the Disabled state - Applies to: ace GigE
        GevIEEE1588StatusLatched_Faulty,  //!< The port is in the Faulty state - Applies to: ace GigE
        GevIEEE1588StatusLatched_Initializing,  //!< The port is in the Initializing state - Applies to: ace GigE
        GevIEEE1588StatusLatched_Listening,  //!< The port is in the Listening state - Applies to: ace GigE
        GevIEEE1588StatusLatched_Master,  //!< The port is in the Master state - Applies to: ace GigE
        GevIEEE1588StatusLatched_Passive,  //!< The port is in the Passive state - Applies to: ace GigE
        GevIEEE1588StatusLatched_PreMaster,  //!< The port is in the PreMaster state - Applies to: ace GigE
        GevIEEE1588StatusLatched_Slave,  //!< The port is in the Slave state - Applies to: ace GigE
        GevIEEE1588StatusLatched_Uncalibrated,  //!< The port is in the Uncalibrated state - Applies to: ace GigE
        GevIEEE1588StatusLatched_Undefined  //!< The port is in an undefined state - Applies to: ace GigE
    };

    //! Valid values for GevInterfaceSelector
    enum GevInterfaceSelectorEnums
    {
        GevInterfaceSelector_NetworkInterface0  //!< Network interface 0 can be configured - Applies to: ace GigE
    };

    //! Valid values for GevStreamChannelSelector
    enum GevStreamChannelSelectorEnums
    {
        GevStreamChannelSelector_StreamChannel0  //!< Stream channel 0 can be configured - Applies to: ace GigE
    };
    ...
    {
        InterlacedIntegrationMode_FieldIntegration,  //!< Sets the integration mode to field integration - Applies to: CameraLink and ace GigE
        InterlacedIntegrationMode_FrameIntegration  //!< Sets the integration mode to frame integration - Applies to: CameraLink and ace GigE
    };

    //! Valid values for LUTSelector
    enum LUTSelectorEnums
    {
        LUTSelector_Luminance  //!< The luminance lookup table can be configured - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };
    ...
    enum LastErrorEnums
    {
        ...
        LastError_InsufficientTriggerWidth,  //!< The trigger width was too short - Applies to: CameraLink and ace GigE
        LastError_InvalidParameter,  //!< A parameter was set to an invalid value - Applies to: CameraLink and ace GigE
        LastError_NoError,  //!< No error was detected - Applies to: CameraLink, ace GigE and blaze
        LastError_OverTemperature,  //!< An over temperature state has been detected - Applies to: CameraLink, ace GigE and blaze
        LastError_Overtrigger,  //!< The camera was overtriggered - Applies to: CameraLink and ace GigE
        LastError_PowerFailure,  //!< The power supply is not sufficient - Applies to: CameraLink and ace GigE
        LastError_UserDefPixFailure,  //!< An error was detected while loading user defect pixel data - Applies to: CameraLink and ace GigE
        LastError_Userset  //!< An error was detected while loading a user set - Applies to: CameraLink and ace GigE
    };

    //! Valid values for LegacyBinningVertical
    enum LegacyBinningVerticalEnums
    {
        LegacyBinningVertical_Off,  //!< Vertical binning is disabled - Applies to: CameraLink and ace GigE
        LegacyBinningVertical_Two_Rows  //!< Vertical binning is set to 2 rows - Applies to: CameraLink and ace GigE
    };
    ...
    {
        LightSourceSelector_Custom,  //!< The color transformation matrix can be customized - Applies to: CameraLink and ace GigE
        LightSourceSelector_Daylight,  //!< The color transformation matrix is optimized for image acquisitions with daylight of 5000 K - Applies to: CameraLink and ace GigE
        LightSourceSelector_Daylight6500K,  //!< The color transformation matrix is optimized for image acquisitions with daylight of 6500 K - Applies to: CameraLink and ace GigE
        LightSourceSelector_LightSource0,  //!< The color transformation matrix is optimized for image acquisitions with a custom light source 0 - Applies to: CameraLink and ace GigE
        LightSourceSelector_LightSource1,  //!< The color transformation matrix is optimized for image acquisitions with a custom light source 1 - Applies to: CameraLink and ace GigE
        LightSourceSelector_MicroscopeLED4500K,  //!< The light source preset for image acquisitions with microscope LED illumination of 4500 K is set - Applies to: ace GigE
        LightSourceSelector_MicroscopeLED5500K,  //!< The light source preset for image acquisitions with microscope LED illumination of 5500 K is set - Applies to: ace GigE
        LightSourceSelector_MicroscopeLED6000K,  //!< The light source preset for image acquisitions with microscope LED illumination of 6000 K is set - Applies to: ace GigE
        LightSourceSelector_Off,  //!< No color transformation for a specific light source is performed - Applies to: CameraLink and ace GigE
        LightSourceSelector_Tungsten  //!< The color transformation matrix is optimized for image acquisition with tungsten incandescent light (3100 K) - Applies to: CameraLink and ace GigE
    };

    //! Valid values for LineFormat
    enum LineFormatEnums
    {
        LineFormat_LVDS,  //!< The line is currently accepting or sending LVDS level signals - Applies to: CameraLink, ace GigE and ace USB
        LineFormat_LVTTL,  //!< The line is currently accepting or sending LVTTL level signals - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        LineFormat_NoConnect,  //!< The line is not connected - Applies to: CameraLink, ace GigE and ace USB
        LineFormat_OpenDrain,  //!< The output of the line is "open drain"/"open collector" - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        LineFormat_OptoCoupled,  //!< The line is opto-coupled - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        LineFormat_RS422,  //!< The line is currently accepting or sending RS-422 level signals - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        LineFormat_TTL,  //!< The line is currently accepting or sending TTL level signals - Applies to: CameraLink, ace GigE and ace USB
        LineFormat_TriState  //!< The line is currently in tri-state mode (not driven) - Applies to: CameraLink, ace GigE and ace USB
    };

    //! Valid values for LineLogic
    enum LineLogicEnums
    {
        LineLogic_Negative,  //!< The line logic of the currently selected line is negative - Applies to: CameraLink, ace GigE and ace USB
        LineLogic_Positive  //!< The line logic of the currently selected line is positive - Applies to: CameraLink, ace GigE and ace USB
    };

    //! Valid values for LineMode
    enum LineModeEnums
    {
        LineMode_InOut,  //!< The selected physical line can be used to input and output an electrical signal - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB and racer 2 CXP
        LineMode_Input,  //!< The selected physical line can be used to input an electrical signal - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        LineMode_Output  //!< The selected physical line can be used to output an electrical signal - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };
    ...
    enum LineSelectorEnums
    {
        ...
        LineSelector_Line1,  //!< Line 1 can be configured - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        LineSelector_Line2,  //!< Line 2 can be configured - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        LineSelector_Line3,  //!< Line 3 can be configured - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        LineSelector_Line4,  //!< Line 4 can be configured - Applies to: CameraLink, ace GigE, ace USB and dart USB
        ...
        LineSelector_Out1,  //!< Output Line 1 can be configured - Applies to: CameraLink, Stereo ace and ace GigE
        LineSelector_Out2,  //!< Output Line 2 can be configured - Applies to: CameraLink, Stereo ace and ace GigE
        LineSelector_Out3,  //!< Output Line 3 can be configured - Applies to: CameraLink, Stereo ace and ace GigE
        LineSelector_Out4  //!< Output Line 4 can be configured - Applies to: CameraLink, Stereo ace and ace GigE
    };

    //! Valid values for LineSource
    enum LineSourceEnums
    {
        LineSource_AcquisitionActive,  //!< The source signal for the currently selected line is set to Acquisition Active - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        LineSource_AcquisitionTriggerReady,  //!< The source signal for the currently selected line is set to Acquisition Trigger Ready - Applies to: CameraLink and ace GigE
        LineSource_AcquisitionTriggerWait,  //!< The source signal for the currently selected line is set to Acquisition Trigger Wait - Applies to: CameraLink and ace GigE
        LineSource_BslLightControl,  //!< The source signal for the currently selected line is set to Light Control - Applies to: ace GigE and ace USB
        LineSource_Counter1Active,  //!< The source signal for the currently selected line is set to Counter 1 Active - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        LineSource_Counter2Active,  //!< The source signal for the currently selected line is set to Counter 2 Active - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        LineSource_ExposureActive,  //!< The source signal for the currently selected line is set to Exposure Active - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        LineSource_ExposureAlternateActive,  //!< Output is high during the exposure of every second Frame - Applies to: Stereo ace
        LineSource_ExposureTriggerWait,  //!< The source signal for the currently selected line is set to Exposure Trigger Wait - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        LineSource_FlashWindow,  //!< The source signal for the currently selected line is set to Flash Window - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE and dart USB
        ...
        LineSource_FrameBurstActive,  //!< The source signal for the currently selected line is set to Frame Burst Active - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE and racer 2S GigE
        LineSource_FrameBurstTriggerWait,  //!< The source signal for the currently selected line is set to Frame Burst Trigger Wait - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE and racer 2S GigE
        LineSource_FrameCycle,  //!< The signal for the currently selected line is rising with Frame Trigger Wait and falling with Exposure Active - Applies to: CameraLink and ace GigE
        LineSource_FrameTriggerWait,  //!< The source signal for the currently selected line is set to Frame Trigger Wait - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        LineSource_FrequencyConverter,  //!< The signal for the currently selected line is associated with the output of the frequency converter module - Applies to: CameraLink and ace GigE
        LineSource_High,  //!< The output is always High - Applies to: Stereo ace
        LineSource_LineTriggerWait,  //!< The source signal for the currently selected line is set to Line Trigger Wait - Applies to: CameraLink, ace GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        LineSource_Low,  //!< The output is always Low - Applies to: Stereo ace
        LineSource_Off,  //!< No source signal is set for the currently selected line - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        LineSource_PatternGenerator1,  //!< Applies to: CameraLink and ace GigE
        LineSource_PatternGenerator2,  //!< Applies to: CameraLink and ace GigE
        LineSource_PatternGenerator3,  //!< Applies to: CameraLink and ace GigE
        LineSource_PatternGenerator4,  //!< Applies to: CameraLink and ace GigE
        LineSource_SerialTx,  //!< The source signal for the currently selected line is set to Serial Tx - Applies to: CameraLink, ace 2 GigE, ace 2 USB, ace GigE, boost CoaXPress, dart GigE and racer 2 CXP
        LineSource_ShaftEncoderModuleOut,  //!< The signal for the currently selected line is associated with the output of the shaft encoder module - Applies to: CameraLink and ace GigE
        LineSource_SyncUserOutput,  //!< The source signal for the currently selected line is set to Sync User Output - Applies to: CameraLink and ace GigE
        LineSource_SyncUserOutput0,  //!< The source signal for the currently selected line is set to Sync User Output 0 - Applies to: ace GigE
        LineSource_SyncUserOutput1,  //!< The source signal for the currently selected line is set to Sync User Output 1 - Applies to: ace GigE
        LineSource_SyncUserOutput2,  //!< The source signal for the currently selected line is set to Sync User Output 2 - Applies to: ace GigE
        LineSource_SyncUserOutput3,  //!< The source signal for the currently selected line is set to Sync User Output 3 - Applies to: ace GigE
        LineSource_Timer1Active,  //!< The source signal for the currently selected line is set to Timer 1 Active - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        LineSource_Timer2Active,  //!< The source signal for the currently selected line is set to Timer 2 Active - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        LineSource_Timer3Active,  //!< Sets the source signal for the selected output line to timer 3 active - Applies to: CameraLink and ace GigE
        LineSource_Timer4Active,  //!< Sets the source signal for the selected output line to timer 4 active - Applies to: CameraLink and ace GigE
        LineSource_TimerActive,  //!< The source signal for the currently selected line is set to Timer Active - Applies to: CameraLink and ace GigE
        LineSource_TriggerReady,  //!< The source signal for the currently selected line is set to Trigger Ready - Applies to: CameraLink and ace GigE
        LineSource_UserOutput,  //!< The source signal for the currently selected line is set to User Output - Applies to: CameraLink and ace GigE
        LineSource_UserOutput0,  //!< The source signal for the currently selected line is set to User Output 0 - Applies to: ace GigE and ace USB
        LineSource_UserOutput1,  //!< The source signal for the currently selected line is set to User Output 1 - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        LineSource_UserOutput2,  //!< The source signal for the currently selected line is set to User Output 2 - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        LineSource_UserOutput3,  //!< The source signal for the currently selected line is set to User Output 3 - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        LineSource_UserOutput4  //!< The source signal for the currently selected line is set to User Output 4 - Applies to: CameraLink, ace GigE and dart USB
    };
    ...
    {
        ParameterSelector_AutoTargetValue,  //!< The factory limits of the Auto Target Value parameter can be removed - Applies to: CameraLink and ace GigE
        ParameterSelector_BlackLevel,  //!< The factory limits of the Black Level parameter can be removed - Applies to: CameraLink and ace GigE
        ParameterSelector_Brightness,  //!< The factory limits of the Brightness parameter can be removed - Applies to: CameraLink and ace GigE
        ParameterSelector_ExposureOverhead,  //!< The factory limits of the Exposure Overhead parameter can be removed - Applies to: CameraLink and ace GigE
        ParameterSelector_ExposureOverlapMax,  //!< The factory limits of the Exposure Overlap Time Max parameter can be removed - Applies to: ace GigE
        ParameterSelector_ExposureTime,  //!< The factory limits of the Exposure Time parameter can be removed - Applies to: CameraLink and ace GigE
        ParameterSelector_Framerate,  //!< The factory limits of the Framerate parameter can be removed - Applies to: CameraLink and ace GigE
        ParameterSelector_Gain  //!< The factory limits of the Gain parameter can be removed - Applies to: CameraLink and ace GigE
    };

    //! Valid values for PgiMode
    enum PgiModeEnums
    {
        PgiMode_Off,  //!< Basler PGI image optimizations are disabled - Applies to: ace GigE and ace USB
        PgiMode_On  //!< Basler PGI image optimizations are enabled - Applies to: ace GigE and ace USB
    };

    //! Valid values for PixelCoding
    enum PixelCodingEnums
    {
        PixelCoding_BGR16,  //!< Applies to: CameraLink and ace GigE
        PixelCoding_BGR8,  //!< Applies to: CameraLink and ace GigE
        PixelCoding_BGRA8,  //!< Applies to: CameraLink and ace GigE
        PixelCoding_BayerBG10p,  //!< Sets the pixel format to Bayer BG 10p - Applies to: ace GigE
        PixelCoding_BayerGB10p,  //!< Sets the pixel format to Bayer GB 10p - Applies to: ace GigE
        PixelCoding_BayerGR10p,  //!< Sets the pixel format to Bayer GR 10p - Applies to: ace GigE
        PixelCoding_BayerRG10p,  //!< Sets the pixel format to Bayer RG 10p - Applies to: ace GigE
        PixelCoding_Mono10Packed,  //!< Applies to: CameraLink and ace GigE
        PixelCoding_Mono12Packed,  //!< Applies to: CameraLink and ace GigE
        PixelCoding_Mono16,  //!< Applies to: CameraLink and ace GigE
        PixelCoding_Mono8,  //!< Applies to: CameraLink and ace GigE
        PixelCoding_Mono8Signed,  //!< Applies to: CameraLink and ace GigE
        PixelCoding_RGB10V1Packed,  //!< Applies to: CameraLink and ace GigE
        PixelCoding_RGB10V2Packed,  //!< Applies to: CameraLink and ace GigE
        PixelCoding_RGB16,  //!< Applies to: CameraLink and ace GigE
        PixelCoding_RGB16Planar,  //!< Applies to: CameraLink and ace GigE
        PixelCoding_RGB8,  //!< Applies to: CameraLink and ace GigE
        PixelCoding_RGB8Planar,  //!< Applies to: CameraLink and ace GigE
        PixelCoding_RGBA8,  //!< Applies to: CameraLink and ace GigE
        PixelCoding_Raw16,  //!< Applies to: CameraLink and ace GigE
        PixelCoding_Raw8,  //!< Applies to: CameraLink and ace GigE
        PixelCoding_YUV411,  //!< Applies to: CameraLink and ace GigE
        PixelCoding_YUV422,  //!< Applies to: CameraLink and ace GigE
        PixelCoding_YUV444  //!< Applies to: CameraLink and ace GigE
    };
    ...
    enum PixelColorFilterEnums
    {
        ...
        PixelColorFilter_Bayer_BG,  //!< The Bayer filter has a BG/GR alignment to the pixels in the acquired images - Applies to: CameraLink and ace GigE
        PixelColorFilter_Bayer_GB,  //!< The Bayer filter has a GB/RG alignment to the pixels in the acquired images - Applies to: CameraLink and ace GigE
        PixelColorFilter_Bayer_GR,  //!< The Bayer filter has a GR/BG alignment to the pixels in the acquired images - Applies to: CameraLink and ace GigE
        PixelColorFilter_Bayer_RG,  //!< The Bayer filter has an RG/GB alignment to the pixels in the acquired images - Applies to: CameraLink and ace GigE
        PixelColorFilter_None  //!< The camera doesn't have a Bayer filter - Applies to: CameraLink, ace GigE, ace USB, dart USB and pulse USB
    };

    //! Valid values for PixelFormat
    enum PixelFormatEnums
    {
        PixelFormat_BGR10Packed,  //!< The pixel format is set to BGR 10 Packed - Applies to: CameraLink and ace GigE
        PixelFormat_BGR12Packed,  //!< The pixel format is set to BGR 12 Packed - Applies to: CameraLink and ace GigE
        PixelFormat_BGR8,  //!< The pixel format is set to BGR 8 - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        PixelFormat_BGR8Packed,  //!< The pixel format is set to BGR 8 Packed - Applies to: CamEmu, CameraLink and ace GigE
        PixelFormat_BGRA8Packed,  //!< The pixel format is set to BGRA 8 Packed - Applies to: CamEmu, CameraLink and ace GigE
        PixelFormat_BayerBG10,  //!< The pixel format is set to Bayer BG 10 - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI and dart USB
        PixelFormat_BayerBG10p,  //!< The pixel format is set to Bayer BG 10p - Applies to: ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE and dart USB
        PixelFormat_BayerBG12,  //!< The pixel format is set to Bayer BG 12 - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB and pulse USB
        PixelFormat_BayerBG12Packed,  //!< The pixel format is set to Bayer BG 12 Packed - Applies to: CameraLink and ace GigE
        PixelFormat_BayerBG12p,  //!< The pixel format is set to Bayer BG 12p - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE and dart USB
        PixelFormat_BayerBG16,  //!< The pixel format is set to Bayer BG 16 - Applies to: CamEmu, CameraLink, ace GigE and dart MIPI
        PixelFormat_BayerBG8,  //!< The pixel format is set to Bayer BG 8 - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB and pulse USB
        PixelFormat_BayerGB10,  //!< The pixel format is set to Bayer GB 10 - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI and dart USB
        PixelFormat_BayerGB10p,  //!< The pixel format is set to Bayer GB 10p - Applies to: ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE and dart USB
        PixelFormat_BayerGB12,  //!< The pixel format is set to Bayer GB 12 - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB and pulse USB
        PixelFormat_BayerGB12Packed,  //!< The pixel format is set to Bayer GB 12 Packed - Applies to: CameraLink and ace GigE
        PixelFormat_BayerGB12p,  //!< The pixel format is set to Bayer GB 12p - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE and dart USB
        PixelFormat_BayerGB16,  //!< The pixel format is set to Bayer GB 16 - Applies to: CamEmu, CameraLink, ace GigE and dart MIPI
        PixelFormat_BayerGB8,  //!< The pixel format is set to Bayer GB 8 - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB and pulse USB
        PixelFormat_BayerGR10,  //!< The pixel format is set to Bayer GR 10 - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI and dart USB
        PixelFormat_BayerGR10p,  //!< The pixel format is set to Bayer GR 10p - Applies to: ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE and dart USB
        PixelFormat_BayerGR12,  //!< The pixel format is set to Bayer GR 12 - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB and pulse USB
        PixelFormat_BayerGR12Packed,  //!< The pixel format is set to Bayer GR 12 Packed - Applies to: CameraLink and ace GigE
        PixelFormat_BayerGR12p,  //!< The pixel format is set to Bayer GR 12p - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE and dart USB
        PixelFormat_BayerGR16,  //!< The pixel format is set to Bayer GR 16 - Applies to: CamEmu, CameraLink, ace GigE and dart MIPI
        PixelFormat_BayerGR8,  //!< The pixel format is set to Bayer GR 8 - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB and pulse USB
        PixelFormat_BayerRG10,  //!< The pixel format is set to Bayer RG 10 - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI and dart USB
        PixelFormat_BayerRG10p,  //!< The pixel format is set to Bayer RG 10p - Applies to: ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE and dart USB
        PixelFormat_BayerRG12,  //!< The pixel format is set to Bayer RG 12 - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB and pulse USB
        PixelFormat_BayerRG12Packed,  //!< The pixel format is set to Bayer RG 12 Packed - Applies to: CameraLink and ace GigE
        PixelFormat_BayerRG12p,  //!< The pixel format is set to Bayer RG 12p - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE and dart USB
        PixelFormat_BayerRG16,  //!< The pixel format is set to Bayer RG 16 - Applies to: CamEmu, CameraLink, ace GigE and dart MIPI
        PixelFormat_BayerRG8,  //!< The pixel format is set to Bayer RG 8 - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB and pulse USB
        PixelFormat_BiColorBGRG10,  //!< The pixel format is set to BiColor BGRG 10 - Applies to: racer 2 CXP
        PixelFormat_BiColorBGRG12,  //!< The pixel format is set to BiColor BGRG 12 - Applies to: racer 2 CXP
        PixelFormat_BiColorBGRG8,  //!< The pixel format is set to BiColor BGRG 8 - Applies to: racer 2 CXP, racer 2S 5GigE and racer 2S GigE
        PixelFormat_BiColorRGBG10,  //!< The pixel format is set to BiColor RGBG 10 - Applies to: racer 2 CXP
        PixelFormat_BiColorRGBG12,  //!< The pixel format is set to BiColor RGBG 12 - Applies to: racer 2 CXP
        PixelFormat_BiColorRGBG8,  //!< The pixel format is set to BiColor RGBG 8 - Applies to: racer 2 CXP, racer 2S 5GigE and racer 2S GigE
        ...
        PixelFormat_Mono10,  //!< The pixel format is set to Mono 10 - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        PixelFormat_Mono10Packed,  //!< Sets the pixel format to Mono 10 Packed - Applies to: CameraLink and ace GigE
        PixelFormat_Mono10p,  //!< The pixel format is set to Mono 10p - Applies to: ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        PixelFormat_Mono12,  //!< The pixel format is set to Mono 12 - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        PixelFormat_Mono12Packed,  //!< The pixel format is set to Mono 12 Packed - Applies to: CameraLink and ace GigE
        PixelFormat_Mono12p,  //!< The pixel format is set to Mono 12p - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        PixelFormat_Mono16,  //!< The pixel format is set to Mono 16 - Applies to: CamEmu, CameraLink, ace GigE, blaze and dart MIPI
        PixelFormat_Mono8,  //!< The pixel format is set to Mono 8 - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        PixelFormat_Mono8Signed,  //!< Sets the pixel format to Mono 8 Signed - Applies to: CameraLink and ace GigE
        PixelFormat_RGB10,  //!< The pixel format is set to RGB 10 - Applies to: racer 2 CXP
        PixelFormat_RGB10Packed,  //!< The pixel format is set to RGB 10 Packed - Applies to: CameraLink and ace GigE
        PixelFormat_RGB10Planar,  //!< The pixel format is set to RGB 10 Planar - Applies to: CameraLink and ace GigE
        PixelFormat_RGB10V1Packed,  //!< The pixel format is set to RGB 10V1 Packed - Applies to: CameraLink and ace GigE
        PixelFormat_RGB10V2Packed,  //!< The pixel format is set to RGB 10V2 Packed - Applies to: CameraLink and ace GigE
        PixelFormat_RGB12,  //!< The pixel format is set to RGB 12 - Applies to: racer 2 CXP
        PixelFormat_RGB12Packed,  //!< The pixel format is set to RGB 12 Packed - Applies to: CameraLink and ace GigE
        PixelFormat_RGB12Planar,  //!< The pixel format is set to RGB 12 Planar - Applies to: CameraLink and ace GigE
        PixelFormat_RGB12V1Packed,  //!< The pixel format is set to RGB 12 V1 Packed - Applies to: CameraLink and ace GigE
        PixelFormat_RGB16Packed,  //!< Sets the pixel format to RGB 16 Packed - Applies to: CamEmu
        PixelFormat_RGB16Planar,  //!< The pixel format is set to RGB 16 Planar - Applies to: CameraLink and ace GigE
        PixelFormat_RGB8,  //!< The pixel format is set to RGB 8 - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        PixelFormat_RGB8Packed,  //!< The pixel format is set to RGB 8 Packed - Applies to: CamEmu, CameraLink and ace GigE
        PixelFormat_RGB8Planar,  //!< The pixel format is set to RGB 8 Planar - Applies to: CameraLink and ace GigE
        PixelFormat_RGBA8Packed,  //!< The pixel format is set to RGBA 8 Packed - Applies to: CameraLink and ace GigE
        ...
        PixelFormat_YCbCr422_8,  //!< The pixel format is set to YCbCr 422 - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2S 5GigE and racer 2S GigE
        PixelFormat_YUV411Packed,  //!< Sets the pixel format to YUV 411 Packed - Applies to: CameraLink and ace GigE
        PixelFormat_YUV422Packed,  //!< The pixel format is set to YUV 422 Packed - Applies to: CameraLink and ace GigE
        PixelFormat_YUV422_8,  //!< The pixel format is set to YUV 4:2:2 8 bit packed - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart MIPI, dart USB, racer 2 CXP and racer 2S CXP
        PixelFormat_YUV422_8_UYVY,  //!< The pixel format is set to YUV 4:2:2 8-bit (UYVY) - Applies to: dart MIPI
        PixelFormat_YUV422_YUYV_Packed,  //!< The pixel format is set to YUV 422 (YUYV) Packed - Applies to: CameraLink and ace GigE
        PixelFormat_YUV444Packed  //!< Sets the pixel format to YUV 444 Packed - Applies to: CameraLink and ace GigE
    };

    //! Valid values for PixelSize
    enum PixelSizeEnums
    {
        PixelSize_Bpp1,  //!< The pixel depth in the acquired images is 1 bit per pixel - Applies to: CameraLink, ace GigE and ace USB
        PixelSize_Bpp10,  //!< The pixel depth in the acquired images is 10 bits per pixel - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        PixelSize_Bpp12,  //!< The pixel depth in the acquired images is 12 bits per pixel - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        PixelSize_Bpp14,  //!< The pixel depth in the acquired images is 14 bits per pixel - Applies to: CameraLink and ace GigE
        PixelSize_Bpp16,  //!< The pixel depth in the acquired images is 16 bits per pixel - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        PixelSize_Bpp2,  //!< The pixel depth in the acquired images is 2 bits per pixel - Applies to: CameraLink, ace GigE and ace USB
        PixelSize_Bpp24,  //!< The pixel depth in the acquired images is 24 bits per pixel - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        PixelSize_Bpp30,  //!< The pixel depth in the acquired images is 30 bits per pixel - Applies to: racer 2 CXP
        PixelSize_Bpp32,  //!< The pixel depth in the acquired images is 32 bits per pixel - Applies to: CamEmu, CameraLink, ace GigE and racer 2 CXP
        PixelSize_Bpp36,  //!< The pixel depth in the acquired images is 36 bits per pixel - Applies to: CameraLink, ace GigE and racer 2 CXP
        PixelSize_Bpp4,  //!< The pixel depth in the acquired images is 4 bits per pixel - Applies to: CameraLink, ace GigE and ace USB
        PixelSize_Bpp48,  //!< The pixel depth in the acquired images is 48 bits per pixel - Applies to: CamEmu, CameraLink and ace GigE
        PixelSize_Bpp64,  //!< The pixel depth in the acquired images is 64 bits per pixel - Applies to: CameraLink and ace GigE
        PixelSize_Bpp8  //!< The pixel depth in the acquired images is 8 bits per pixel - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for PtpClockAccuracy
    enum PtpClockAccuracyEnums
    {
        PtpClockAccuracy_GreaterThan10s,  //!< The expected accuracy of the PTP device clock is greater than 10 seconds - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        PtpClockAccuracy_Unknown,  //!< The expected accuracy of the PTP device clock is unknown - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        PtpClockAccuracy_Within100ms,  //!< The expected accuracy of the PTP device clock is within 100 milliseconds - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        PtpClockAccuracy_Within100ns,  //!< The expected accuracy of the PTP device clock is within 100 nanoseconds - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        PtpClockAccuracy_Within100us,  //!< The expected accuracy of the PTP device clock is within 100 microseconds - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        PtpClockAccuracy_Within10ms,  //!< The expected accuracy of the PTP device clock is within 10 milliseconds - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        PtpClockAccuracy_Within10s,  //!< The expected accuracy of the PTP device clock is within 10 seconds - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        PtpClockAccuracy_Within10us,  //!< The expected accuracy of the PTP device clock is within 10 microseconds - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        PtpClockAccuracy_Within1ms,  //!< The expected accuracy of the PTP device clock is within 1 millisecond - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        PtpClockAccuracy_Within1s,  //!< The expected accuracy of the PTP device clock is within 1 second - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        PtpClockAccuracy_Within1us,  //!< The expected accuracy of the PTP device clock is within 1 microsecond - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        PtpClockAccuracy_Within250ms,  //!< The expected accuracy of the PTP device clock is within 250 milliseconds - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        PtpClockAccuracy_Within250ns,  //!< The expected accuracy of the PTP device clock is within 250 nanoseconds - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        PtpClockAccuracy_Within250us,  //!< The expected accuracy of the PTP device clock is within 250 microseconds - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        PtpClockAccuracy_Within25ms,  //!< The expected accuracy of the PTP device clock is within 25 milliseconds - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        PtpClockAccuracy_Within25ns,  //!< The expected accuracy of the PTP device clock is within 25 nanoseconds - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        PtpClockAccuracy_Within25us,  //!< The expected accuracy of the PTP device clock is within 25 microseconds - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        PtpClockAccuracy_Within2p5ms,  //!< The expected accuracy of the PTP device clock is within 2 5 milliseconds - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        PtpClockAccuracy_Within2p5us  //!< The expected accuracy of the PTP device clock is within 2 5 microseconds - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
    };

    //! Valid values for PtpServoStatus
    enum PtpServoStatusEnums
    {
        PtpServoStatus_Locked,  //!< The clock servo is locked - Applies to: Stereo ace, ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        PtpServoStatus_Unknown  //!< The status of the clock servo is unknown - Applies to: Stereo ace, ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
    };

    //! Valid values for PtpStatus
    enum PtpStatusEnums
    {
        PtpStatus_Disabled,  //!< The port is in the Disabled state - Applies to: Stereo ace, ace 2 GigE, blaze, dart GigE, racer 2S 5GigE and racer 2S GigE
        PtpStatus_Faulty,  //!< The port is in the Faulty state - Applies to: Stereo ace, ace 2 GigE, blaze, dart GigE, racer 2S 5GigE and racer 2S GigE
        PtpStatus_Initializing,  //!< The port is in the Initializing state - Applies to: Stereo ace, ace 2 GigE, blaze, dart GigE, racer 2S 5GigE and racer 2S GigE
        PtpStatus_Listening,  //!< The port is in the Listening state - Applies to: Stereo ace, ace 2 GigE, blaze, dart GigE, racer 2S 5GigE and racer 2S GigE
        PtpStatus_Master,  //!< The port is in the Master state - Applies to: Stereo ace, ace 2 GigE, blaze, dart GigE, racer 2S 5GigE and racer 2S GigE
        PtpStatus_Passive,  //!< The port is in the Passive state - Applies to: Stereo ace, ace 2 GigE, blaze, dart GigE, racer 2S 5GigE and racer 2S GigE
        PtpStatus_PreMaster,  //!< The port is in the PreMaster state - Applies to: Stereo ace, ace 2 GigE, blaze, dart GigE, racer 2S 5GigE and racer 2S GigE
        PtpStatus_Slave,  //!< The port is in the Slave state - Applies to: Stereo ace, ace 2 GigE, blaze, dart GigE, racer 2S 5GigE and racer 2S GigE
        PtpStatus_Uncalibrated  //!< The port is in the Uncalibrated state - Applies to: Stereo ace, ace 2 GigE, blaze, dart GigE, racer 2S 5GigE and racer 2S GigE
    };

    //! Valid values for ROIZoneMode
    enum ROIZoneModeEnums
    {
        ROIZoneMode_Off,  //!< The currently selected ROI zone is disabled - Applies to: ace GigE and ace USB
        ROIZoneMode_On  //!< The currently selected ROI zone is enabled - Applies to: ace GigE and ace USB
    };

    //! Valid values for ROIZoneSelector
    enum ROIZoneSelectorEnums
    {
        ROIZoneSelector_Zone0,  //!< ROI zone 0 can be configured - Applies to: ace GigE and ace USB
        ROIZoneSelector_Zone1,  //!< ROI zone 1 can be configured - Applies to: ace GigE and ace USB
        ROIZoneSelector_Zone2,  //!< ROI zone 2 can be configured - Applies to: ace GigE and ace USB
        ROIZoneSelector_Zone3,  //!< ROI zone 3 can be configured - Applies to: ace GigE and ace USB
        ROIZoneSelector_Zone4,  //!< ROI zone 4 can be configured - Applies to: ace GigE and ace USB
        ROIZoneSelector_Zone5,  //!< ROI zone 5 can be configured - Applies to: ace GigE and ace USB
        ROIZoneSelector_Zone6,  //!< ROI zone 6 can be configured - Applies to: ace GigE and ace USB
        ROIZoneSelector_Zone7  //!< ROI zone 7 can be configured - Applies to: ace GigE and ace USB
    };
    ...
    {
        SensorBitDepth_BitDepth10,  //!< The sensor delivers 10-bit pixels - Applies to: CameraLink and ace GigE
        SensorBitDepth_BitDepth12,  //!< The sensor delivers 12-bit pixels - Applies to: CameraLink and ace GigE
        SensorBitDepth_BitDepth14,  //!< The sensor delivers 14-bit pixels - Applies to: CameraLink and ace GigE
        SensorBitDepth_BitDepth16,  //!< The sensor delivers 16-bit pixels - Applies to: CameraLink and ace GigE
        SensorBitDepth_BitDepth8  //!< The sensor delivers 8-bit pixels - Applies to: CameraLink and ace GigE
    };

    //! Valid values for SensorDigitizationTaps
    enum SensorDigitizationTapsEnums
    {
        SensorDigitizationTaps_Four,  //!< Applies to: CameraLink and ace GigE
        SensorDigitizationTaps_One,  //!< Applies to: CameraLink and ace GigE
        SensorDigitizationTaps_Three,  //!< Applies to: CameraLink and ace GigE
        SensorDigitizationTaps_Two  //!< Applies to: CameraLink and ace GigE
    };

    //! Valid values for SensorReadoutMode
    enum SensorReadoutModeEnums
    {
        SensorReadoutMode_Fast,  //!< The camera operates in fast readout mode - Applies to: ace GigE and ace USB
        SensorReadoutMode_Normal  //!< The camera operates in normal readout mode - Applies to: ace GigE and ace USB
    };

    //! Valid values for SensorShutterMode
    enum SensorShutterModeEnums
    {
        SensorShutterMode_Global,  //!< The shutter opens and closes at the same time for all pixels - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB and pulse USB
        ...
        SensorShutterMode_Rolling  //!< The shutter opens and closes sequentially for groups of rows - Applies to: ace 2 GigE, ace 2 USB, dart USB and pulse USB
    };

    //! Valid values for SequenceAddressBitSelector
    enum SequenceAddressBitSelectorEnums
    {
        SequenceAddressBitSelector_Bit0,  //!< Bit 0 of the sequence set address can be controlled using an input line - Applies to: CameraLink and ace GigE
        SequenceAddressBitSelector_Bit1,  //!< Bit 1 of the sequence set address can be controlled using an input line - Applies to: CameraLink and ace GigE
        SequenceAddressBitSelector_Bit2,  //!< Bit 2 of the sequence set address can be controlled using an input line - Applies to: CameraLink and ace GigE
        SequenceAddressBitSelector_Bit3  //!< Bit 3 of the sequence set address can be controlled using an input line - Applies to: CameraLink and ace GigE
    };

    //! Valid values for SequenceAddressBitSource
    enum SequenceAddressBitSourceEnums
    {
        SequenceAddressBitSource_CC1,  //!< The selected bit of the sequence set address can be set using the CC1 signal - Applies to: CameraLink and ace GigE
        SequenceAddressBitSource_CC2,  //!< The selected bit of the sequence set address can be set using the CC2 signal - Applies to: CameraLink and ace GigE
        SequenceAddressBitSource_CC3,  //!< The selected bit of the sequence set address can be set using the CC3 signal - Applies to: CameraLink and ace GigE
        SequenceAddressBitSource_CC4,  //!< The selected bit of the sequence set address can be set using the CC4 signal - Applies to: CameraLink and ace GigE
        SequenceAddressBitSource_Line1,  //!< The selected bit of the sequence set address can be set using Line 1 - Applies to: CameraLink and ace GigE
        SequenceAddressBitSource_Line2,  //!< The selected bit of the sequence set address can be set using Line 2 - Applies to: CameraLink and ace GigE
        SequenceAddressBitSource_Line3,  //!< The selected bit of the sequence set address can be set using Line 3 - Applies to: CameraLink and ace GigE
        SequenceAddressBitSource_Line4,  //!< The selected bit of the sequence set address can be set using Line 4 - Applies to: CameraLink and ace GigE
        SequenceAddressBitSource_Line5,  //!< The selected bit of the sequence set address can be set using Line 5 - Applies to: CameraLink and ace GigE
        SequenceAddressBitSource_Line6,  //!< The selected bit of the sequence set address can be set using Line 6 - Applies to: CameraLink and ace GigE
        SequenceAddressBitSource_Line7,  //!< The selected bit of the sequence set address can be set using Line 7 - Applies to: CameraLink and ace GigE
        SequenceAddressBitSource_Line8,  //!< The selected bit of the sequence set address can be set using Line 8 - Applies to: CameraLink and ace GigE
        SequenceAddressBitSource_VInput1,  //!< Selects Virtual Input 1 as the source for the selected bit of the sequence set address - Applies to: CameraLink and ace GigE
        SequenceAddressBitSource_VInput2,  //!< Selects Virtual Input 2 as the source for the selected bit of the sequence set address - Applies to: CameraLink and ace GigE
        SequenceAddressBitSource_VInput3,  //!< Selects Virtual Input 3 as the source for the selected bit of the sequence set address - Applies to: CameraLink and ace GigE
        SequenceAddressBitSource_VInput4,  //!< Selects Virtual Input 4 as the source for the selected bit of the sequence set address - Applies to: CameraLink and ace GigE
        SequenceAddressBitSource_VInputDecActive  //!< Selects Virtual Input Decoder Active as the source for the selected bit of the sequence set address - Applies to: CameraLink and ace GigE
    };

    //! Valid values for SequenceAdvanceMode
    enum SequenceAdvanceModeEnums
    {
        SequenceAdvanceMode_Auto,  //!< The Auto sequence advance mode is selected - Applies to: CameraLink and ace GigE
        SequenceAdvanceMode_Controlled,  //!< The Controlled sequence advance mode is selected - Applies to: CameraLink and ace GigE
        SequenceAdvanceMode_FreeSelection  //!< The Free Selection sequence advance mode is selected - Applies to: CameraLink and ace GigE
    };

    //! Valid values for SequenceConfigurationMode
    enum SequenceConfigurationModeEnums
    {
        SequenceConfigurationMode_Off,  //!< The sequencer can't be configured - Applies to: ace GigE
        SequenceConfigurationMode_On  //!< The sequencer can be configured - Applies to: ace GigE
    };

    //! Valid values for SequenceControlSelector
    enum SequenceControlSelectorEnums
    {
        SequenceControlSelector_Advance,  //!< The sequence set advance can be configured - Applies to: CameraLink and ace GigE
        SequenceControlSelector_Restart  //!< The sequence set restart can be configured - Applies to: CameraLink and ace GigE
    };

    //! Valid values for SequenceControlSource
    enum SequenceControlSourceEnums
    {
        SequenceControlSource_AlwaysActive,  //!< Sequence set advance is automatic  The sequence repeat starts with sequence set index number 1 - Applies to: CameraLink and ace GigE
        SequenceControlSource_CC1,  //!< Sequence restart or sequence set advance are controlled using the CC1 signal - Applies to: CameraLink and ace GigE
        SequenceControlSource_CC2,  //!< Sequence restart or sequence set advance are controlled using the CC2 signal - Applies to: CameraLink and ace GigE
        SequenceControlSource_CC3,  //!< Sequence restart or sequence set advance are controlled using the CC3 signal - Applies to: CameraLink and ace GigE
        SequenceControlSource_CC4,  //!< Sequence restart or sequence set advance are controlled using the CC4 signal - Applies to: CameraLink and ace GigE
        SequenceControlSource_Disabled,  //!< Sequence set advance will be controlled using the Async Advance command - Applies to: CameraLink and ace GigE
        SequenceControlSource_Line1,  //!< Sequence restart or sequence set advance are controlled using Line 1 - Applies to: CameraLink and ace GigE
        SequenceControlSource_Line2,  //!< Sequence restart or sequence set advance are controlled using Line 2 - Applies to: CameraLink and ace GigE
        SequenceControlSource_Line3,  //!< Sequence restart or sequence set advance are controlled using Line 3 - Applies to: CameraLink and ace GigE
        SequenceControlSource_Line4,  //!< Sequence restart or sequence set advance are controlled using Line 4 - Applies to: CameraLink and ace GigE
        SequenceControlSource_Line5,  //!< Sequence restart or sequence set advance are controlled using Line 5 - Applies to: CameraLink and ace GigE
        SequenceControlSource_Line6,  //!< Sequence restart or sequence set advance are controlled using Line 6 - Applies to: CameraLink and ace GigE
        SequenceControlSource_Line7,  //!< Sequence restart or sequence set advance are controlled using Line 7 - Applies to: CameraLink and ace GigE
        SequenceControlSource_Line8,  //!< Sequence restart or sequence set advance are controlled using Line 8 - Applies to: CameraLink and ace GigE
        SequenceControlSource_VInput1,  //!< The source for sequence restart or sequence set advance is Virtual Input 1 - Applies to: CameraLink and ace GigE
        SequenceControlSource_VInput2,  //!< The source for sequence restart or sequence set advance is Virtual Input 2 - Applies to: CameraLink and ace GigE
        SequenceControlSource_VInput3,  //!< The source for sequence restart or sequence set advance is Virtual Input 3 - Applies to: CameraLink and ace GigE
        SequenceControlSource_VInput4,  //!< The source for sequence restart or sequence set advance is Virtual Input 4 - Applies to: CameraLink and ace GigE
        SequenceControlSource_VInputDecActive  //!< The source for sequence restart or sequence set advance is Virtual Input Decoder Active - Applies to: CameraLink and ace GigE
    };
    ...
    {
        ShadingSelector_GainShading,  //!< Gain Shading correction is selected - Applies to: CameraLink and ace GigE
        ShadingSelector_OffsetShading  //!< Offset Shading correction is selected - Applies to: CameraLink and ace GigE
    };

    //! Valid values for ShadingSetCreate
    enum ShadingSetCreateEnums
    {
        ShadingSetCreate_Off,  //!< Applies to: CameraLink and ace GigE
        ShadingSetCreate_Once  //!< Applies to: CameraLink and ace GigE
    };

    //! Valid values for ShadingSetDefaultSelector
    enum ShadingSetDefaultSelectorEnums
    {
        ShadingSetDefaultSelector_DefaultShadingSet,  //!< The default shading set is selected as the bootup shading set - Applies to: CameraLink and ace GigE
        ShadingSetDefaultSelector_UserShadingSet1,  //!< User Shading Set 1 is selected as the bootup shading set - Applies to: CameraLink and ace GigE
        ShadingSetDefaultSelector_UserShadingSet2  //!< User Shading Set 2 is selected as the bootup shading set - Applies to: CameraLink and ace GigE
    };

    //! Valid values for ShadingSetSelector
    enum ShadingSetSelectorEnums
    {
        ShadingSetSelector_DefaultShadingSet,  //!< The default shading set can be loaded using the Activate command - Applies to: CameraLink and ace GigE
        ShadingSetSelector_UserShadingSet1,  //!< User Shading Set 1 can be loaded using the Activate command - Applies to: CameraLink and ace GigE
        ShadingSetSelector_UserShadingSet2  //!< User Shading Set 2 can be loaded using the Activate command - Applies to: CameraLink and ace GigE
    };

    //! Valid values for ShadingStatus
    enum ShadingStatusEnums
    {
        ShadingStatus_ActivateError,  //!< The selected shading set could not be loaded - Applies to: CameraLink and ace GigE
        ShadingStatus_CreateError,  //!< A problem occurred while creating a shading set - Applies to: CameraLink and ace GigE
        ShadingStatus_NoError,  //!< The last operation related to shading correction was successful - Applies to: CameraLink and ace GigE
        ShadingStatus_StartupSetError  //!< A problem with the startup shading set occurred - Applies to: CameraLink and ace GigE
    };

    //! Valid values for ShaftEncoderModuleCounterMode
    enum ShaftEncoderModuleCounterModeEnums
    {
        ShaftEncoderModuleCounterMode_FollowDirection,  //!< The tick counter increases for forward ticks and decreases for reverse ticks - Applies to: CameraLink and ace GigE
        ShaftEncoderModuleCounterMode_IgnoreDirection  //!< The tick counter increases for forward ticks and for reverse ticks - Applies to: CameraLink and ace GigE
    };

    //! Valid values for ShaftEncoderModuleLineSelector
    enum ShaftEncoderModuleLineSelectorEnums
    {
        ShaftEncoderModuleLineSelector_PhaseA,  //!< Phase A of the shaft encoder is selected as input for the shaft encoder module - Applies to: CameraLink and ace GigE
        ShaftEncoderModuleLineSelector_PhaseB  //!< Phase B of the shaft encoder is selected as input for the shaft encoder module - Applies to: CameraLink and ace GigE
    };

    //! Valid values for ShaftEncoderModuleLineSource
    enum ShaftEncoderModuleLineSourceEnums
    {
        ShaftEncoderModuleLineSource_CC1,  //!< The source signal for the shaft encoder module is set to CC1 - Applies to: CameraLink and ace GigE
        ShaftEncoderModuleLineSource_CC2,  //!< The source signal for the shaft encoder module is set to CC2 - Applies to: CameraLink and ace GigE
        ShaftEncoderModuleLineSource_CC3,  //!< The source signal for the shaft encoder module is set to CC3 - Applies to: CameraLink and ace GigE
        ShaftEncoderModuleLineSource_CC4,  //!< The source signal for the shaft encoder module is set to CC4 - Applies to: CameraLink and ace GigE
        ShaftEncoderModuleLineSource_Line1,  //!< The source signal for the shaft encoder module is set to input line 1 - Applies to: CameraLink and ace GigE
        ShaftEncoderModuleLineSource_Line2,  //!< The source signal for the shaft encoder module is set to input line 2 - Applies to: CameraLink and ace GigE
        ShaftEncoderModuleLineSource_Line3,  //!< The source signal for the shaft encoder module is set to input line 3 - Applies to: CameraLink and ace GigE
        ShaftEncoderModuleLineSource_Line4,  //!< The source signal for the shaft encoder module is set to input line 4 - Applies to: CameraLink and ace GigE
        ShaftEncoderModuleLineSource_Line5,  //!< Selects input line 5 as signal source for the shaft encoder module - Applies to: CameraLink and ace GigE
        ShaftEncoderModuleLineSource_Line6,  //!< Selects input line 6 as signal source for the shaft encoder module - Applies to: CameraLink and ace GigE
        ShaftEncoderModuleLineSource_Line7,  //!< Selects input line 7 as signal source for the shaft encoder module - Applies to: CameraLink and ace GigE
        ShaftEncoderModuleLineSource_Line8  //!< Selects input line 8 as signal source for the shaft encoder module - Applies to: CameraLink and ace GigE
    };

    //! Valid values for ShaftEncoderModuleMode
    enum ShaftEncoderModuleModeEnums
    {
        ShaftEncoderModuleMode_AnyDirection,  //!< The shaft encoder module outputs trigger signals for forward and reverse ticks, provided the reverse counter is neither increasing nor decreasing - Applies to: CameraLink and ace GigE
        ShaftEncoderModuleMode_ForwardOnly  //!< The shaft encoder module outputs trigger signals for forward ticks only, provided the reverse counter is neither increasing nor decreasing - Applies to: CameraLink and ace GigE
    };

    //! Valid values for ShutterMode
    enum ShutterModeEnums
    {
        ShutterMode_Global,  //!< The shutter opens and closes at the same time for all pixels - Applies to: CameraLink, ace GigE and ace USB
        ShutterMode_GlobalResetRelease,  //!< The shutter opens at the same time for all rows but closes in a sequential manner - Applies to: CameraLink, ace GigE and ace USB
        ShutterMode_Rolling  //!< The shutter opens and closes sequentially for groups of rows - Applies to: CameraLink, ace GigE and ace USB
    };

    //! Valid values for SoftwareSignalSelector
    enum SoftwareSignalSelectorEnums
    {
        SoftwareSignalSelector_SoftwareSignal1,  //!< Software signal 1 can be executed - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        SoftwareSignalSelector_SoftwareSignal2,  //!< Software signal 2 can be executed - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        SoftwareSignalSelector_SoftwareSignal3,  //!< Software signal 3 can be executed - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    ...
    {
        SyncUserOutputSelector_SyncUserOutput0,  //!< User-settable synchronous output signal 0 can be configured - Applies to: ace GigE
        SyncUserOutputSelector_SyncUserOutput1,  //!< User-settable synchronous output signal 1 can be configured - Applies to: CameraLink and ace GigE
        SyncUserOutputSelector_SyncUserOutput2,  //!< User-settable synchronous output signal 2 can be configured - Applies to: CameraLink and ace GigE
        SyncUserOutputSelector_SyncUserOutput3,  //!< User-settable synchronous output signal 3 can be configured - Applies to: CameraLink and ace GigE
        SyncUserOutputSelector_SyncUserOutput4,  //!< User-settable synchronous output signal 4 can be configured - Applies to: CameraLink and ace GigE
        SyncUserOutputSelector_SyncUserOutput5,  //!< Selects user settable synchronous output signal 5 for configuration - Applies to: CameraLink and ace GigE
        SyncUserOutputSelector_SyncUserOutput6,  //!< Selects user settable synchronous output signal 6 for configuration - Applies to: CameraLink and ace GigE
        SyncUserOutputSelector_SyncUserOutput7,  //!< Selects user settable synchronous output signal 7 for configuration - Applies to: CameraLink and ace GigE
        SyncUserOutputSelector_SyncUserOutput8,  //!< Selects user settable synchronous output signal 8 for configuration - Applies to: CameraLink and ace GigE
    ...
    {
        TemperatureSelector_Case,  //!< The temperature is measured on the case - Applies to: CameraLink and ace GigE
        TemperatureSelector_Coreboard,  //!< The temperature is measured on the core board - Applies to: CameraLink and ace GigE
        TemperatureSelector_Framegrabberboard,  //!< The temperature is measured on the frame grabber board - Applies to: CameraLink and ace GigE
        TemperatureSelector_Sensorboard  //!< The temperature is measured on the sensor board - Applies to: CameraLink and ace GigE
    };

    //! Valid values for TemperatureState
    enum TemperatureStateEnums
    {
        TemperatureState_Critical,  //!< The temperature is close to or at the allowed maximum  Provide cooling - Applies to: CameraLink, ace GigE, ace USB and blaze
        TemperatureState_Error,  //!< The temperature is above the allowed maximum  Provide cooling immediately - Applies to: CameraLink, ace GigE, ace USB and blaze
        TemperatureState_Ok  //!< The temperature is within the normal operating temperature range - Applies to: CameraLink, ace GigE, ace USB and blaze
    };

    //! Valid values for TestImageSelector
    enum TestImageSelectorEnums
    {
        TestImageSelector_Black,  //!< Sets the camera to generate and transmit black test images - Applies to: CameraLink and ace GigE
        TestImageSelector_ColorBar,  //!< Sets the camera to generate and transmit test images with a color bar pattern - Applies to: CameraLink and ace GigE
        TestImageSelector_DeviceSpecific,  //!< Sets the camera to generate and transmit test images with a camera specific pattern - Applies to: CameraLink and ace GigE
        TestImageSelector_FixedDiagonalGrayGradient_8Bit,  //!< Sets the camera to generate and transmit test images with an 8 bit fixed diagonal gray gradient pattern - Applies to: CameraLink and ace GigE
        TestImageSelector_FrameCounter,  //!< Sets the camera to generate and transmit test images with a frame counter pattern - Applies to: CameraLink and ace GigE
        TestImageSelector_GreyHorizontalRamp,  //!< Sets the camera to generate and transmit test images with a fixed horizontal gray gradient pattern - Applies to: CameraLink and ace GigE
        TestImageSelector_GreyHorizontalRampMoving,  //!< Sets the camera to generate and transmit test images with a moving horizontal gray gradient pattern - Applies to: CameraLink and ace GigE
        TestImageSelector_GreyVerticalRamp,  //!< Sets the camera to generate and transmit test images with a fixed vertical gray gradient pattern - Applies to: CameraLink and ace GigE
        TestImageSelector_GreyVerticalRampMoving,  //!< Sets the camera to generate and transmit test images with a moving vertical gray gradient pattern - Applies to: CameraLink and ace GigE
        TestImageSelector_HorzontalLineMoving,  //!< Sets the camera to generate and transmit test images with a moving horizontal line pattern - Applies to: CameraLink and ace GigE
        TestImageSelector_MovingDiagonalColorGradient,  //!< Sets the camera to generate and transmit test images with a moving diagonal color gradient pattern - Applies to: CameraLink and ace GigE
        TestImageSelector_MovingDiagonalGrayGradientFeatureTest_12Bit,  //!< Sets the camera to generate and transmit test images with a 12 bit moving diagonal gray gradient feature test pattern - Applies to: CameraLink and ace GigE
        TestImageSelector_MovingDiagonalGrayGradientFeatureTest_8Bit,  //!< Sets the camera to generate and transmit test images with an 8 bit moving diagonal gray gradient feature test pattern - Applies to: CameraLink and ace GigE
        TestImageSelector_MovingDiagonalGrayGradient_12Bit,  //!< Sets the camera to generate and transmit test images with a 12 bit moving diagonal gray gradient pattern - Applies to: CameraLink and ace GigE
        TestImageSelector_MovingDiagonalGrayGradient_8Bit,  //!< Sets the camera to generate and transmit test images with an 8 bit moving diagonal gray gradient pattern - Applies to: CameraLink and ace GigE
        TestImageSelector_Off,  //!< The camera doesn't display a test image - Applies to: CamEmu, CameraLink, ace GigE and ace USB
        TestImageSelector_Testimage1,  //!< The camera generates a test image with the test image 1 pattern - Applies to: CamEmu, CameraLink, ace GigE and ace USB
        TestImageSelector_Testimage2,  //!< The camera generates a test image with the test image 2 pattern - Applies to: CamEmu, CameraLink, ace GigE and ace USB
        TestImageSelector_Testimage3,  //!< The camera generates a test image with the test image 3 pattern - Applies to: CameraLink, ace GigE and ace USB
        TestImageSelector_Testimage4,  //!< The camera generates a test image with the test image 4 pattern - Applies to: CameraLink, ace GigE and ace USB
        TestImageSelector_Testimage5,  //!< The camera generates a test image with the test image 5 pattern - Applies to: CameraLink, ace GigE and ace USB
        TestImageSelector_Testimage6,  //!< The camera generates a test image with the test image 6 pattern - Applies to: CameraLink, ace GigE and ace USB
        TestImageSelector_Testimage7,  //!< The camera generates a test image with the test image 7 pattern - Applies to: CameraLink and ace GigE
        TestImageSelector_VerticalLineMoving,  //!< Sets the camera to generate and transmit test images with a moving vertical line pattern - Applies to: CameraLink and ace GigE
        TestImageSelector_White  //!< Sets the camera to generate and transmit white test images - Applies to: CameraLink and ace GigE
    };

    //! Valid values for TestPattern
    enum TestPatternEnums
    {
        TestPattern_Black,  //!< The camera generates a black test pattern - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        TestPattern_Off,  //!< No test pattern is generated - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TestPattern_Testimage1,  //!< The camera generates a test image with the test image 1 pattern - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TestPattern_Testimage2,  //!< The camera generates a test image with the test image 2 pattern - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TestPattern_Testimage3,  //!< The camera generates a test image with the test image 3 pattern - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TestPattern_Testimage6,  //!< The camera generates a test image with the test image 6 pattern - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TestPattern_White  //!< The camera generates a white test pattern - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for TimerSelector
    enum TimerSelectorEnums
    {
        TimerSelector_Timer1,  //!< Timer 1 can be configured - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TimerSelector_Timer2,  //!< Timer 2 can be configured - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TimerSelector_Timer3,  //!< Timer 3 can be configured - Applies to: CameraLink and ace GigE
        TimerSelector_Timer4  //!< Timer 4 can be configured - Applies to: CameraLink and ace GigE
    };

    //! Valid values for TimerSequenceEntrySelector
    enum TimerSequenceEntrySelectorEnums
    {
        TimerSequenceEntrySelector_Entry1,  //!< Applies to: CameraLink and ace GigE
        TimerSequenceEntrySelector_Entry10,  //!< Applies to: CameraLink and ace GigE
        TimerSequenceEntrySelector_Entry11,  //!< Applies to: CameraLink and ace GigE
        TimerSequenceEntrySelector_Entry12,  //!< Applies to: CameraLink and ace GigE
        TimerSequenceEntrySelector_Entry13,  //!< Applies to: CameraLink and ace GigE
        TimerSequenceEntrySelector_Entry14,  //!< Applies to: CameraLink and ace GigE
        TimerSequenceEntrySelector_Entry15,  //!< Applies to: CameraLink and ace GigE
        TimerSequenceEntrySelector_Entry16,  //!< Applies to: CameraLink and ace GigE
        TimerSequenceEntrySelector_Entry2,  //!< Applies to: CameraLink and ace GigE
        TimerSequenceEntrySelector_Entry3,  //!< Applies to: CameraLink and ace GigE
        TimerSequenceEntrySelector_Entry4,  //!< Applies to: CameraLink and ace GigE
        TimerSequenceEntrySelector_Entry5,  //!< Applies to: CameraLink and ace GigE
        TimerSequenceEntrySelector_Entry6,  //!< Applies to: CameraLink and ace GigE
        TimerSequenceEntrySelector_Entry7,  //!< Applies to: CameraLink and ace GigE
        TimerSequenceEntrySelector_Entry8,  //!< Applies to: CameraLink and ace GigE
        TimerSequenceEntrySelector_Entry9  //!< Applies to: CameraLink and ace GigE
    };

    //! Valid values for TimerSequenceTimerSelector
    enum TimerSequenceTimerSelectorEnums
    {
        TimerSequenceTimerSelector_Timer1,  //!< Applies to: CameraLink and ace GigE
        TimerSequenceTimerSelector_Timer2,  //!< Applies to: CameraLink and ace GigE
        TimerSequenceTimerSelector_Timer3,  //!< Applies to: CameraLink and ace GigE
        TimerSequenceTimerSelector_Timer4  //!< Applies to: CameraLink and ace GigE
    };

    //! Valid values for TimerStatus
    enum TimerStatusEnums
    {
        TimerStatus_TimerActive,  //!< The timer has been started - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TimerStatus_TimerIdle,  //!< The timer is idle - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TimerStatus_TimerTriggerWait  //!< The timer is waiting to be started - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for TimerTriggerActivation
    enum TimerTriggerActivationEnums
    {
        TimerTriggerActivation_AnyEdge,  //!< The timer will start at any edge signal change - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TimerTriggerActivation_FallingEdge,  //!< The timer will start at a falling edge signal change - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TimerTriggerActivation_LevelHigh,  //!< The timer will start when the signal is high - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TimerTriggerActivation_LevelLow,  //!< The timer will start when the signal is low - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TimerTriggerActivation_RisingEdge  //!< The timer will start at a rising edge signal change - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for TimerTriggerSource
    enum TimerTriggerSourceEnums
    {
        TimerTriggerSource_AcquisitionActive,  //!< The selected timer can be started by an Acquisition Active signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TimerTriggerSource_Action1,  //!< The selected timer can be started by an action signal that is defined by action signal 1 - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        TimerTriggerSource_Counter1Active,  //!< The selected timer can be started by a Counter 1 Active signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TimerTriggerSource_Counter1End,  //!< The selected timer can be started by a Counter 1 End signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TimerTriggerSource_Counter1Start,  //!< The selected timer can be started by a Counter 1 Start signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TimerTriggerSource_Counter2Active,  //!< The selected timer can be started by a Counter 2 Active signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TimerTriggerSource_Counter2End,  //!< The selected timer can be started by a Counter 2 End signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TimerTriggerSource_Counter2Start,  //!< The selected timer can be started by a Counter 2 Start signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        TimerTriggerSource_ExposureActive,  //!< The selected timer can be started by an Exposure Active signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TimerTriggerSource_ExposureStart,  //!< The selected timer can be started by an Exposure Start signal - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TimerTriggerSource_ExposureTriggerWait,  //!< The selected timer can be started by an Exposure Trigger Wait signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TimerTriggerSource_FlashWindow,  //!< The selected timer can be started by a Flash Window signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and dart USB
        TimerTriggerSource_FlashWindowStart,  //!< The timer can be triggered by the flash window start signal - Applies to: ace GigE and ace USB
        ...
        TimerTriggerSource_FrameBurstActive,  //!< The selected timer can be started by a Frame Burst Active signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE and racer 2S GigE
        TimerTriggerSource_FrameBurstTriggerWait,  //!< The selected timer can be started by a Frame Burst Trigger Wait signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE and racer 2S GigE
        TimerTriggerSource_FrameTriggerWait,  //!< The selected timer can be started by a Frame Trigger Wait signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        TimerTriggerSource_Line1,  //!< The selected timer can be started by a Line 1 signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TimerTriggerSource_Line2,  //!< The selected timer can be started by a Line 2 signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TimerTriggerSource_Line3,  //!< The selected timer can be started by a Line 3 signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TimerTriggerSource_Line4,  //!< The selected timer can be started by a Line 4 signal - Applies to: dart USB
        ...
        TimerTriggerSource_Off,  //!< The selected timer is disabled and can't be started - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TimerTriggerSource_PeriodicSignal1,  //!< The selected timer can be started by a Periodic Signal 1 signal - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        TimerTriggerSource_SoftwareSignal1,  //!< The selected timer can be started by a Software Signal 1 signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TimerTriggerSource_SoftwareSignal2,  //!< The selected timer can be started by a Software Signal 2 signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TimerTriggerSource_SoftwareSignal3,  //!< The selected timer can be started by a Software Signal 3 signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TimerTriggerSource_Timer1Active,  //!< The selected timer can be started by a Timer 1 Active signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TimerTriggerSource_Timer1End,  //!< The selected timer can be started by a Timer 1 End signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TimerTriggerSource_Timer2Active,  //!< The selected timer can be started by a Timer 2 Active signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TimerTriggerSource_Timer2End  //!< The selected timer can be started by a Timer 2 End signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for TonalRangeAuto
    enum TonalRangeAutoEnums
    {
        TonalRangeAuto_Off,  //!< Automatic tonal range adjustment is disabled - Applies to: ace GigE and ace USB
        TonalRangeAuto_Once  //!< Automatic tonal range adjustment is enabled - Applies to: ace GigE and ace USB
    };

    //! Valid values for TonalRangeEnable
    enum TonalRangeEnableEnums
    {
        TonalRangeEnable_Off,  //!< Tonal range adjustment is disabled - Applies to: ace GigE and ace USB
        TonalRangeEnable_On  //!< Tonal range adjustment is enabled - Applies to: ace GigE and ace USB
    };

    //! Valid values for TonalRangeSelector
    enum TonalRangeSelectorEnums
    {
        TonalRangeSelector_Blue,  //!< Only the blue pixel values are used for tonal range adjustments - Applies to: ace GigE and ace USB
        TonalRangeSelector_Green,  //!< Only the green pixel values are used for tonal range adjustments - Applies to: ace GigE and ace USB
        TonalRangeSelector_Red,  //!< Only the red pixel values are used for tonal range adjustments - Applies to: ace GigE and ace USB
        TonalRangeSelector_Sum  //!< The summed RGB pixel values are used for tonal range adjustments - Applies to: ace GigE and ace USB
    };

    //! Valid values for TriggerActivation
    enum TriggerActivationEnums
    {
        TriggerActivation_AnyEdge,  //!< The selected trigger is activated by the falling or rising edge of the source signal - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TriggerActivation_FallingEdge,  //!< The selected trigger is activated by the falling edge of the source signal - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TriggerActivation_LevelHigh,  //!< The selected trigger is activated when the source signal is high - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TriggerActivation_LevelLow,  //!< The selected trigger is activated when the source signal is low - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TriggerActivation_RisingEdge  //!< The selected trigger is activated by the rising edge of the source signal - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for TriggerControlImplementation
    enum TriggerControlImplementationEnums
    {
        TriggerControlImplementation_Legacy,  //!< The image acquisition control mode is set to Legacy - Applies to: CameraLink and ace GigE
        TriggerControlImplementation_Standard  //!< The image acquisition control mode is set to Standard - Applies to: CameraLink and ace GigE
    };

    //! Valid values for TriggerDelaySource
    enum TriggerDelaySourceEnums
    {
        TriggerDelaySource_LineTrigger,  //!< The trigger delay is expressed as a number of line triggers - Applies to: CameraLink and ace GigE
        TriggerDelaySource_Time_us  //!< The trigger delay is expressed as a time interval in microseconds - Applies to: CameraLink and ace GigE
    };

    //! Valid values for TriggerMode
    enum TriggerModeEnums
    {
        TriggerMode_Off,  //!< The currently selected trigger is turned off - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TriggerMode_On  //!< The currently selected trigger is turned on - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for TriggerSelector
    enum TriggerSelectorEnums
    {
        TriggerSelector_AcquisitionActive,  //!< Selects the acquisition active trigger for configuration - Applies to: CameraLink and ace GigE
        TriggerSelector_AcquisitionEnd,  //!< Selects the acquisition end trigger for configuration - Applies to: CameraLink and ace GigE
        TriggerSelector_AcquisitionStart,  //!< The Acquisition Start trigger can be configured - Applies to: CameraLink and ace GigE
        TriggerSelector_ExposureActive,  //!< The Exposure Active trigger can be configured - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TriggerSelector_ExposureEnd,  //!< The Exposure End trigger can be configured - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TriggerSelector_ExposureStart,  //!< The Exposure Start trigger can be configured - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TriggerSelector_FrameActive,  //!< The Frame Active trigger can be configured - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TriggerSelector_FrameBurstActive,  //!< The Frame Burst Active trigger can be configured - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE and racer 2S GigE
        TriggerSelector_FrameBurstEnd,  //!< The Frame Burst End trigger can be configured - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE and racer 2S GigE
        TriggerSelector_FrameBurstStart,  //!< The Frame Burst Start trigger can be configured - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE and racer 2S GigE
        TriggerSelector_FrameEnd,  //!< The Frame End trigger can be configured - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TriggerSelector_FrameStart,  //!< The Frame Start trigger can be configured - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TriggerSelector_LineStart  //!< The Line Start trigger can be configured - Applies to: CameraLink, ace GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for TriggerSource
    enum TriggerSourceEnums
    {
        TriggerSource_Action1,  //!< The source signal for the selected trigger is set to action command signal 1 - Applies to: CamEmu, CameraLink, ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        TriggerSource_Action2,  //!< The source signal for the selected trigger is set to action command signal 2 - Applies to: CameraLink, ace 2 GigE and ace GigE
        TriggerSource_Action3,  //!< The source signal for the selected trigger is set to action command signal 3 - Applies to: CameraLink and ace GigE
        TriggerSource_Action4,  //!< The source signal for the selected trigger is set to action command signal 4 - Applies to: CameraLink and ace GigE
        TriggerSource_CC1,  //!< The source signal for the selected trigger is set to CC1 - Applies to: CameraLink and ace GigE
        TriggerSource_CC2,  //!< The source signal for the selected trigger is set to CC2 - Applies to: CameraLink and ace GigE
        TriggerSource_CC3,  //!< The source signal for the selected trigger is set to CC3 - Applies to: CameraLink and ace GigE
        TriggerSource_CC4,  //!< The source signal for the selected trigger is set to CC4 - Applies to: CameraLink and ace GigE
        TriggerSource_CXPTrigger0,  //!< The CXP Trigger 0 trigger can be configured - Applies to: boost V CoaXPress
        TriggerSource_Counter1Active,  //!< The source signal for the selected trigger is set to Counter 1 Active - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TriggerSource_Counter1End,  //!< The source signal for the selected trigger is set to Counter 1 End - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TriggerSource_Counter1Start,  //!< The source signal for the selected trigger is set to Counter 1 Start - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TriggerSource_Counter2Active,  //!< The source signal for the selected trigger is set to Counter 2 Active - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TriggerSource_Counter2End,  //!< The source signal for the selected trigger is set to Counter 2 End - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TriggerSource_Counter2Start,  //!< The source signal for the selected trigger is set to Counter 2 Start - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        TriggerSource_FrequencyConverter,  //!< The source signal for the selected trigger is set to Frequency Converter - Applies to: CameraLink, ace GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        TriggerSource_Line1,  //!< The source signal for the selected trigger is set to Line 1 - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TriggerSource_Line2,  //!< The source signal for the selected trigger is set to Line 2 - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TriggerSource_Line3,  //!< The source signal for the selected trigger is set to Line 3 - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TriggerSource_Line4,  //!< The source signal for the selected trigger is set to Line 4 - Applies to: CameraLink, ace GigE, ace USB and dart USB
        TriggerSource_Line5,  //!< The source signal for the selected trigger is set to Line 5 - Applies to: CameraLink and ace GigE
        TriggerSource_Line6,  //!< The source signal for the selected trigger is set to Line 6 - Applies to: CameraLink and ace GigE
        TriggerSource_Line7,  //!< The source signal for the selected trigger is set to Line 7 - Applies to: CameraLink and ace GigE
        TriggerSource_Line8,  //!< The source signal for the selected trigger is set to Line 8 - Applies to: CameraLink and ace GigE
        TriggerSource_PeriodicSignal1,  //!< The source signal for the selected trigger is set to Periodic Signal 1 - Applies to: CamEmu, ace 2 GigE, dart GigE, dart MIPI, racer 2S 5GigE and racer 2S GigE
        TriggerSource_ShaftEncoderModuleOut,  //!< The source signal for the selected trigger is set to the shaft encoder module - Applies to: CameraLink and ace GigE
        TriggerSource_Software,  //!< The source signal for the selected trigger is set to software triggering - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TriggerSource_SoftwareSignal1,  //!< The source signal for the selected trigger is set to software signal 1 - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TriggerSource_SoftwareSignal2,  //!< The source signal for the selected trigger is set to software signal 2 - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TriggerSource_SoftwareSignal3,  //!< The source signal for the selected trigger is set to software signal 3 - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TriggerSource_Timer1Active,  //!< The Timer 1 Active trigger can be configured - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TriggerSource_Timer1End,  //!< The Timer 1 End trigger can be configured - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TriggerSource_Timer1Start,  //!< Sets the signal source for the selected trigger to timer 1 start - Applies to: CameraLink and ace GigE
        TriggerSource_Timer2Active,  //!< The Timer 2 Active trigger can be configured - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TriggerSource_Timer2End,  //!< The Timer 2 End trigger can be configured - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        TriggerSource_UserOutput1,  //!< Sets the signal source for the selected trigger to user output 1 - Applies to: CameraLink and ace GigE
        TriggerSource_UserOutput2,  //!< Sets the signal source for the selected trigger to user output 2 - Applies to: CameraLink and ace GigE
        TriggerSource_VInput1,  //!< Sets the signal source for the selected trigger to Virtual Input 1 - Applies to: CameraLink and ace GigE
        TriggerSource_VInput2,  //!< Sets the signal source for the selected trigger to Virtual Input 2 - Applies to: CameraLink and ace GigE
        TriggerSource_VInput3,  //!< Sets the signal source for the selected trigger to Virtual Input 3 - Applies to: CameraLink and ace GigE
        TriggerSource_VInput4,  //!< Sets the signal source for the selected trigger to Virtual Input 4 - Applies to: CameraLink and ace GigE
        TriggerSource_VInputDecActive  //!< Sets the signal source for the selected trigger to Virtual Input Decoder Active - Applies to: CameraLink and ace GigE
    };

    //! Valid values for UserDefinedValueSelector
    enum UserDefinedValueSelectorEnums
    {
        UserDefinedValueSelector_Value1,  //!< The user-defined value 1 can be configured - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        UserDefinedValueSelector_Value2,  //!< The user-defined value 2 can be configured - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        UserDefinedValueSelector_Value3,  //!< The user-defined value 3 can be configured - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        UserDefinedValueSelector_Value4,  //!< The user-defined value 4 can be configured - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        UserDefinedValueSelector_Value5  //!< The user-defined value 5 can be configured - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for UserOutputSelector
    enum UserOutputSelectorEnums
    {
        UserOutputSelector_UserOutput0,  //!< The user-settable output signal 0 can be configured - Applies to: ace GigE and ace USB
        UserOutputSelector_UserOutput1,  //!< The user-settable output signal 1 can be configured - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        UserOutputSelector_UserOutput2,  //!< The user-settable output signal 2 can be configured - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        UserOutputSelector_UserOutput3,  //!< The user-settable output signal 3 can be configured - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        UserOutputSelector_UserOutput4,  //!< The user-settable output signal 4 can be configured - Applies to: CameraLink, ace GigE and dart USB
        UserOutputSelector_UserOutput5,  //!< The user-settable output signal 5 can be configured - Applies to: CameraLink and ace GigE
        UserOutputSelector_UserOutput6,  //!< The user-settable output signal 6 can be configured - Applies to: CameraLink and ace GigE
        UserOutputSelector_UserOutput7,  //!< Selects user settable output signal 7 for configuration - Applies to: CameraLink and ace GigE
        UserOutputSelector_UserOutput8,  //!< Selects user settable output signal 8 for configuration - Applies to: CameraLink and ace GigE
    ...
    enum UserSetDefaultEnums
    {
        ...
        UserSetDefault_Default,  //!< The Default User Set factory set is set as the default startup set - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        UserSetDefault_UserSet1,  //!< User set 1 is set as the default startup set - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        UserSetDefault_UserSet2,  //!< User set 2 is set as the default startup set - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        UserSetDefault_UserSet3  //!< User set 3 is set as the default startup set - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for UserSetDefaultSelector
    enum UserSetDefaultSelectorEnums
    {
        UserSetDefaultSelector_AutoFunctions,  //!< The Auto Functions factory set is set as the default startup set - Applies to: CameraLink and ace GigE
        UserSetDefaultSelector_Color,  //!< The Color factory set is set as the default startup set - Applies to: CameraLink and ace GigE
        UserSetDefaultSelector_ColorRaw,  //!< The Color Raw factory set is set as the default startup set - Applies to: ace GigE
        UserSetDefaultSelector_Custom0,  //!< Custom 0 factory set is set as the default startup set - Applies to: CameraLink and ace GigE
        UserSetDefaultSelector_Custom1,  //!< Custom 1 factory set is set as the default startup set - Applies to: CameraLink and ace GigE
        UserSetDefaultSelector_Default,  //!< The Default User Set factory set is set as the default startup set - Applies to: CameraLink and ace GigE
        UserSetDefaultSelector_HighGain,  //!< The High Gain factory set is set as the default startup set - Applies to: CameraLink and ace GigE
        UserSetDefaultSelector_LightMicroscopy,  //!< The Light Microscopy factory set is set as the default startup set - Applies to: ace GigE
        UserSetDefaultSelector_UserSet1,  //!< User set 1 is set as the default startup set - Applies to: CameraLink and ace GigE
        UserSetDefaultSelector_UserSet2,  //!< User set 2 is set as the default startup set - Applies to: CameraLink and ace GigE
        UserSetDefaultSelector_UserSet3  //!< User set 3 is set as the default startup set - Applies to: CameraLink and ace GigE
    };

    //! Valid values for UserSetSelector
    enum UserSetSelectorEnums
    {
        UserSetSelector_AutoFunctions,  //!< The Auto Functions factory set can be loaded - Applies to: CameraLink, ace GigE and ace USB
        UserSetSelector_Color,  //!< The Color factory set can be loaded - Applies to: CameraLink, ace GigE and ace USB
        UserSetSelector_ColorRaw,  //!< The Color Raw factory set can be loaded - Applies to: ace GigE and ace USB
        UserSetSelector_Custom0,  //!< The Custom 0 factory set can be loaded - Applies to: CameraLink and ace GigE
        UserSetSelector_Custom1,  //!< The Custom 1 factory set can be loaded - Applies to: CameraLink and ace GigE
        UserSetSelector_Default,  //!< The Default User Set factory set can be loaded - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        UserSetSelector_HighGain,  //!< The High Gain factory set can be loaded - Applies to: CameraLink, ace GigE and ace USB
        UserSetSelector_LightMicroscopy,  //!< The Light Microscopy factory set can be loaded - Applies to: ace GigE and ace USB
        UserSetSelector_UserSet1,  //!< User set 1 can be saved, loaded, or configured - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        UserSetSelector_UserSet2,  //!< User set 2 can be saved, loaded, or configured - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        UserSetSelector_UserSet3  //!< User set 3 can be saved, loaded, or configured - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for VInpSignalReadoutActivation
    enum VInpSignalReadoutActivationEnums
    {
        VInpSignalReadoutActivation_FallingEdge,  //!< Sets the type of signal change necessary to start the signal evaluation - Applies to: CameraLink and ace GigE
        VInpSignalReadoutActivation_RisingEdge  //!< Sets the type of signal change necessary to start the signal evaluation - Applies to: CameraLink and ace GigE
    };

    //! Valid values for VInpSignalSource
    enum VInpSignalSourceEnums
    {
        VInpSignalSource_CC1,  //!< TODO - Applies to: CameraLink and ace GigE
        VInpSignalSource_CC2,  //!< TODO - Applies to: CameraLink and ace GigE
        VInpSignalSource_CC3,  //!< TODO - Applies to: CameraLink and ace GigE
        VInpSignalSource_CC4,  //!< TODO - Applies to: CameraLink and ace GigE
        VInpSignalSource_Line1,  //!< TODO - Applies to: CameraLink and ace GigE
        VInpSignalSource_Line2,  //!< TODO - Applies to: CameraLink and ace GigE
        VInpSignalSource_Line3,  //!< TODO - Applies to: CameraLink and ace GigE
        VInpSignalSource_Line4,  //!< TODO - Applies to: CameraLink and ace GigE
        VInpSignalSource_Line5,  //!< TODO - Applies to: CameraLink and ace GigE
        VInpSignalSource_Line6,  //!< TODO - Applies to: CameraLink and ace GigE
        VInpSignalSource_Line7,  //!< TODO - Applies to: CameraLink and ace GigE
        VInpSignalSource_Line8  //!< TODO - Applies to: CameraLink and ace GigE
    };

    //! Valid values for VignettingCorrectionMode
    enum VignettingCorrectionModeEnums
    {
        VignettingCorrectionMode_Off,  //!< The vignetting correction is disabled - Applies to: ace GigE and ace USB
        VignettingCorrectionMode_On  //!< The vignetting correction is enabled - Applies to: ace GigE and ace USB
    };
    ...
    //**************************************************************************************************
    // Parameter class CUniversalCameraParams_Params_v11_0_0
    //**************************************************************************************************
    ...
    The \ref sample_ParametrizeCamera_NativeParameterAccess code sample shows how to access camera parameters via the \c Pylon::CBaslerUniversalInstantCamera class.
    */
    class PYLONBASE_API CUniversalCameraParams_Params_v11_0_0
    {
    //----------------------------------------------------------------------------------------------------------------
    // Implementation
    //----------------------------------------------------------------------------------------------------------------
    ...
    //! \cond HIDE_CLASS_METHODS
        ...
        //! Constructor
        CUniversalCameraParams_Params_v11_0_0( void );
    ...
    private:
        class CUniversalCameraParams_Params_v11_0_0_Data;
        CUniversalCameraParams_Params_v11_0_0_Data* m_pCUniversalCameraParams_Params_v11_0_0_Data;
    ...
    public:
        ...
        //@{
        /*!
            \brief Aborts the acquisition of images - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Number of frames to acquire for each Frame Burst Start trigger - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Number of frames to acquire for each Acquisition Start trigger - Applies to: CameraLink, Stereo ace and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Acquisition frame rate of the camera in frames per second - Applies to: CamEmu, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Acquisition frame rate of the camera in frames per second - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables setting the camera's acquisition frame rate to a specified value - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, dart GigE, dart MIPI, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief A check determines whether the camera is currently idle - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Acquisition line rate of the camera in lines per second - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the image acquisition mode - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Starts the acquisition of images - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Stream channel index of the Acquisition Start event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Acquisition Start event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Stream channel index of the Acquisition Start Overtrigger event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Acquisition Start Overtrigger event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Stream channel index of the Acquisition Start Wait event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Acquisition Start Wait event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates whether the camera is waiting for trigger signals - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the signal whose status you want to check - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Stops the acquisition of images - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets how Acquisition Stop commands end image acquisition - Applies to: ace 2 GigE, ace 2 USB, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Stream channel index of the Acquisition Wait event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of an Acquisition Wait event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Number of separate action signals supported by the camera - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Device key used for action commands - Applies to: ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Group key used for action commands - Applies to: ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Group mask used for action commands - Applies to: ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Stream channel index of the Action Late event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Action Late event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Number of action commands that can be queued by the camera - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Action command to be configured   - Applies to: ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Lower limit of the Exposure Time parameter when the Exposure Auto auto function is active - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Upper limit of the Exposure Time parameter when the Exposure Auto auto function is active - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Lower limit of the Exposure Time parameter when the Exposure Auto auto function is active - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Lower limit of the Exposure Time parameter when the Exposure Auto auto function is active (raw value) - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Upper limit of the Exposure Time parameter when the Exposure Auto auto function is active - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Upper limit of the Exposure Time parameter when the Exposure Auto auto function is active (raw value) - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Height of the auto function AOI (in pixels) - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Horizontal offset of the auto function AOI from the left side of the sensor (in pixels) - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Vertical offset from the top of the sensor to the auto function AOI (in pixels) - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which auto function AOI can be configured - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Assigns the Gain Auto and the Exposure Auto auto functions to the currently selected auto function AOI - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Assigns the Red Light Correction auto function to the currently selected auto function AOI - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Assigns the Tonal Range Auto auto function to the currently selected auto function AOI - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Assigns the Balance White Auto auto function to the currently selected auto function AOI - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Width of the auto function AOI (in pixels) - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets how gain and exposure time will be balanced when the camera is making automatic adjustments - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Height of the auto function ROI (in pixels) - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Highlights the current auto function ROI in the image window - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Horizontal offset of the auto function ROI from the left side of the sensor (in pixels) - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Vertical offset from the top of the sensor to the auto function ROI (in pixels) - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which auto function ROI can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Assigns the Gain Auto and the Exposure Auto auto functions to the currently selected auto function ROI - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Assigns the Balance White Auto auto function to the currently selected auto function ROI - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Width of the auto function ROI (in pixels) - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Lower limit of the Gain parameter when the Gain Auto auto function is active - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Lower limit of the Gain parameter when the Gain Auto auto function is active (raw value) - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Upper limit of the Gain parameter when the Gain Auto auto function is active (raw value) - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Upper limit of the Gain parameter when the Gain Auto auto function is active - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Target brightness for the Gain Auto and the Exposure Auto auto functions - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Target brightness for the Gain Auto and the Exposure Auto auto functions - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which parts of the tonal range can be adjusted - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the kind of tonal range auto adjustment - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Bright target value to be used during automatic tonal range adjustments - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Dark target value to be used during automatic tonal range adjustments - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Threshold value from which the Tonal Range Source Bright parameter value is calculated during automatic tonal range adjustments - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Threshold value from which the Tonal Range Source Bright parameter value is calculated during automatic tonal range adjustments (raw value) - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Threshold value from which the Tonal Range Source Dark parameter value is calculated during automatic tonal range adjustments - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Threshold value from which the Tonal Range Source Dark parameter value is calculated during automatic tonal range adjustments (raw value) - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief A serial framing error occurred on reception - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief A serial parity error occurred on reception - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Reports the baud rate of the serial communication module - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Clears the error flags of the serial communication module - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Reports the parity bit configuration of the serial communication module - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Reads and removes the front byte value from the serial communication receive queue - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Last byte value read from the serial communication receive queue - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the signal source for the serial communication module - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Reports the number of stop bits used by the serial communication module - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Writes the current byte value to the transmit queue - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Byte value to be written to the transmit queue - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Reports the status of the serial communication receive queue - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Reports the status of the serial communication transmit queue - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Balance Ratio value to be applied to the currently selected channel - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Balance Ratio value to be applied to the currently selected channel - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Balance Ratio value to be applied to the currently selected channel (raw value) - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which color channel can be adjusted when performing manual white balance - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Balance White adjustment damping factor to be applied - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Balance White adjustment damping factor to be applied (raw value) - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the operation mode of the Balance White Auto auto function - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Resets all white balance adjustments - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets a predefined bandwidth reserve or enables manual configuration of the bandwidth reserve - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Number of adjacent horizontal pixels to be summed - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the binning mode for horizontal binning - Applies to: CamEmu, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets whether sensor or FPGA binning can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Number of adjacent vertical pixels to be summed - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the binning mode for vertical binning - Applies to: CamEmu, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Black level value to be applied to the currently selected sensor tap - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the value of the selected black level control as a float - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Black level value to be applied to the currently selected sensor tap (raw value) - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the type of black level adjustment to be configured - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the burst mode - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets how Acquisition Stop commands end image acquisition - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the metering mode of the auto function - Applies to: dart MIPI

            Sets the metering mode of the exposure or gain auto functions.

            Visibility: Beginner

            The <a href="https://docs.baslerweb.com/?rhcsh=1&rhmapid=BslAutoFunctionMeteringMode" target="_blank">feature documentation</a> may provide more information.
        */
        Pylon::IEnumParameterT<BslAutoFunctionMeteringModeEnums>& BslAutoFunctionMeteringMode;
        ...
        */
        ...
        //@{
        /*!
            \brief Enables the Blooming Reduction feature - Applies to: ace 2 GigE and ace 2 USB
            ...
            The <a href="https://docs.baslerweb.com/?rhcsh=1&rhmapid=BslBloomingReductionEnable" target="_blank">feature documentation</a> may provide more information.
        */
        Pylon::IBooleanEx& BslBloomingReductionEnable;
        ...
        //@{
        /*!
            \brief Brightness value to be applied - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Brightness value to be applied (raw value) - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Centers the image horizontally - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Centers the image vertically - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart MIPI, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the status of the target brightness adjustments performed by the Exposure Auto and Gain Auto auto functions - Applies to: ace 2 GigE, ace 2 USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Value of encoders position counter - Applies to: racer 2S 5GigE and racer 2S GigE


            Visibility: Expert

            The <a href="https://docs.baslerweb.com/?rhcsh=1&rhmapid=BslChunkEncoderValue" target="_blank">feature documentation</a> may provide more information.
        */
        Pylon::IIntegerEx& BslChunkEncoderValue;
        ...
        //@{
        /*!
            \brief Sets which information should be included in the Chunk Timestamp Value chunk - Applies to: ace 2 GigE, ace 2 USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Value of the timestamp when the image was acquired - Applies to: ace 2 GigE, ace 2 USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables color adjustment - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Hue adjustment value to be applied to the currently selected color channel - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Saturation adjustment value to be applied to the currently selected color channel - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which color in your images will be adjusted - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the color space for image acquisitions - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Contrast value to be applied - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the contrast mode - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Contrast value to be applied (raw value) - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the conversion gain mode - Applies to: ace 2 GigE, ace 2 USB and dart GigE


            Visibility: Expert

            The <a href="https://docs.baslerweb.com/?rhcsh=1&rhmapid=BslConversionGainMode" target="_blank">feature documentation</a> may provide more information.
        */
        Pylon::IEnumParameterT<BslConversionGainModeEnums>& BslConversionGainMode;
        ...
        //@{
        /*!
            \brief Identifies outlier pixels and adjusts their intensity value - Applies to: dart MIPI and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the demosaicing method - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the demosaicing mode - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Actual bandwidth the camera will use - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Current exposure time of the camera in microseconds - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates whether an internal error occurred on the device - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Retrieves the next error code from the device - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Error code indicating the cause of the internal error - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Exposure start delay with current settings - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the delay between the start of exposure and the start of the flash window in microseconds - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the width of the flash window in microseconds - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Enables HDR mode - Applies to: dart MIPI


            Visibility: Expert

            The <a href="https://docs.baslerweb.com/?rhcsh=1&rhmapid=BslHdrEnable" target="_blank">feature documentation</a> may provide more information.
        */
        Pylon::IBooleanEx& BslHdrEnable;
        ...
        //@{
        /*!
            \brief Hue shift value to be applied - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Hue shift value to be applied (raw value) - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Time period in which the camera evaluates all changes and durations of logical states of the input signal   - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Time period in which the camera doesn't accept any further trigger signals or signal changes after receiving an input trigger signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Searches for light devices connected to your camera - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates whether any of the light devices are currently experiencing problems - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates whether any of the light devices are currently experiencing problems - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables or disables the light control features - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Number of trigger signals that were received while any of the connected light devices wasn't ready for it - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Resets the counter for trigger signals that were received while any of the connected light devices wasn't ready for it - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which line is used to control the light features - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the current state of the light control mode - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the type of signal transition that will trigger connected light devices - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which signal is used to trigger connected light devices - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Brightness of the light in percent of total brightness available - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Brightness of the light in percent of total brightness available (raw value) - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Changes the ID of the currently selected light device - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Clears the last light device error - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets how the light device is controlled - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Nominal current that the light device uses in continuous operation - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Duty cycle of the device - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Error code indicating the cause of an error in a light device - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Error status indicating whether the current light device is experiencing problems - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Reads the error code from the current light device and resets the error status to No Error - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Version of the light device's firmware - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the last light device error - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum current that the light device is going to use - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum current that the light device is going to use (raw value) - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Name of the light device model - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which ID should be assigned to the current light device - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Changes the ID of the current light device - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the operation mode of the light device - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum current to be used when operating the light device in overdrive - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which light device can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Duration of the individual strobe pulses - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Duration of the individual strobe pulses (raw value) - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the strobe mode of the light device - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the light source preset - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables adjustment of the selected feature - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which features the camera adjusts when you select a light source preset - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //! \name Categories: LineCombinationControl
        //@{
        /*!
            \brief Selects line combination mode - Applies to: racer 2 CXP


            Visibility: Expert

            The <a href="https://docs.baslerweb.com/?rhcsh=1&rhmapid=BslLineCombinationMode" target="_blank">feature documentation</a> may provide more information.
        */
        Pylon::IEnumParameterT<BslLineCombinationModeEnums>& BslLineCombinationMode;
        ...
        //@{
        /*!
            \brief Sets the connection signal for the currently selected line - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates whether a GPIO line is overloaded, i e , not powered correctly - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Horizontal offset of the currently selected column - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which column can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Width of the currently selected column - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables or disables the ability to define multiple regions in horizontal direction - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Vertical offset of the currently selected row - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which row can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Height of the currently selected row - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables or disables the ability to define multiple regions in vertical direction - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Amount of noise reduction to be applied - Applies to: ace 2 GigE, ace 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Delay to be applied to the periodic signal in microseconds - Applies to: ace 2 GigE, dart GigE, dart MIPI, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Length of the periodic signal in microseconds - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the periodic signal channel to be configured - Applies to: ace 2 GigE, dart GigE, dart MIPI, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the source for synchronizing the periodic signal - Applies to: ace 2 GigE, dart GigE, dart MIPI, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Amount of defect pixel correction to be applied - Applies to: ace 2 GigE and ace 2 USB
            ...
            The <a href="https://docs.baslerweb.com/?rhcsh=1&rhmapid=BslPixelCorrectionBeyond" target="_blank">feature documentation</a> may provide more information.
        */
        Pylon::IFloatEx& BslPixelCorrectionBeyond;
        ...
        //@{
        /*!
            \brief Enables the Pixel Correction Beyond feature - Applies to: ace 2 GigE and ace 2 USB
            ...
            The <a href="https://docs.baslerweb.com/?rhcsh=1&rhmapid=BslPixelCorrectionBeyondEnable" target="_blank">feature documentation</a> may provide more information.
        */
        Pylon::IBooleanEx& BslPixelCorrectionBeyondEnable;
        ...
        //@{
        /*!
            \brief Indicates the PTP delay mechanism - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables PTP management - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the mode for PTP network communication - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Value indicating the priority of the device when determining the master clock - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the default PTP profile - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Threshold value below which the device will set the Ptp Servo Status parameter to Locked, indicating that the device is sufficiently synchronized   - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Configures a two-step clock if enabled or a one-step clock if disabled - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Unicast port address - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Unicast port address index - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum number of frames that can be acquired per second with current camera settings - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum number of bursts per second with current camera settings - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum number of frames that can be transferred per second with current camera settings - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Saturation value to be applied - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Saturation value to be applied (raw value) - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Scaling factor to be applied to all images - Applies to: ace 2 GigE, ace 2 USB, dart MIPI and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the bit depth of the image sensor's data output - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the sensor bit depth mode - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Switches the sensor power off - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Switches the sensor power on - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Puts the sensor in standby mode - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Returns the current power state of the sensor - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the baud rate used in serial communication - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the number of data bits used in serial communication - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the number of stop bits used in serial communication - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which kind of parity check is performed - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Initiates a receiving transaction from the serial input buffer - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the incoming break signal status - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Resets the incoming break status - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the overflow status of the receiving FIFO - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the parity error status of the receiving FIFO - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the source of the Rx serial input - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the stop bit error status of the receiving FIFO - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Buffer that holds Rx or Tx transfer data in the controller domain   - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Effective number of serial frames in a Rx or Tx data transfer - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Initiates a transmitting transaction to the serial output buffer - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Controls the transmit behaviour of the serial communication - Applies to: ace 2 GigE, ace 2 USB, dart GigE and racer 2 CXP


            Visibility: Expert

            The <a href="https://docs.baslerweb.com/?rhcsh=1&rhmapid=BslSerialTransmitMode" target="_blank">feature documentation</a> may provide more information.
        */
        Pylon::IEnumParameterT<BslSerialTransmitModeEnums>& BslSerialTransmitMode;
        ...
        //@{
        /*!
            \brief Signals a break to a receiver connected to the camera, or terminates the break - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates whether the transmitting FIFO is empty - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates whether the transmitting FIFO has overflown - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE and racer 2 CXP
        ...
        */
        ...
        /*!
            ...
            Selected by: BslShadingCorrectionSelector and BslShadingCorrectionTargetSelector
        ...
        */
        ...
        //@{
        /*!
            \brief Horizontal offset of the shading ROI (in pixels) - Applies to: racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE


            Visibility: Beginner

            Selected by: BslShadingCorrectionROISelector

            The <a href="https://docs.baslerweb.com/?rhcsh=1&rhmapid=BslShadingCorrectionROIOffsetX" target="_blank">feature documentation</a> may provide more information.
        */
        Pylon::IIntegerEx& BslShadingCorrectionROIOffsetX;
        ...
        //@{
        /*!
            \brief Sets which shading ROI can be configured - Applies to: racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE


            Visibility: Beginner

            Selecting Parameters: BslShadingCorrectionROIOffsetX and BslShadingCorrectionROIWidth

            The <a href="https://docs.baslerweb.com/?rhcsh=1&rhmapid=BslShadingCorrectionROISelector" target="_blank">feature documentation</a> may provide more information.
        */
        Pylon::IEnumParameterT<BslShadingCorrectionROISelectorEnums>& BslShadingCorrectionROISelector;
        ...
        //@{
        /*!
            \brief Width of the shading ROI (in pixels) - Applies to: racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
            ...
            The <a href="https://docs.baslerweb.com/?rhcsh=1&rhmapid=BslShadingCorrectionROIWidth" target="_blank">feature documentation</a> may provide more information.
        */
        Pylon::IIntegerEx& BslShadingCorrectionROIWidth;
        ...
        /*!
            ...
            Selecting Parameters: BslShadingCorrectionAbsoluteTargetValue, BslShadingCorrectionMaximumMeasuredValue, BslShadingCorrectionMode, BslShadingCorrectionSetCreate, BslShadingCorrectionSetCreateResult, BslShadingCorrectionSetIndex, BslShadingCorrectionSetStatus, BslShadingCorrectionTargetSelector and BslShadingCorrectionTargetValue
        ...
        */
        ...
        //@{
        /*!
            \brief This selects the color/line for which the prnu values shall be calculated - Applies to: racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
            ...
            Selecting Parameters: BslShadingCorrectionAbsoluteTargetValue, BslShadingCorrectionMaximumMeasuredValue and BslShadingCorrectionTargetValue

            The <a href="https://docs.baslerweb.com/?rhcsh=1&rhmapid=BslShadingCorrectionTargetSelector" target="_blank">feature documentation</a> may provide more information.
        */
        Pylon::IEnumParameterT<BslShadingCorrectionTargetSelectorEnums>& BslShadingCorrectionTargetSelector;
        ...
        */
        ...
        //@{
        /*!
            \brief Sharpening value to be applied - Applies to: ace 2 GigE, ace 2 USB, dart MIPI and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the signal source to be used to trigger a reversal of the defined spatial correction direction - Applies to: racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Number of acquisitions that have to be buffered in order to combine the correct line data for spatial correction - Applies to: racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Returns the file status of the defect pixel correction file - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum number of defect pixels that the factory or user correction file can contain - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the static defect pixel correction mode - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Reloads the user defect pixel correction file - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the maximum temperature the camera reached during operation - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the temperature state - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates how often the temperature state changed to Error - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the bit depth used for internal image processing   - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the transfer bit depth mode - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the bit rate for TWI communication - Applies to: dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Pulls SCL low, which is rarely needed - Applies to: dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Pulls SDA low, which is rarely needed - Applies to: dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Triggers a read transfer - Applies to: dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Address of the target device - Applies to: dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Buffer that holds data to be written or data that was read - Applies to: dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Number of bytes to be transferred from or to the transfer buffer - Applies to: dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the status of an accepted read or write transfer - Applies to: dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Triggers an update of the transfer status - Applies to: dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Triggers a write transfer - Applies to: dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Centers the image horizontally - Applies to: CameraLink, ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Centers the image vertically - Applies to: CameraLink, ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which counter to retrieve chunk data from - Applies to: ace 2 GigE, ace 2 USB, ace USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Value of the selected chunk counter - Applies to: ace 2 GigE, ace 2 USB, ace USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum possible pixel value in the acquired image - Applies to: ace 2 GigE and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Minimum possible pixel value in the acquired image - Applies to: ace 2 GigE and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Includes the currently selected chunk in the payload data - Applies to: Stereo ace, ace 2 GigE, ace 2 USB, ace GigE, ace USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Exposure time used to acquire the image - Applies to: Stereo ace, ace 2 GigE, ace 2 USB, ace GigE, ace USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which exposure time to retrieve chunk data from - Applies to: ace 2 GigE, ace 2 USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Unique identifier of the current frame - Applies to: Stereo ace, ace 2 GigE, ace 2 USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Value of the Frame Trigger counter when the image was acquired - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Value of the Frame Trigger Ignored counter when the image was acquired - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Value of the Frame counter when the image was acquired - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Value of the Frames per Trigger counter when the image was acquired - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Gain used during image acquisition - Applies to: Stereo ace, ace 2 GigE, ace 2 USB, ace USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Gain All value of the acquired image - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which gain channel to retrieve chunk data from - Applies to: ace 2 GigE, ace 2 USB, ace USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief AOI height of the acquired image - Applies to: Stereo ace, ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Number of bits per line used for the Input Status At Line Trigger parameter - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Index number used for the Input Status At Line Trigger parameter - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Value indicating the status of the camera's input lines when a specific line was acquired - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Bit field that indicates the status of all of the camera's input and output lines when the image was acquired - Applies to: Stereo ace, ace 2 GigE, ace 2 USB, ace GigE, ace USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Value of the Line Trigger counter when the image was acquired - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Value of the Line Trigger End to End counter when the image was acquired - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Value of the Line Trigger Ignored counter when the image was acquired - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables the chunk mode - Applies to: Stereo ace, ace 2 GigE, ace 2 USB, ace GigE, ace USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief X offset of the AOI of the acquired image - Applies to: Stereo ace, ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Y offset of the AOI of the acquired image - Applies to: Stereo ace, ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief CRC checksum of the acquired image - Applies to: ace 2 GigE, ace 2 USB, ace GigE, ace USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum possible pixel value in the acquired image - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Minimum possible pixel value in the acquired image - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the pixel format of the acquired image - Applies to: Stereo ace, ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which chunk can be enabled - Applies to: Stereo ace, ace 2 GigE, ace 2 USB, ace GigE, ace USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sequence set index number related to the acquired image - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Value of the Shaft Encoder counter when the image was acquired - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Number of bytes of data between the beginning of one line in the acquired image and the beginning of the next line in the acquired image - Applies to: ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Value of the timestamp when the image was acquired - Applies to: Stereo ace, ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Value of the Trigger Input counter when the image was acquired - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Status of all of the camera's virtual input and output lines when the image was acquired - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Width of the AOI of the acquired image - Applies to: Stereo ace, ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Clears the last error   - Applies to: CameraLink, ace GigE and blaze
        ...
        */
        ...
        //@{
        /*!
            \brief Enables color adjustment - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Hue adjustment value to be applied to the currently selected color channel - Applies to: CameraLink, ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Hue adjustment value to be applied to the currently selected color channel (raw value) - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Allows you to restore previous color adjustment settings - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Saturation adjustment value to be applied to the currently selected color channel - Applies to: CameraLink, ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Saturation adjustment value to be applied to the currently selected color channel (raw value) - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which color in your images will be adjusted - Applies to: CameraLink, ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Enables color overexposure compensation - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the color overexposure compensation factor for the selected C O C  AOI - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the raw value for the color overexposure compensation factor - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the height for the selected C O C  AOI - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the X offset for the selected C O C  AOI - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the Y offset for the selected C O C  AOI - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Selcts the AOI for color overexposure compensation - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the width for the selected C O C  AOI - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables color transformation - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Extent to which the color matrix influences the color values - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Extent to which the color matrix influences the color values (raw value) - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which type of color transformation will be performed - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Transformation value for the selected element in the color transformation matrix - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Transformation value for the selected element in the color transformation matrix (raw value) - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which element will be entered in the color transformation matrix - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Number of times a sequencer set is used before the Counter End event is generated - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the type of signal transition that the counter will count - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which event increases the currently selected counter - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Immediately resets the selected counter - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which type of signal transition will reset the counter - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which source signal will reset the currently selected counter - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which counter can be configured - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Returns the current status of the counter - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the type of signal transition that will start the counter - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the signal used to start the selected counter - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Current value of the counter - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates whether the critical temperature has been reached - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Stream channel index of the Critical Temperature event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Critical Temperature event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Horizontal decimation factor - Applies to: CameraLink, Stereo ace, ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Vertical decimation factor - Applies to: CameraLink, Stereo ace, ace GigE, ace USB and boost V CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the demosaicing mode - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the character set used by the strings of the device's bootstrap registers - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Version of the color modifications applied to images - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Identifier of the product family of the device - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Disables feature streaming on the device - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables feature streaming on the device - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Version of the camera's firmware - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Major version of the GenCP protocol supported by the device - Applies to: ace 2 USB, dart MIPI and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Minor version of the GenCP protocol supported by the device - Applies to: ace 2 USB, dart MIPI and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief ID of the camera - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the behavior of the camera's status LED - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Speed of transmission negotiated on the selected link - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Bandwidth limit for data transmission (in bytes per second) - Applies to: CamEmu, Stereo ace, ace 2 GigE, ace 2 USB, ace USB, dart GigE, dart MIPI, dart USB, pulse USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables/disables the device link throughput limit - Applies to: CamEmu, Stereo ace, ace 2 GigE, ace 2 USB, ace USB, dart GigE, dart MIPI, dart USB, pulse USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief First URL to the GenICam XML device description file of the selected manifest entry - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Major version number of the schema file of the selected manifest entry - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Minor version number of the schema file of the selected manifest entry - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Major version number of the GenICam XML file of the selected manifest entry - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Minor version number of the GenICam XML file of the selected manifest entry - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Subminor version number of the GenICam XML file of the selected manifest entry - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Additional information from the vendor about the camera - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Name of the camera model - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Endianness of the registers of the device - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Announces the end of feature streaming - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, boost CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Prepares the camera for feature streaming - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, boost CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Immediately resets and restarts the camera - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Major version number of the SFNC specification that the camera is compatible with - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Minor version number of the SFNC specification that the camera is compatible with - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Subminor version number of the SFNC specification that the camera is compatible with - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the scan type of the camera's sensor (area or line scan) - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Serial number of the camera - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the type of the device's transport layer - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Major version number of the device's transport layer - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Minor version number of the device's transport layer - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Subminor version number of the device's transport layer - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Temperature at the selected location in the camera (in degrees centigrade) - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the location in the camera where the temperature will be measured - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief User-settable ID of the camera - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Name of the camera vendor - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Version of the camera - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Digital shift to be applied - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables Burst Acquisition - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Unique identifier of the Action Late event - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Action Late event - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Unique identifier of the Exposure End event - Applies to: ace 2 GigE, ace 2 USB, ace USB, dart GigE and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Frame ID of the Exposure End event - Applies to: ace 2 GigE, ace 2 USB, ace USB, dart GigE and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Exposure End event - Applies to: ace 2 GigE, ace 2 USB, ace USB, dart GigE and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Unique identifier of the Frame Buffer Overrun event - Applies to: ace 2 GigE, ace 2 USB and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Frame Buffer Overrun event - Applies to: ace 2 GigE, ace 2 USB and dart GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Unique identifier of the Frame Start event - Applies to: ace 2 GigE, ace 2 USB, ace USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Frame ID of the Frame Start event - Applies to: ace 2 GigE, ace 2 USB, ace USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Frame Start event - Applies to: ace 2 GigE, ace 2 USB, ace USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Unique identifier of the Frame Trigger Missed event - Applies to: ace 2 GigE, ace 2 USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Frame Trigger Missed event - Applies to: ace 2 GigE, ace 2 USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables event notifications for the currently selected event - Applies to: ace 2 GigE, ace 2 USB, ace GigE, ace USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Unique identifier of the Event Overrun event - Applies to: ace 2 GigE, ace 2 USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Frame ID of the Event Overrun event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Stream channel index of the Event Overrun event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Event Overrun event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Event Overrun event - Applies to: ace 2 GigE, ace 2 USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the event notification to be enabled - Applies to: ace 2 GigE, ace 2 USB, ace GigE, ace USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Unique identifier of the Temperature Status Changed event - Applies to: ace 2 GigE, ace 2 USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief New temperature status that applies after the Temperature Status Changed event was raised - Applies to: ace 2 GigE, ace 2 USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Temperature Status Changed event - Applies to: ace 2 GigE, ace 2 USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Unique identifier of the Test event - Applies to: ace 2 GigE, ace 2 USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the test event - Applies to: ace 2 GigE, ace 2 USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Key for making the selected expert feature available - Applies to: CameraLink, ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the expert feature to be made available - Applies to: CameraLink, ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Enables the currently selected expert feature - Applies to: CameraLink, ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the operation mode of the Exposure Auto auto function - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Frame ID of the Exposure End event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Stream channel index of the Exposure End event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Exposure End event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the exposure mode - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum overlap of the sensor exposure with sensor readout in Trigger Width exposure mode (in microseconds) - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum overlap of the sensor exposure with sensor readout in Trigger Width exposure mode (raw value) - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the exposure overlap time mode - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief  Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Exposure time of the camera in microseconds - Applies to: CamEmu, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Exposure time of the camera in microseconds - Applies to: CamEmu, CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timebase (in microseconds) that the camera uses when the exposure time is specified using the Exposure Time (Raw) parameter - Applies to: CamEmu, CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables the use of the exposure timebase - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the exposure time mode - Applies to: ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Exposure time of the camera (raw value) - Applies to: CamEmu, CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which component the Exposure Time parameter value applies to - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the default GenICam XML file - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Selects the mode to output the fields - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Access buffer for file operations - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Number of bytes read from the file into the file access buffer or written to the file from the file access buffer - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the access mode in which a file is opened in the camera - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Executes the operation selected by File Operation Selector parameter - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief File operation result - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the target operation for the currently selected file - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the file operation execution status - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the target file in the camera - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Size of the currently selected file in bytes - Applies to: CameraLink, Stereo ace, ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Stream channel index of the Frame Start event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Frame Start event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Stream channel index of the Frame Start Overtrigger event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Frame Start Overtrigger event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Stream channel index of the Frame Start Wait event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Frame Start Wait event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Frame timeout in microseconds - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables the frame timeout - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Stream channel index of the Frame Timeout event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Frame Timeout event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Stream channel index of the Frame Wait event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Frame Wait event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the input source - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Multiplication factor to be applied to the input signal frequency - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Post-divider value to decrease input signal frequency - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Pre-divider value to decrease signal frequency - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables overtriggering protection - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the signal transition relationships between received and generated signals - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Value of the currently selected gain in dB - Applies to: CamEmu, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief This is a float value that sets the selected gain control in dB - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the operation mode of the Gain Auto auto function - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Value of the currently selected gain (raw value) - Applies to: CamEmu, CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the gain type to be adjusted - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Gamma correction to be applied - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables gamma correction - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the type of gamma to be applied - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the control channel privilege - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Current default gateway of the selected network interface - Applies to: Stereo ace, ace GigE and blaze
        ...
        */
        ...
        //@{
        /*!
            \brief Current IP address of the selected network interface - Applies to: Stereo ace, ace GigE and blaze
        ...
        */
        ...
        //@{
        /*!
            \brief Current IP configuration of the selected network interface - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Current subnet mask of the selected network interface - Applies to: Stereo ace, ace GigE and blaze
        ...
        */
        ...
        //@{
        /*!
            \brief Character set used by all strings of the bootstrap registers - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates whether the bootstrap register is in big-endian format - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief First URL reference to the GenICam XML file   - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the Extended ID mode for GVSP - Applies to: ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Heartbeat timeout in milliseconds - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables the IEEE 1588 V2 Precision Time Protocol for the timestamp register - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Latched IEEE 1588 clock ID of the camera - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Latches the current IEEE 1588-related values of the camera - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Latched offset from the IEEE 1588 master clock in nanoseconds   - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Latched IEEE 1588 parent clock ID of the camera - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the state of the IEEE 1588 clock - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the latched state of the IEEE 1588 clock - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the physical network interface to be configured - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the state of medium-dependent interface crossover (MDIX) for the selected network interface - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates whether the selected network interface operates in full-duplex mode - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates whether the selected network interface is the clock master - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Connection speed in Mbps of the selected network interface - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief MAC address of the selected network interface - Applies to: ace GigE and blaze
        ...
        */
        ...
        //@{
        /*!
            \brief Number of message channels supported by the camera - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Number of network interfaces of the camera - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Fixed default gateway of the selected network interface - Applies to: Stereo ace, ace GigE and blaze
        ...
        */
        ...
        //@{
        /*!
            \brief Fixed IP address of the selected network interface - Applies to: Stereo ace, ace GigE and blaze
        ...
        */
        ...
        //@{
        /*!
            \brief Fixed subnet mask of the selected network interface - Applies to: Stereo ace, ace GigE and blaze
        ...
        */
        ...
        //@{
        /*!
            \brief Base bandwidth in bytes per second that will be used by the camera to transmit image and chunk feature data and to handle resends and control data transmissions - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Percentage of the Ethernet bandwidth assigned to the camera to be held in reserve - Applies to: CamEmu, ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Multiplier for the Bandwidth Reserve parameter   - Applies to: CamEmu, ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Destination address of the selected stream channel - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Actual bandwidth (in bytes per second) that the camera will use to transmit image data and chunk data - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum amount of data (in bytes per second) that the camera can generate - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum amount of time (in ticks) that the next frame transmission could be delayed due to a burst of resends   - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Frame transmission delay on the selected stream channel - Applies to: CamEmu, ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Delay between the transmission of each packet on the selected stream channel - Applies to: CamEmu, Stereo ace, ace 2 GigE, ace GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Destination port of the selected stream channel - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Index of the network interface to be used - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the endianness of multi-byte pixel data for this stream - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Disables IP fragmentation of packets on the stream channel - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sends a GigE Vision streaming test packet - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Packet size in bytes on the selected stream channel  Excludes data leader and data trailer - Applies to: CamEmu, Stereo ace, ace 2 GigE, ace GigE, blaze, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Second URL reference to the GenICam XML file   - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Number of stream channels supported by the camera - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the stream channel to be configured - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates whether the IEEE 1588 V2 Precision Time Protocol (PTP) is supported - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates whether the selected network interface supports DHCP IP addressing - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates whether the selected network interface supports auto IP addressing (also known as LLA) - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates whether the selected network interface supports fixed IP addressing (also known as persistent IP addressing) - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates whether multiple operations in a single message are supported - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates whether EVENT_CMD and EVENT_ACK are supported - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates whether EVENTDATA_CMD and EVENTDATA_ACK are supported - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates whether PACKETRESEND_CMD is supported - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates whether WRITEMEM_CMD and WRITEMEM_ACK are supported - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates whether this GVSP transmitter or receiver can support a 16-bit block ID - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Latches the current timestamp value of the camera - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Resets the timestamp control latch - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Resets the timestamp value of the camera - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Number of timestamp clock ticks in 1 second - Applies to: ace 2 GigE, ace GigE, blaze, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Latched value of the timestamp - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Major version number of the GigE Vision specification supported by this camera - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Minor version number of the GigE Vision specification supported by this camera - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Gray value adjustment damping factor to be applied - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Gray value adjustment damping factor (raw value) to be applied - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Height of the camera's region of interest (area of interest) in pixels - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum height of the region of interest (area of interest) in pixels - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Selects the Interlaced Integration Mode - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables the selected lookup table (LUT) - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Pixel value to be replaced with the LUT Value pixel value - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the lookup table (LUT) to be configured - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief New pixel value to replace the LUT Index pixel value - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief A single register that lets you access all LUT entries - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the last error code in the memory - Applies to: CameraLink, ace GigE and blaze
        ...
        */
        ...
        //@{
        /*!
            \brief Sets whether vertical binning is used - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the type of light source for which color transformation will be performed - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Stream channel index of the Line 1 Rising Edge event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Line 1 Rising Edge event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Stream channel index of the Line 2 Rising Edge event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Line 2 Rising Edge event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Stream channel index of the Line 3 Rising Edge event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Line 3 Rising Edge event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Stream channel index of the Line 4 Rising Edge event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Line 4 Rising Edge event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Line debouncer time in microseconds - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the electrical configuration of the currently selected line - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables the signal inverter function for the currently selected input or output line - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the line logic of the currently selected line - Applies to: CameraLink, ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the mode for the selected line - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the I/O line to be configured - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the source signal for the currently selected line - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Stream channel index of the Line Start Overtrigger event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Line Start Overtrigger event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the current logical state of the selected line - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Single bit field indicating the current logical state of all available line signals at time of polling - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables the termination resistor of the selected input line - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Minimum signal width of an output signal (in microseconds) - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Amount of noise reduction to be applied - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Amount of noise reduction to be applied (raw value) - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Horizontal offset of the region of interest (area of interest) from the left side of the sensor (in pixels) - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Vertical offset of the region of interest (area of interest) from the top of the sensor (in pixels) - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates whether an over temperature state has been detected - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Stream channel index of the Over Temperature event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Over Temperature event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the parameter whose factory limits can be removed - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Size of the payload in bytes - Applies to: CamEmu, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables Basler PGI image optimizations - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the color coding of the pixels in the acquired images - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the alignment of the camera's Bayer filter to the pixels in the acquired images - Applies to: CameraLink, ace GigE, ace USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum possible pixel value that can be transferred from the camera - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Minimum possible pixel value that can be transferred from the camera - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the format of the pixel data transmitted by the camera - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables legacy pixel format encoding - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the depth of the pixel values in the image (in bits per pixel) - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the number of prelines - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables the output of color-improved raw image data - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the expected accuracy of the PTP device clock when it is or becomes the grandmaster - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Returns the latched clock ID of the PTP device - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Latches the current values from the device's PTP clock data set - Applies to: Stereo ace, ace 2 GigE, blaze, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables the Precision Time Protocol (PTP) - Applies to: Stereo ace, ace 2 GigE, blaze, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Returns the latched grandmaster clock ID of the PTP device - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Returns the latched offset from the PTP master clock in nanoseconds - Applies to: Stereo ace, ace 2 GigE, blaze, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Returns the latched parent clock ID of the PTP device - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Returns the latched state of the clock servo - Applies to: Stereo ace, ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Returns the latched state of the PTP clock - Applies to: Stereo ace, ace 2 GigE, blaze, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables or disables the currently selected ROI zone - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Vertical offset of the currently selected ROI zone - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the ROI zone that can be configured - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Height of the currently selected ROI zone - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sensor readout time with current settings - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Removes the factory-set limit of the selected parameter - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum frame acquisition period with current camera settings - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum frame acquisition rate with current camera settings - Applies to: CamEmu, CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum line acquisition period with current camera settings - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum line acquisition rate with current camera settings - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables horizontal mirroring of the image - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables vertical mirroring of the image - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief For information only  May be required when contacting Basler support - Applies to: ace 2 USB, ace USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Horizontal scaling factor - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Vertical scaling factor - Applies to: ace GigE
  ...
  errors causing planar surfaces to appear curved.
        ...
        */
        ...
        //@{
        /*!
            \brief Amount of data bits the sensor produces for one sample - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief This feature represents the number of digitized samples outputted simultaneously by the camera A/D conversion stage - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Height of the camera's sensor in pixels - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the sensor readout mode - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sensor readout time with current settings - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the shutter mode of the camera - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Width of the camera's sensor in pixels - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which bit of the sequence set address can be assigned to an input line - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets an input line as the control source for the currently selected sequence set address bit - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the sequence set advance mode - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables asynchronous advance from one sequence set to the next - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables asynchronous restart of the sequence set sequence - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets whether the sequencer can be configured - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets whether sequence advance or sequence restart can be configured - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the source for sequence control - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Current sequence set - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables the sequencer - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Number of sequence set executions - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Index number of a sequence set - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Loads the parameter values of the currently selected sequence set for configuration - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Stores the sequencer parameter values in the currently selected sequence set - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Total number of sequence sets in the sequence - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables the selected shading correction type - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the kind of shading correction - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Loads the selected shading set - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables/disables shading set creation - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the bootup shading set - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which shading set can be enabled or created - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates error statuses related to shading correction - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Current value of the tick counter - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum value of the tick counter - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the counting mode of the tick counter - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Resets the tick counter to 0 - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the phase of the shaft encoder - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the line source for the shaft encoder module - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets how the shaft encoder module outputs trigger signals - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum value of the reverse counter - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Resets the reverse counter of the shaft encoder module - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sharpening value to be applied - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sharpening value to be applied (raw value) - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the shutter mode of the camera - Applies to: CameraLink, ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Executes the selected software signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the software signal to be executed - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Correction factor to account for the gaps between the sensor's lines - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables the Stacked Zone Imaging feature - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Index number of the zone to configure - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables the selected zone - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Height of the selected zone - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Vertical offset (top offset) of the selected zone - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Substrate voltage - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables the synchronous free run mode - Applies to: ace GigE and blaze
        ...
        */
        ...
        //@{
        /*!
            \brief High 32 bits of the synchronous free run trigger start time - Applies to: ace GigE and blaze
        ...
        */
        ...
        //@{
        /*!
            \brief Low 32 bits of the synchronous free run trigger start time - Applies to: ace GigE and blaze
        ...
        */
        ...
        //@{
        /*!
            \brief Synchronous free run trigger rate - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Updates synchronous free run settings - Applies to: ace GigE and blaze
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the user-settable synchronous output signal to be configured - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables the selected user-settable synchronous output line - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Single bit field that sets the state of all user-settable synchronous output signals in one access - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Temperature at the selected location in the camera (in degrees centigrade) - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the location in the camera where the temperature will be measured - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the temperature state - Applies to: CameraLink, ace GigE, ace USB and blaze
        ...
        */
        ...
        //@{
        /*!
            \brief Generates a Test event that can be used for testing event notification - Applies to: ace 2 GigE, ace 2 USB, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Allows you to turn a moving test image into a fixed one - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the test image to display - Applies to: CamEmu, CameraLink, ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the test pattern to display - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Test pending acknowledge time in milliseconds - Applies to: ace 2 GigE, ace 2 USB, dart GigE, dart USB, pulse USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Delay of the currently selected timer in microseconds - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Delay of the currently selected timer in microseconds - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Delay of the selected timer (raw value) - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timebase (in microseconds) that is used when a timer delay is specified using the Timer Delay Raw parameter - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Duration of the currently selected timer in microseconds - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Duration of the currently selected timer in microseconds - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Duration of the selected timer (raw value) - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timebase (in microseconds) that is used when a timer duration is specified using the Timer Duration Raw parameter - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Resets the selected timer - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the timer to be configured - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the status of the currently selected timer - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the type of signal transition that will start the timer - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Arm delay of the currently selected timer - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the internal camera signal used to trigger the selected timer - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Latches the current timestamp counter and stores its value in TimestampLatchValue - Applies to: Stereo ace, ace 2 GigE, ace 2 USB, ace USB, blaze, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Latched value of the timestamp counter - Applies to: Stereo ace, ace 2 GigE, ace 2 USB, ace USB, blaze, dart GigE, dart USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Resets the current timestamp counter - Applies to: ace 2 GigE, dart GigE, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the operation mode of the Tonal Range Auto auto function - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets whether tonal range adjustment is used - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which pixel values are used for tonal range adjustments - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Source value for tonal range adjustments at the bright end of the tonal range - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Source value for tonal range adjustments at the dark end of the tonal range - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Target value at the bright end of the tonal range to which pixel values should be mapped during tonal range adjustments - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Target value at the dark end of the tonal range to which pixel values should be mapped during tonal range adjustments - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the type of signal transition that will activate the selected trigger - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the image acquisition control mode - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Trigger delay time in microseconds - Applies to: CamEmu, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Trigger delay time in microseconds - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Trigger delay as number of line triggers - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the kind of trigger delay - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the mode for the currently selected trigger - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Determines whether a partial or a complete frame is transmitted when the Frame Start trigger signal transitions prematurely - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the trigger type to be configured - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Generates a software trigger signal - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the source signal for the selected trigger - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief User-defined value - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the user-defined value to set or read - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the user-settable output signal to be configured - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables the selected user-settable output line - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Single bit field that sets the state of all user-settable output signals in one access - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Defines a mask that is used when the User Output Value All setting is used to set all of the user settable output signals in one access - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the user set or the factory set to be used as the startup set - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the user set or the factory set to be used as the startup set - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Loads the selected set into the camera's volatile memory and makes it the active configuration set - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Saves the current active set as the selected user set - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the user set or the factory set to load, save, or configure - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the length of the input bit - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Time span between the beginning of the input bit and the time when the high/low status is evaluated - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Selects when to start the signal evaluation - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the I/O line on which the camera receives the virtual input signal - Applies to: CameraLink and ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Loads the vignetting correction data - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Enables/disables the vignetting correction - Applies to: ace GigE and ace USB
        ...
        */
        ...
        //@{
        /*!
            \brief Stream channel index of the Virtual Line 1 Rising Edge event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Virtual Line 1 Rising Edge event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Stream channel index of the Virtual Line 2 Rising Edge event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Virtual Line 2 Rising Edge event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Stream channel index of the Virtual Line 3 Rising Edge event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Virtual Line 3 Rising Edge event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Stream channel index of the Virtual Line 4 Rising Edge event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Virtual Line 4 Rising Edge event - Applies to: ace GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Width of the camera's region of interest (area of interest) in pixels - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum width of the region of interest (area of interest) in pixels - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2 CXP, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    ...
    //! \cond HIDE_CLASS_METHODS
        ...
        CUniversalCameraParams_Params_v11_0_0(CUniversalCameraParams_Params_v11_0_0&);

        //! not implemented assignment operator
        CUniversalCameraParams_Params_v11_0_0& operator=(CUniversalCameraParams_Params_v11_0_0&);
    ...
    The \ref sample_ParametrizeCamera_NativeParameterAccess code sample shows how to access camera parameters via the \c Pylon::CBaslerUniversalInstantCamera class.
    */
    class CUniversalCameraParams_Params : public CUniversalCameraParams_Params_v11_0_0
    {
    //----------------------------------------------------------------------------------------------------------------
    // Implementation
    //----------------------------------------------------------------------------------------------------------------
    protected:
        ...
        {
            CUniversalCameraParams_Params_v11_0_0::_Initialize( pNodeMap );
        }
        //! \endcond
    };
} // namespace Basler_UniversalCameraParams
