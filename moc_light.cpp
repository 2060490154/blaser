...
QT_MOC_LITERAL(1, 6, 11), // "valuechange"
QT_MOC_LITERAL(2, 18, 0) // ""

    },
    "light\0valuechange\0"
};
...
void light::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (light::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&light::valuechange)) {
                *result = 0;
                return;
            }
        }
