...
int main(int argc, char* argv[])
{
    ...
    try
    {
        ...
        cout << "camera.ChunkSequencerSetActive = " << camera.ChunkSequencerSetActive.ToStringOrDefault("<not readable>") << std::endl;
        ...
        cout << "camera.EventCriticalTemperature = " << camera.EventCriticalTemperature.ToStringOrDefault("<not readable>") << std::endl;
        cout << "camera.EventCriticalTemperatureTimestamp = " << camera.EventCriticalTemperatureTimestamp.ToStringOrDefault("<not readable>") << std::endl;
        ...
        cout << "camera.EventFrameBurstStartWait = " << camera.EventFrameBurstStartWait.ToStringOrDefault("<not readable>") << std::endl;
        cout << "camera.EventFrameBurstStartWaitTimestamp = " << camera.EventFrameBurstStartWaitTimestamp.ToStringOrDefault("<not readable>") << std::endl;
        ...
        cout << "camera.EventFrameStartWait = " << camera.EventFrameStartWait.ToStringOrDefault("<not readable>") << std::endl;
        cout << "camera.EventFrameStartWaitTimestamp = " << camera.EventFrameStartWaitTimestamp.ToStringOrDefault("<not readable>") << std::endl;
        cout << "camera.EventNotification = " << camera.EventNotification.ToStringOrDefault("<not readable>") << std::endl;
        cout << "camera.EventOverTemperature = " << camera.EventOverTemperature.ToStringOrDefault("<not readable>") << std::endl;
        cout << "camera.EventOverTemperatureTimestamp = " << camera.EventOverTemperatureTimestamp.ToStringOrDefault("<not readable>") << std::endl;
        ...
        cout << "camera.NoiseReduction = " << camera.NoiseReduction.ToStringOrDefault("<not readable>") << std::endl;
        ...
        cout << "camera.ScalingHorizontal = " << camera.ScalingHorizontal.ToStringOrDefault("<not readable>") << std::endl;
        cout << "camera.ScalingVertical = " << camera.ScalingVertical.ToStringOrDefault("<not readable>") << std::endl;
        ...
        cout << "camera.SequencerConfigurationMode = " << camera.SequencerConfigurationMode.ToStringOrDefault("<not readable>") << std::endl;
        cout << "camera.SequencerMode = " << camera.SequencerMode.ToStringOrDefault("<not readable>") << std::endl;
        cout << "camera.SequencerPathSelector = " << camera.SequencerPathSelector.ToStringOrDefault("<not readable>") << std::endl;
        cout << "camera.SequencerSetActive = " << camera.SequencerSetActive.ToStringOrDefault("<not readable>") << std::endl;
        cout << "camera.SequencerSetLoad = " << camera.SequencerSetLoad.ToStringOrDefault("<not readable>") << std::endl;
        cout << "camera.SequencerSetNext = " << camera.SequencerSetNext.ToStringOrDefault("<not readable>") << std::endl;
        cout << "camera.SequencerSetSave = " << camera.SequencerSetSave.ToStringOrDefault("<not readable>") << std::endl;
        cout << "camera.SequencerSetSelector = " << camera.SequencerSetSelector.ToStringOrDefault("<not readable>") << std::endl;
        cout << "camera.SequencerSetStart = " << camera.SequencerSetStart.ToStringOrDefault("<not readable>") << std::endl;
        cout << "camera.SequencerTriggerActivation = " << camera.SequencerTriggerActivation.ToStringOrDefault("<not readable>") << std::endl;
        cout << "camera.SequencerTriggerSource = " << camera.SequencerTriggerSource.ToStringOrDefault("<not readable>") << std::endl;
        cout << "camera.SharpnessEnhancement = " << camera.SharpnessEnhancement.ToStringOrDefault("<not readable>") << std::endl;
