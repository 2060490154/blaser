...
namespace BaslerCameraStreamParams_Params
{
    ...
    */
    ...
    //@{
    /*!
        \brief Maximum size (in bytes) of a buffer used for grabbing images - Applies to: acA2440-35uc
    ...
    */
    ...
    //@{
    /*!
        \brief Maximum number of buffers that can be used simultaneously for grabbing images - Applies to: acA2440-35uc
    ...
    */
    ...
    //@{
    /*!
        \brief Maximum USB data transfer size in bytes - Applies to: acA2440-35uc
    ...
    */
    ...
    //@{
    /*!
        \brief GigE cameras: Number of buffers with at least one failed packet  A packet is considered failed if its status is not 'success'  Other cameras: Number of buffers that returned with an error status   - Applies to: acA2440-35uc
    ...
    */
    ...
    //@{
    /*!
        \brief Last grabbed block ID - Applies to: acA2440-35uc
    ...
    */
    ...
    //@{
    /*!
        \brief Status code of the last failed buffer - Applies to: acA2440-35uc
    ...
    */
    ...
    //@{
    /*!
        \brief Number of corrupt or lost frames between successfully grabbed images - Applies to: acA2440-35uc
    ...
    */
    ...
    //@{
    /*!
        \brief Number of out-of-memory errors - Applies to: acA2440-35uc
    ...
    */
    ...
    //@{
    /*!
        \brief Number of stream resynchronizations - Applies to: acA2440-35uc
    ...
    */
    ...
    //@{
    /*!
        \brief GigE cameras: Number of frames received  Other cameras: Number of buffers processed - Applies to: acA2440-35uc
