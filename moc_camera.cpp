...
QT_MOC_LITERAL(1, 7, 10), // "sendcamera"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 5) // "token"

    },
    "camera\0sendcamera\0\0token"
};
...
void camera::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendcamera((*reinterpret_cast< void*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (camera::*)(void * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&camera::sendcamera)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void camera::sendcamera(void * _t1)
{
