        ...
        */
        ...
        public:
            ...
            */
            ...
            /*!
             \brief
                Gets the execution time of this update in microseconds if the update is complete.

             \param[in] executionTime The execution time in microseconds.

             \return
                \c true if this update is already complete and the execution time is set. \c false if the update is not valid or if it has not completed yet (the execution time is not set in this case).

             \error
                Doesn't throw C++ exceptions.
            */
            bool GetExecutionTime(uint64_t& executionTime) const;
