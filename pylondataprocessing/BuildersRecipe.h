        ...
        public:
            ...
            */
            ...
            /*!
             ...
             \post
              ...
              \error
                 Throws an exception if the preconditions aren't met, or when memory allocation fails.
            ...
            */
            ...
            /*!
             ...
             \error
                Throws exceptions if the preconditions aren't met or when memory allocation fails.
            ...
            */
            ...
            /*!
             ...
             \param[in] format The format the recipe file will be stored in (see \c ERecipeFileFormat for all available options).
             \param[in] fileName Path to the file to store the recipe in.
                                 This can be an absolute or a relative path.
                                 If it is relative, the file will be saved relative to your current working directory.
             ...
             \post
                - The recipe has been written to the file path specified and can be loaded using the \c CRecipe API.
             ...
             \threading
                This method is synchronized using the lock provided by \c GetLock().
            */
            void SaveAs(ERecipeFileFormat format, const Pylon::String_t& fileName);
