        ...
        */
        ...
        public:
            ...
            */
            ...
            /*!
                \brief Compares two CTransformationData instances for equality.
             ...
             */
            bool operator == (const CTransformationData& rhs) const;

            /*!
                \brief Compares two CTransformationData instances for inequality.
                \param[in] rhs The right-hand side object to compare with.
                \error
                 - Doesn't throw C++ exceptions.
            ...
            /*!
                \brief Compares two CTransformationData instances for similarity within a given tolerance.
                \param[in] rhs The right-hand side object to compare with.
             ...
             */
            bool IsSimilar(const CTransformationData& rhs, double tolerance = gs_defaultComparisonTolerance) const;
